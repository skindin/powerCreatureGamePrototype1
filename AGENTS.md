...
- **Standard Gamepad API Polling**:
  ...
  - **Right Under-Paddle (M1 — Jump & Climb Control)**:
    - Supported inputs: `A (0)`, `R3 (11)`, `Y (3)`, `Menu/Start (9)`, `D-pad Right (15)`, extended M1 paddle buttons (`Button 16` on 17/18-btn pads, `Button 17`, `Button 19`, `Button 21` on 19+ pads), axis 4, and remapped `Space` keys.
