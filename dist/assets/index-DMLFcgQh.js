        ...
        <div class="dev-section">
          ...
          <div class="module-card" id="card-mod-bounce">
            ...
            <div id="group-mod-bounce" style="display: ${(g=this.selectedEntity.bounceModule)!=null&&g.enabled?"block":"none"};">
              ...
              <div id="warn-bounce-vert-vel" class="module-dep-warning" style="display: ${(k=this.selectedEntity.bounceModule)!=null&&k.enabled&&((L=this.selectedEntity.bounceModule)!=null&&L.verticalBounce)&&!this.selectedEntity.hasVerticalVelocity?"block":"none"};">
          ...
          <div class="module-card">
            ...
            <div id="note-roll-friction" class="module-detached-note" style="display: ${(S=this.selectedEntity.rollModule)!=null&&S.enabled&&!this.selectedEntity.hasFriction?"block":"none"}; color: #cbd5e1;">
          ...
          <div id="character-specific-controls" style="display: ${this.selectedEntity===this.character?"flex":"none"}; flex-direction: column; gap: 10px;">
            ...
            <div class="module-card" id="card-mod-walking">
              <div class="toggle-row">
                ...
                <button id="toggle-walk" class="btn-toggle ${(M=this.character.walkingModule)!=null&&M.enabled?"active":""}">
