var $t=Object.defineProperty;var Dt=(O,t,i)=>t in O?$t(O,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):O[t]=i;var r=(O,t,i)=>Dt(O,typeof t!="symbol"?t+"":t,i);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const l of e)if(l.type==="childList")for(const n of l.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function i(e){const l={};return e.integrity&&(l.integrity=e.integrity),e.referrerPolicy&&(l.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?l.credentials="include":e.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(e){if(e.ep)return;e.ep=!0;const l=i(e);fetch(e.href,l)}})();class dt{constructor(t={}){r(this,"z");r(this,"hasVerticalVelocity");r(this,"verticalVelocity");r(this,"enabled");this.z=t.z??0,this.hasVerticalVelocity=t.hasVerticalVelocity!==void 0?t.hasVerticalVelocity:!0,this.verticalVelocity=t.verticalVelocity??0,this.enabled=t.enabled!==void 0?t.enabled:!0}}const St=class St{constructor(t=20,i=14,s=1){r(this,"width");r(this,"height");r(this,"tileSize");r(this,"cols");r(this,"rows");r(this,"wallHeight");r(this,"gravity");r(this,"frictionCoeff");r(this,"staticFrictionThreshold");r(this,"tileGrid");r(this,"walls",[]);r(this,"currentPresetId","trenches");this.width=t,this.height=i,this.tileSize=s,this.cols=Math.floor(t/s),this.rows=Math.floor(i/s),this.wallHeight=1,this.gravity=10,this.frictionCoeff=10.4,this.staticFrictionThreshold=.16,this.tileGrid=Array.from({length:this.rows},()=>Array.from({length:this.cols},()=>0)),this.loadWallPreset("trenches")}rebuildWalls(){this.walls=[];for(let t=0;t<this.rows;t++)for(let i=0;i<this.cols;i++)this.tileGrid[t][i]===1&&this.walls.push({id:`wall-${i}-${t}`,x:i*this.tileSize,y:t*this.tileSize,width:this.tileSize,height:this.tileSize,wallHeight:this.wallHeight})}setStandardWallHeight(t){this.wallHeight=t,this.rebuildWalls()}setWallTile(t,i,s){if(t<0||t>=this.cols||i<0||i>=this.rows)return!1;const e=s?1:0;return this.tileGrid[i][t]===e?!1:(this.tileGrid[i][t]=e,this.rebuildWalls(),!0)}hasWall(t,i){return t<0||t>=this.cols||i<0||i>=this.rows?!1:this.tileGrid[i][t]===1}loadWallPreset(t,i){const s=St.WALL_PRESETS.find(e=>e.id===t);return s?(this.currentPresetId=t,this.tileGrid=s.generate(this.cols,this.rows),this.rebuildWalls(),this.syncEntitiesWithWalls(i),!0):!1}syncEntitiesWithWalls(t){var i;if(t)for(const s of t){const e=s.hasCollider?s.colliderRadius:((i=s.colliderModule)==null?void 0:i.radius)??.32,l=this.getSupportingWall(s.position.x,s.position.y,e);l&&s.position.z<l.wallHeight&&(s.hasVerticalPosition||(s.verticalPositionModule?s.verticalPositionModule.enabled=!0:s.verticalPositionModule=new dt({z:l.wallHeight,hasVerticalVelocity:!0})),s.position.z=l.wallHeight,s.supportingSurfaceHeight=l.wallHeight,s.standingWall=l,s.verticalVelocity=0)}}clearAllWalls(t){this.loadWallPreset("empty",t)}resetDefaultWalls(t){this.loadWallPreset("trenches",t)}getWallAt(t,i){for(const s of this.walls)if(t>=s.x&&t<=s.x+s.width&&i>=s.y&&i<=s.y+s.height)return s;return null}testWallOverlap(t,i,s,e){const l=Math.max(e.x,Math.min(t,e.x+e.width)),n=Math.max(e.y,Math.min(i,e.y+e.height)),o=t-l,a=i-n;return o*o+a*a<s*s}getSupportingWall(t,i,s=0){if(s<=0)return this.getWallAt(t,i);for(const e of this.walls)if(this.testWallOverlap(t,i,s,e))return e;return null}areWallsContiguous(t,i){if(t.id===i.id)return!0;const s=Math.max(0,Math.max(t.x,i.x)-Math.min(t.x+t.width,i.x+i.width)),e=Math.max(0,Math.max(t.y,i.y)-Math.min(t.y+t.height,i.y+i.height)),l=Math.min(t.x+t.width,i.x+i.width)-Math.max(t.x,i.x),n=Math.min(t.y+t.height,i.y+i.height)-Math.max(t.y,i.y);return s<.001&&n>.05||e<.001&&l>.05}getSupportingSurfaceHeight(t,i,s=0){const e=this.getSupportingWall(t,i,s);return e?e.wallHeight:0}};r(St,"WALL_PRESETS",[{id:"trenches",name:"⛏️ Trench Tunnels",badge:"Dense Walls",description:"Mostly elevated walls with a winding network of 1-tile-wide ground-level trench tunnels.",generate:(t,i)=>{const s=Array.from({length:i},()=>Array.from({length:t},()=>1));for(let e=2;e<=17;e++)s[3][e]=0,s[7][e]=0,s[10][e]=0;for(let e=2;e<=11;e++)s[e][5]=0,s[e][10]=0,s[e][14]=0;s[1][10]=0,s[12][10]=0,s[7][1]=0,s[7][18]=0;for(let e=5;e<=9;e++)s[e][2]=0;for(let e=5;e<=9;e++)s[e][17]=0;for(let e=2;e<=5;e++)s[5][e]=0;for(let e=10;e<=14;e++)s[5][e]=0;for(let e=5;e<=10;e++)s[9][e]=0;for(let e=14;e<=17;e++)s[9][e]=0;return s[7][5]=0,s}},{id:"standard",name:"🏛️ Standard Arena",badge:"Balanced",description:"Center dividing wall with an open gateway and two 2×2 cover obstacles.",generate:(t,i)=>{const s=Array.from({length:i},()=>Array.from({length:t},()=>0)),e=10;for(let l=1;l<=4;l++)s[l][e]=1;for(let l=8;l<=12;l++)s[l][e]=1;return s[4][4]=1,s[5][4]=1,s[4][5]=1,s[5][5]=1,s[7][15]=1,s[8][15]=1,s[7][16]=1,s[8][16]=1,s}},{id:"courtyards",name:"🏰 Courtyards & Platforms",badge:"4 Quadrants",description:"Four large raised platforms in each corner with a central dais and open courtyards.",generate:(t,i)=>{const s=Array.from({length:i},()=>Array.from({length:t},()=>0));for(let e=2;e<=4;e++){for(let l=3;l<=6;l++)s[e][l]=1;for(let l=13;l<=16;l++)s[e][l]=1}for(let e=9;e<=11;e++){for(let l=3;l<=6;l++)s[e][l]=1;for(let l=13;l<=16;l++)s[e][l]=1}for(let e=6;e<=7;e++)for(let l=9;l<=10;l++)s[e][l]=1;return s}},{id:"pillars",name:"🗿 Pillars & Monoliths",badge:"Tactical Cover",description:"Raised monoliths and stepping-stone pillars scattered across the arena.",generate:(t,i)=>{const s=Array.from({length:i},()=>Array.from({length:t},()=>0)),e=[[3,2],[8,2],[15,2],[3,10],[8,10],[15,10],[5,6],[13,6],[9,6]];for(const[l,n]of e)s[n][l]=1,s[n+1][l]=1,s[n][l+1]=1,s[n+1][l+1]=1;return s}},{id:"maze",name:"🌀 Labyrinth Maze",badge:"Winding Paths",description:"Interlocking corridors and winding paths with high walls to climb over or navigate.",generate:(t,i)=>{const s=Array.from({length:i},()=>Array.from({length:t},()=>0));for(let e=1;e<=9;e++)s[e][4]=1;for(let e=4;e<=12;e++)s[e][7]=1;for(let e=1;e<=9;e++)s[e][10]=1;for(let e=4;e<=12;e++)s[e][13]=1;for(let e=1;e<=9;e++)s[e][16]=1;for(let e=7;e<=10;e++)s[4][e]=1;for(let e=13;e<=16;e++)s[4][e]=1;for(let e=4;e<=7;e++)s[9][e]=1;for(let e=10;e<=13;e++)s[9][e]=1;return s}},{id:"empty",name:"⬜ Empty (Open Arena)",badge:"Clean Slate",description:"Completely open arena with zero walls for custom level design.",generate:(t,i)=>Array.from({length:i},()=>Array.from({length:t},()=>0))}]);let J=St;class ht{constructor(t={}){r(this,"radius");r(this,"enabled");this.radius=t.radius??.32,this.enabled=t.enabled??!0}}class ut{constructor(t={}){r(this,"mass");r(this,"enabled");this.mass=t.mass??1,this.enabled=t.enabled??!0}}class yt{constructor(t={}){r(this,"staticFrictionMod");r(this,"dynamicFrictionMod");r(this,"enabled");this.staticFrictionMod=t.staticFrictionMod??1,this.dynamicFrictionMod=t.dynamicFrictionMod??1,this.enabled=t.enabled??!0}}class gt{constructor(t={}){r(this,"bounceMod");r(this,"verticalBounce");r(this,"enabled");this.bounceMod=t.bounceMod??.4,this.verticalBounce=t.verticalBounce??!0,this.enabled=t.enabled??!0}}class mt{constructor(t={}){r(this,"enabled");this.enabled=t.enabled??!0}}class tt{constructor(t={}){r(this,"id");r(this,"name");r(this,"position");r(this,"velocity");r(this,"color");r(this,"isHeld");r(this,"heldBy");r(this,"lastThrower",null);r(this,"isCharacter",!1);r(this,"isClimbing",!1);r(this,"visualShape","circle");r(this,"colliderModule",null);r(this,"massModule",null);r(this,"frictionModule",null);r(this,"bounceModule",null);r(this,"verticalPositionModule",null);r(this,"gravityModule",null);r(this,"rollModule",null);r(this,"supportingSurfaceHeight",0);r(this,"standingWall",null);var i,s,e,l,n;this.id=t.id??`obj-${Math.random().toString(36).substring(2,9)}`,this.name=t.name??"Entity",this.position={x:((i=t.position)==null?void 0:i.x)??0,y:((s=t.position)==null?void 0:s.y)??0,z:((e=t.position)==null?void 0:e.z)??0},this.velocity={x:((l=t.velocity)==null?void 0:l.x)??0,y:((n=t.velocity)==null?void 0:n.y)??0},this.color=t.color??"#94a3b8",this.isHeld=!1,this.heldBy=null,this.visualShape=t.visualShape??"circle",this.colliderModule=t.colliderModule!==void 0?t.colliderModule:t.colliderRadius!==void 0?new ht({radius:t.colliderRadius}):new ht({radius:.35}),this.massModule=t.massModule!==void 0?t.massModule:t.mass!==void 0?new ut({mass:t.mass}):new ut({mass:1}),this.frictionModule=t.frictionModule!==void 0?t.frictionModule:new yt({staticFrictionMod:t.staticGroundFrictionMod??1,dynamicFrictionMod:t.dynamicGroundFrictionMod??1}),this.bounceModule=t.bounceModule!==void 0?t.bounceModule:t.bounceMod!==void 0&&t.bounceMod!==null?new gt({bounceMod:t.bounceMod}):new gt({bounceMod:.4}),this.verticalPositionModule=t.verticalPositionModule!==void 0?t.verticalPositionModule:t.hasVerticalPosition===!1?null:new dt({z:this.position.z,hasVerticalVelocity:t.hasVerticalVelocity!==!1,verticalVelocity:t.verticalVelocity??0}),this.hasVerticalPosition||(this.position.z=0),this.gravityModule=t.gravityModule!==void 0?t.gravityModule:t.hasGravity===!1?null:new mt,this.rollModule=t.rollModule??null}get hasCollider(){return!!(this.colliderModule&&this.colliderModule.enabled)}get colliderRadius(){return this.colliderModule&&this.colliderModule.enabled?this.colliderModule.radius:0}set colliderRadius(t){this.colliderModule?this.colliderModule.radius=t:this.colliderModule=new ht({radius:t})}get hasMass(){return!!(this.massModule&&this.massModule.enabled&&this.massModule.mass>0)}get mass(){return this.massModule&&this.massModule.enabled?this.massModule.mass:0}set mass(t){this.massModule?this.massModule.mass=t:this.massModule=new ut({mass:t})}get hasFriction(){return!!(this.hasMass&&this.frictionModule&&this.frictionModule.enabled)}get staticGroundFrictionMod(){return this.hasFriction&&this.frictionModule?this.frictionModule.staticFrictionMod:0}set staticGroundFrictionMod(t){this.frictionModule?this.frictionModule.staticFrictionMod=t:this.frictionModule=new yt({staticFrictionMod:t})}get dynamicGroundFrictionMod(){return this.hasFriction&&this.frictionModule?this.frictionModule.dynamicFrictionMod:0}set dynamicGroundFrictionMod(t){this.frictionModule?this.frictionModule.dynamicFrictionMod=t:this.frictionModule=new yt({dynamicFrictionMod:t})}get hasBounce(){return!!(this.hasMass&&this.bounceModule&&this.bounceModule.enabled)}get bounceMod(){return this.hasBounce&&this.bounceModule?this.bounceModule.bounceMod:null}set bounceMod(t){t===null||t<=.01?this.bounceModule=null:this.bounceModule?this.bounceModule.bounceMod=t:this.bounceModule=new gt({bounceMod:t})}get hasVerticalPosition(){return!!(this.verticalPositionModule&&this.verticalPositionModule.enabled)}get hasVerticalVelocity(){var t;return!!(this.hasVerticalPosition&&((t=this.verticalPositionModule)!=null&&t.hasVerticalVelocity))}get verticalVelocity(){return this.hasVerticalVelocity&&this.verticalPositionModule?this.verticalPositionModule.verticalVelocity:0}set verticalVelocity(t){this.hasVerticalVelocity&&this.verticalPositionModule&&(this.verticalPositionModule.verticalVelocity=t)}get hasVerticalBounce(){var t;return!!(this.hasBounce&&((t=this.bounceModule)!=null&&t.verticalBounce)&&this.hasVerticalVelocity)}get hasGravity(){return!!(this.gravityModule&&this.gravityModule.enabled)}get isRestingOnSurface(){return Math.abs(this.position.z-this.supportingSurfaceHeight)<=.01&&Math.abs(this.verticalVelocity)<=.05}get isAboveGround(){return this.hasVerticalPosition&&this.position.z>.001}get isAboveWalls(){return this.hasVerticalPosition&&(this.position.z>=.85||this.supportingSurfaceHeight>=.85||this.standingWall!==null)}updatePosition(t,i){var m,S,f,b,k,D,V,C,z,L,T;if(this.isHeld)return;if(this.lastThrower){const M=this.lastThrower.hasCollider?this.lastThrower.colliderRadius:.44,h=(((m=this.lastThrower.pickupModule)==null?void 0:m.pickupReach)??1.3)+this.colliderRadius+M;(Math.hypot(this.position.x-this.lastThrower.position.x,this.position.y-this.lastThrower.position.y)>h||this.isRestingOnSurface)&&(this.lastThrower=null)}this.hasVerticalPosition||(this.position.z=0,this.verticalVelocity=0,this.supportingSurfaceHeight=0);let s=0;if(this.hasCollider&&this.hasVerticalPosition&&i.walls.length>0)if(this.position.z>=i.wallHeight-.05||this.supportingSurfaceHeight>=i.wallHeight-.05&&this.position.z>=i.wallHeight-.2||this.standingWall!==null){const h=this.isCharacter?this:null;if(!!((S=h==null?void 0:h.climbingModule)!=null&&S.isDismountFreefall||(f=h==null?void 0:h.climbingModule)!=null&&f.climbSuppressedUntilRePress))this.standingWall=null,s=0;else if(this.standingWall){const F=this.colliderRadius;if(i.testWallOverlap(this.position.x,this.position.y,F,this.standingWall))s=this.standingWall.wallHeight;else if((b=h==null?void 0:h.climbingModule)!=null&&b.dismountSuppressedUntilRelease)s=this.standingWall.wallHeight;else{let P=null;for(const R of i.walls)if(i.areWallsContiguous(this.standingWall,R)&&i.testWallOverlap(this.position.x,this.position.y,F,R)){P=R;break}P?(this.standingWall=P,s=P.wallHeight):(this.standingWall=null,s=0,h!=null&&h.climbingModule&&(h.climbingModule.isDismountFreefall=!0,h.climbingModule.climbSuppressedUntilRelease=!0))}}else if(!this.isClimbing&&(this.position.z>=i.wallHeight-.05||this.supportingSurfaceHeight>=i.wallHeight-.05)){const F=i.getSupportingWall(this.position.x,this.position.y,this.colliderRadius);F&&(this.standingWall=F,s=F.wallHeight)}}else this.standingWall=null;if(this.isClimbing&&(s=Math.max(s,this.position.z),this.verticalVelocity=0),this.supportingSurfaceHeight=s,this.hasGravity&&this.hasVerticalVelocity){if((this.position.z>s||this.verticalVelocity!==0)&&(this.verticalVelocity-=i.gravity*t,this.position.z+=this.verticalVelocity*t,this.position.z<=s))if(this.position.z=s,!this.isCharacter&&this.hasVerticalBounce&&this.bounceMod!==null&&this.bounceMod>0&&Math.abs(this.verticalVelocity)>.25){const M=Math.abs(this.verticalVelocity);if(this.verticalVelocity=-this.verticalVelocity*this.bounceMod,this.hasFriction&&this.rollModule&&this.rollModule.enabled){const h=this.rollModule,w=this.colliderRadius>0?this.colliderRadius:.3,F=.4,x=this.bounceMod,P=(1+x)*this.mass*M,R=i.frictionCoeff*this.dynamicGroundFrictionMod*.05,$=this.velocity.x-h.angularVelocity.y*w,B=this.velocity.y+h.angularVelocity.x*w,E=Math.hypot($,B);if(E>.001&&R>0){const A=R*P,q=E*this.mass/(1+1/F),H=Math.min(q,A),j=$/E*H,G=B/E*H;this.velocity.x-=j/this.mass,this.velocity.y-=G/this.mass,h.angularVelocity.y+=j/(F*this.mass*w),h.angularVelocity.x-=G/(F*this.mass*w)}const W=Math.max(.65,1-(1-x)*.35);h.angularVelocity.x*=W,h.angularVelocity.y*=W,h.angularVelocity.z*=W}}else this.verticalVelocity=0}else this.hasVerticalVelocity&&this.verticalVelocity!==0&&(this.position.z+=this.verticalVelocity*t,this.position.z<=s&&(this.position.z=s,this.hasVerticalBounce&&this.bounceMod!==null&&this.bounceMod>0&&Math.abs(this.verticalVelocity)>.25?this.verticalVelocity=-this.verticalVelocity*this.bounceMod:this.verticalVelocity=0));if(Math.abs(this.position.z-s)<=.01&&Math.abs(this.verticalVelocity)<=.05&&this.hasFriction){if(!(this.isCharacter&&((k=this.walkingModule)==null?void 0:k.enabled)))if(this.rollModule&&this.rollModule.enabled){const h=this.rollModule,w=this.colliderRadius>0?this.colliderRadius:.3,F=i.frictionCoeff*this.dynamicGroundFrictionMod,x=.4,P=this.velocity.x-h.angularVelocity.y*w,R=this.velocity.y+h.angularVelocity.x*w,$=Math.hypot(P,R);if(F>0&&$>.001){const E=F*(1+1/x)*t;if($<=E){const W=this.velocity.x+x*h.angularVelocity.y*w,A=this.velocity.y-x*h.angularVelocity.x*w,q=W/(1+x),H=A/(1+x);this.velocity.x=q,this.velocity.y=H,h.angularVelocity.y=q/w,h.angularVelocity.x=-H/w}else{const W=P/$*F*t,A=R/$*F*t;this.velocity.x-=W,this.velocity.y-=A,h.angularVelocity.y+=W/(x*w),h.angularVelocity.x-=A/(x*w)}}const B=Math.hypot(this.velocity.x,this.velocity.y);if(B>0){if(h.rollResistance>0){const E=h.rollResistance*t,W=Math.max(0,B-E);if(W<.005)this.velocity.x=0,this.velocity.y=0,h.angularVelocity.x=0,h.angularVelocity.y=0;else{const A=W/B;this.velocity.x*=A,this.velocity.y*=A,h.angularVelocity.x*=A,h.angularVelocity.y*=A}}}else{const E=Math.hypot(h.angularVelocity.x,h.angularVelocity.y);if(E>0&&F>0){const W=F/(x*w)*t,A=Math.max(0,E-W),q=E>0?A/E:0;h.angularVelocity.x*=q,h.angularVelocity.y*=q}}if(Math.abs(h.angularVelocity.z)>.001&&h.rollResistance>0){const E=h.rollResistance/(x*w)*t,W=Math.sign(h.angularVelocity.z),A=Math.abs(h.angularVelocity.z);h.angularVelocity.z=A<=E?0:W*(A-E)}h.updateVisualPhase(t)}else{const h=Math.hypot(this.velocity.x,this.velocity.y);if(h>0){const w=i.staticFrictionThreshold*this.staticGroundFrictionMod;if(h<w)this.velocity.x=0,this.velocity.y=0;else{const F=i.frictionCoeff*this.dynamicGroundFrictionMod*t,P=Math.max(0,h-F)/h;this.velocity.x*=P,this.velocity.y*=P}}}}else this.rollModule&&this.rollModule.enabled&&this.rollModule.updateVisualPhase(t);const l=this.isCharacter?this:null,n=l==null?void 0:l.climbingModule,o=!this.isClimbing&&this.supportingSurfaceHeight>=i.wallHeight-.05&&this.standingWall!==null,a=Math.max(.01,(n==null?void 0:n.hangDistance)??.1);if(n)if(this.position.z<=.01)n.isAssistClampArmed=!1,n.hasLeftClampZoneSinceDismount=!0;else if(o&&this.standingWall){const M=this.standingWall,h=[M];for(const x of i.walls)x.id!==M.id&&i.areWallsContiguous(M,x)&&h.push(x);let w=1/0;for(const x of h){const P=Math.max(x.x,Math.min(this.position.x,x.x+x.width)),R=Math.max(x.y,Math.min(this.position.y,x.y+x.height)),$=Math.hypot(this.position.x-P,this.position.y-R);$<w&&(w=$)}w<=a+.001?l.isClimbInputHeld&&!n.dismountSuppressedUntilRelease?(n.isAssistClampArmed=!1,n.hasLeftClampZoneSinceDismount=!1):n.hasLeftClampZoneSinceDismount&&(n.isAssistClampArmed=!0):(n.hasLeftClampZoneSinceDismount=!0,n.isAssistClampArmed=!1)}else n.isAssistClampArmed=!1;const d=!!(l&&o&&(n!=null&&n.enabled)&&(n!=null&&n.preventWalkOff)&&(n!=null&&n.isAssistClampArmed)),c=this.velocity.x*t,y=this.velocity.y*t,p=Math.hypot(c,y);if(p>1e-4)if(d){const M=Math.max(.01,((D=l==null?void 0:l.climbingModule)==null?void 0:D.hangDistance)??.1);let h=this.standingWall??i.getSupportingWall(this.position.x,this.position.y,M);this.standingWall=h;const w=this.position.x+c,F=this.position.y+y,x=[];if(h){x.push(h);for(const R of i.walls)R.id!==h.id&&i.areWallsContiguous(h,R)&&x.push(R)}let P=null;for(const R of x)if(i.testWallOverlap(w,F,M,R)){P=R;break}if(P)this.position.x=w,this.position.y=F,this.standingWall=P;else if(x.length>0){let R=1/0,$=null;for(const B of x){const E=Math.max(B.x,Math.min(w,B.x+B.width)),W=Math.max(B.y,Math.min(F,B.y+B.height)),A=w-E,q=F-W,H=A*A+q*q;H<R&&(R=H,$={wall:B,closestX:E,closestY:W,dist:Math.sqrt(H),dx:A,dy:q})}if($&&$.dist>0){const B=$.dx/$.dist,E=$.dy/$.dist,W=this.velocity.x*B+this.velocity.y*E;W>0&&(this.velocity.x-=W*B,this.velocity.y-=W*E);const A=M-.002;$.dist>A?(this.position.x=$.closestX+B*A,this.position.y=$.closestY+E*A):(this.position.x=w,this.position.y=F);const q=i.testWallOverlap(this.position.x,this.position.y,M,$.wall)?$.wall:x.find(H=>i.testWallOverlap(this.position.x,this.position.y,M,H));q&&(this.standingWall=q)}else this.velocity.x=0,this.velocity.y=0}}else{const h=Math.max(1,Math.ceil(p/.01)),w=c/h,F=y/h;let x=this.standingWall??(o?i.getSupportingWall(this.position.x,this.position.y,this.colliderRadius):null),P=!1;for(let R=1;R<=h;R++){const $=this.position.x+w,B=this.position.y+F;if(x){let W=null;if(i.testWallOverlap($,B,this.colliderRadius,x))W=x;else for(const A of i.walls)if(i.areWallsContiguous(x,A)&&i.testWallOverlap($,B,this.colliderRadius,A)){W=A;break}W?(x=W,this.standingWall=W):(V=l==null?void 0:l.climbingModule)!=null&&V.dismountSuppressedUntilRelease||(P=!0,x=null,this.standingWall=null,this.supportingSurfaceHeight=0,l!=null&&l.climbingModule&&(l.climbingModule.isDismountFreefall=!0,l.climbingModule.climbSuppressedUntilRelease=!0))}if(this.position.x=$,this.position.y=B,!this.isClimbing&&(P||!this.standingWall&&!!((C=l==null?void 0:l.climbingModule)!=null&&C.isDismountFreefall||(z=l==null?void 0:l.climbingModule)!=null&&z.climbSuppressedUntilRePress))&&this.hasCollider)for(const W of i.walls)this.position.z<=W.wallHeight&&this.resolveWallCollision(W)}}if(this.hasCollider){const M=this.colliderRadius,h=M,w=i.width-M,F=M,x=i.height-M,P=this.isCharacter?0:this.hasBounce&&this.bounceMod!==null?this.bounceMod:0;this.position.x<h?(this.position.x=h,this.resolveWallImpact(1,0,P)):this.position.x>w&&(this.position.x=w,this.resolveWallImpact(-1,0,P)),this.position.y<F?(this.position.y=F,this.resolveWallImpact(0,1,P)):this.position.y>x&&(this.position.y=x,this.resolveWallImpact(0,-1,P));const R=!!((L=l==null?void 0:l.climbingModule)!=null&&L.isDismountFreefall||(T=l==null?void 0:l.climbingModule)!=null&&T.climbSuppressedUntilRePress);for(const $ of i.walls)if(this.position.z<=$.wallHeight&&(this.position.z<$.wallHeight-.05||R||this.standingWall===null)){if(this.standingWall&&(this.standingWall.id===$.id||i.areWallsContiguous(this.standingWall,$)))continue;this.resolveWallCollision($)}}const v=16,g=Math.hypot(this.velocity.x,this.velocity.y);if(g>v){const M=v/g;this.velocity.x*=M,this.velocity.y*=M}if(this.rollModule&&this.rollModule.enabled){const h=this.rollModule.angularSpeed;if(h>35){const w=35/h;this.rollModule.angularVelocity.x*=w,this.rollModule.angularVelocity.y*=w,this.rollModule.angularVelocity.z*=w}}this.verticalPositionModule&&(this.verticalPositionModule.z=this.position.z)}static getClosestWallPoint(t,i,s){if(!s.walls||s.walls.length===0)return null;let e=1/0,l=null;for(const n of s.walls){const o=Math.max(n.x,Math.min(t,n.x+n.width)),a=Math.max(n.y,Math.min(i,n.y+n.height)),d=t-o,c=i-a,y=d*d+c*c;y<e&&(e=y,l={wall:n,closestX:o,closestY:a,dist:Math.sqrt(y),dx:d,dy:c})}return l}resolveWallImpact(t,i,s){this.lastThrower=null;const e=this.velocity.x*t+this.velocity.y*i;if(e>=0)return;const l=e;if(s>0&&this.hasMass?(this.velocity.x-=(1+s)*l*t,this.velocity.y-=(1+s)*l*i):(this.velocity.x-=l*t,this.velocity.y-=l*i),this.hasFriction&&this.rollModule&&this.rollModule.enabled){const n=this.rollModule,o=this.colliderRadius>0?this.colliderRadius:.3,a=.4,d=.35,c=-i,y=t,p=this.velocity.x*c+this.velocity.y*y,v=-(1+s)*this.mass*l,g=p-n.angularVelocity.z*o,m=Math.abs(g)*this.mass/(1+1/a),S=d*v,f=Math.min(m,S),b=-Math.sign(g)*f,k=p,D=k+b/this.mass,V=Math.abs(D)<=Math.abs(k)+.01?D-k:-k*.1;this.velocity.x+=V*c,this.velocity.y+=V*y;const z=-(V*this.mass)/(a*this.mass*o);n.angularVelocity.z+=z,n.angularVelocity.z=Math.max(-30,Math.min(30,n.angularVelocity.z)),n.angularVelocity.y=this.velocity.x/o,n.angularVelocity.x=-this.velocity.y/o}}resolveWallCollision(t){if(!this.hasCollider)return;const i=this.colliderRadius,s=Math.max(t.x,Math.min(this.position.x,t.x+t.width)),e=Math.max(t.y,Math.min(this.position.y,t.y+t.height)),l=this.position.x-s,n=this.position.y-e,o=l*l+n*n;if(o<i*i){this.lastThrower=null;const a=Math.sqrt(o);let d=0,c=0,y=0;if(a===0){const v=Math.abs(this.position.x-t.x),g=Math.abs(t.x+t.width-this.position.x),m=Math.abs(this.position.y-t.y),S=Math.abs(t.y+t.height-this.position.y),f=Math.min(v,g,m,S);f===v?(d=-1,y=v+i):f===g?(d=1,y=g+i):f===m?(c=-1,y=m+i):(c=1,y=S+i)}else y=i-a,d=l/a,c=n/a;this.position.x+=d*y,this.position.y+=c*y;const p=this.isCharacter?0:this.hasBounce&&this.bounceMod!==null?this.bounceMod:0;this.resolveWallImpact(d,c,p)}}}class Pt{constructor(){r(this,"id","walking");r(this,"name","Walking Module");r(this,"enabled",!0);r(this,"maxWalkForce",35);r(this,"maxWalkSpeed",5.2);r(this,"dragDamping",8.01)}update(t,i,s,e){var L;if(!this.enabled||!t.isRestingOnSurface||t.isClimbing){t.isActivelyWalking=!1;return}if(!t.hasFriction||!((L=t.frictionModule)!=null&&L.enabled)||!t.hasMass||!t.hasStrength||t.strength<=0){t.isActivelyWalking=!1;return}const l=Math.hypot(i.x,i.y),n=l>.05;if(t.isActivelyWalking=n,t.mass<=.01)return;const a=t.dynamicGroundFrictionMod;if(a<=.001)return;const d=e.frictionCoeff/10,c=a*d,p=t.carriedMass/(Math.max(.1,t.strength)*8),v=this.maxWalkSpeed/(1+p);let g=0,m=0;if(n){const T=i.x/l,M=i.y/l;g=T*v,m=M*v}const S=g-t.velocity.x,f=m-t.velocity.y,b=Math.hypot(S,f);if(b<.001){t.velocity.x=g,t.velocity.y=m;return}const k=Math.hypot(t.velocity.x,t.velocity.y),D=Math.max(.02,e.staticFrictionThreshold*t.staticGroundFrictionMod),V=t.hasMass?Math.max(.2,t.baseMass):1,z=this.maxWalkForce*t.strength/V*c*s;if(b<=z||!n&&k<D)t.velocity.x=g,t.velocity.y=m;else{const T=z/b;t.velocity.x+=S*T,t.velocity.y+=f*T}}}class Rt{constructor(){r(this,"id","pickup");r(this,"name","Pickup Ability");r(this,"enabled",!0);r(this,"pickupReach",1.3);r(this,"crossLayerReachRatio",.55)}isObjectInReach(t,i,s=1){var c;if(!this.enabled||i===t||i.isHeld||i.isCharacter||i.lastThrower===t)return!1;const e=t.position.z>=s-.05?1:0,l=i.position.z>=s-.05?1:0,o=e!==l?this.pickupReach*this.crossLayerReachRatio:this.pickupReach,a=i.hasCollider?i.colliderRadius:((c=i.colliderModule)==null?void 0:c.radius)??.32;return Math.hypot(i.position.x-t.position.x,i.position.y-t.position.y)<=o+a}findTargetObject(t,i,s,e,l=1){if(!this.enabled)return null;let n=null,o=1/0;for(const a of e){if(!this.isObjectInReach(t,a,l))continue;const d=Math.hypot(a.position.x-i,a.position.y-s);d<o&&(o=d,n=a)}return n}pickup(t,i){if(!this.enabled||t.heldObject)return!1;const s=i.velocity.x,e=i.velocity.y,l=i.mass/Math.max(.2,t.mass);return t.velocity.x+=s*l,t.velocity.y+=e*l,t.isAboveGround&&Math.abs(i.verticalVelocity)>.1&&(t.verticalVelocity+=i.verticalVelocity*l),t.heldObject=i,i.isHeld=!0,i.heldBy=t,i.velocity.x=0,i.velocity.y=0,i.verticalVelocity=0,i.position.z=i.hasVerticalPosition?.45:0,!0}drop(t){if(!t.heldObject)return null;const i=t.heldObject;return t.heldObject=null,i.isHeld=!1,i.heldBy=null,i.velocity.x=t.velocity.x*.4,i.velocity.y=t.velocity.y*.4,i.verticalVelocity=0,i}}class Wt{constructor(){r(this,"id","throw");r(this,"name","Throw Ability");r(this,"enabled",!0);r(this,"baseThrowForce",7.6);r(this,"maxThrowAimDistance",13)}testWallIntersection(t,i,s,e){const l=Math.max(e.x,Math.min(t,e.x+e.width)),n=Math.max(e.y,Math.min(i,e.y+e.height)),o=t-l,a=i-n;return o*o+a*a<s*s}computeLaunchVelocity(t,i,s,e,l,n,o,a=!0,d=!0,c=.35){const y=e-t,p=l-i,v=Math.hypot(y,p);if(v<.1)return null;const g=Math.min(v,this.maxThrowAimDistance),m=y/v,S=p/v,f=t+m*g,b=i+S*g;if(!a||!d){const P=Math.max(3,o),R=Math.max(.14,g/P),$=m*P,B=S*P;return{vx:$,vy:B,vz:0,totalTime:R,finalTargetX:f,finalTargetY:b,targetSurfaceHeight:s}}const k=n.getSupportingSurfaceHeight(f,b),D=k-s,V=Math.max(3,o);let z=Math.max(.14,g/V);D>0&&(z=Math.max(z,Math.sqrt(2*D/n.gravity)));const L=40,T=c>0?c:.35,M=.25;for(let P=1;P<L;P++){const R=P/L,$=t+(f-t)*R,B=i+(b-i)*R;for(const E of n.walls)if(this.testWallIntersection($,B,T,E)){if(k>0&&f>=E.x&&f<=E.x+E.width&&b>=E.y&&b<=E.y+E.height&&R>.65)continue;const A=(1-R)*s+R*k,H=E.wallHeight+M-A;if(H>0){const j=n.gravity*R*(1-R);if(j>.001){const G=2*H/j;if(G>0){const U=Math.sqrt(G);U>z&&(z=U)}}}}}if(z<=.05)return null;const h=(D+.5*n.gravity*z*z)/z,w=g/z,F=m*w,x=S*w;return{vx:F,vy:x,vz:h,totalTime:z,finalTargetX:f,finalTargetY:b,targetSurfaceHeight:k}}calculateTrajectory(t,i,s,e){if(!this.enabled||!t.heldObject)return null;const l=t.heldObject,n=l.position.x,o=l.position.y,a=l.position.z,d=this.baseThrowForce*t.strength,c=l.hasGravity&&l.hasVerticalVelocity,y=this.computeLaunchVelocity(n,o,a,i,s,e,d,l.hasGravity,l.hasVerticalVelocity,l.colliderRadius);if(!y)return null;const{vx:p,vy:v,vz:g,totalTime:m,finalTargetX:S,finalTargetY:f,targetSurfaceHeight:b}=y,k=90,D=m/k,V=[];let C=!1,z=b>0,L;for(let M=0;M<=k;M++){const h=M*D,w=M===k?S:n+p*h,F=M===k?f:o+v*h,x=c?a+g*h-.5*e.gravity*h*h:a,P=c?M===k?b:Math.max(b,x):a,R=c?g-e.gravity*h:0,$=P>e.wallHeight;let B=!1,E=!1;for(const W of e.walls)if(this.testWallIntersection(w,F,l.colliderRadius,W)&&(B=!0,P<=W.wallHeight+.001)){if(V.length>0&&V[V.length-1].z>=W.wallHeight-.05&&R<=0){if(b>0&&(M>=k-2||Math.hypot(w-S,F-f)<.2)){z=!0;break}else if(b===0){z=!0,E=!0,C=!0,L=W.id;break}}else if(P<W.wallHeight-.05){E=!0,C=!0,L=W.id;break}}if(V.push({x:w,y:F,z:P,t:h,couldClearWall:$,isOverWall:B,collidesWall:E}),E)break}const T=V[V.length-1];return{points:V,landPoint:{x:C?T.x:S,y:C?T.y:f},isBlockedByWall:C,isLandingOnWallTop:C?z:b>0,blockedAtWallId:L}}throwHeldObject(t,i,s,e){if(!this.enabled||!t.heldObject)return null;const l=t.heldObject,n=l.position.x,o=l.position.y,a=l.position.z,d=this.baseThrowForce*t.strength,c=this.computeLaunchVelocity(n,o,a,i,s,e,d,l.hasGravity,l.hasVerticalVelocity,l.colliderRadius);if(!c)return null;if(l.isHeld=!1,l.heldBy=null,l.lastThrower=t,l.velocity.x=c.vx,l.velocity.y=c.vy,l.verticalVelocity=c.vz,l.position.z=l.hasVerticalPosition?Math.max(.3,l.position.z):0,l.hasFriction&&l.rollModule&&l.rollModule.enabled){const S=l.colliderRadius>0?l.colliderRadius:.3;l.rollModule.angularVelocity.y=c.vx/S,l.rollModule.angularVelocity.x=-c.vy/S}const y=l.hasMass?l.mass:0,p=t.hasMass?Math.max(.2,t.baseMass):0,v=y>0&&p>0?y/p:0;t.heldObject=null;const g=c.vx-t.velocity.x,m=c.vy-t.velocity.y;if(t.velocity.x-=g*v,t.velocity.y-=m*v,t.isAboveGround&&l.hasVerticalVelocity){const S=c.vz-t.verticalVelocity;t.verticalVelocity-=S*v}return l}}class Ft{constructor(t){r(this,"id","climbing");r(this,"name","Climbing Module");r(this,"enabled",!0);r(this,"maxAdhesion",35);r(this,"maxClimbSpeed",3);r(this,"preventWalkOff",!0);r(this,"horizontalClimb",!1);r(this,"hangDistance",.1);r(this,"dismountSuppressedUntilRelease",!1);r(this,"climbSuppressedUntilRelease",!1);r(this,"isDismountFreefall",!1);r(this,"isAssistClampArmed",!1);r(this,"hasLeftClampZoneSinceDismount",!0);r(this,"wasClimbHeldLastTick",!1);(t==null?void 0:t.maxAdhesion)!==void 0&&(this.maxAdhesion=t.maxAdhesion),(t==null?void 0:t.maxClimbSpeed)!==void 0&&(this.maxClimbSpeed=t.maxClimbSpeed),(t==null?void 0:t.preventWalkOff)!==void 0&&(this.preventWalkOff=t.preventWalkOff),(t==null?void 0:t.horizontalClimb)!==void 0&&(this.horizontalClimb=t.horizontalClimb),(t==null?void 0:t.hangDistance)!==void 0&&(this.hangDistance=t.hangDistance)}get climbSuppressedUntilRePress(){return this.isDismountFreefall||this.climbSuppressedUntilRelease}set climbSuppressedUntilRePress(t){this.isDismountFreefall=t,this.climbSuppressedUntilRelease=t}update(t,i,s,e,l){const n=s&&!this.wasClimbHeldLastTick;if(this.wasClimbHeldLastTick=s,s||(this.dismountSuppressedUntilRelease=!1,this.climbSuppressedUntilRelease=!1),(t.position.z<=.01||n)&&(this.isDismountFreefall=!1,t.position.z<=.01&&(this.isAssistClampArmed=!1,this.hasLeftClampZoneSinceDismount=!0)),this.climbSuppressedUntilRelease||!this.enabled||!t.hasVerticalPosition||!t.hasStrength||t.strength<=0)return t.isClimbing=!1,!1;const o=t.hasCollider?t.colliderRadius:.44,a=Math.hypot(i.x,i.y),d=a>=.05,c=d?i.x/a:0,y=d?i.y/a:0;if(!t.isClimbing&&(t.standingWall!==null||t.position.z>=l.wallHeight))return t.isClimbing=!1,!1;let p=null,v=1/0,g=0,m=0,S=0;for(const V of l.walls){const C=Math.max(V.x,Math.min(t.position.x,V.x+V.width)),z=Math.max(V.y,Math.min(t.position.y,V.y+V.height)),L=C-t.position.x,T=z-t.position.y,M=Math.hypot(L,T);M<=o+.15&&M<v&&(v=M,p=V,g=d?c*L+y*T:0,m=L,S=T)}if(!p)return t.isClimbing=!1,!1;const f=t.mass;if(f*l.gravity>this.maxAdhesion)return t.isClimbing=!1,!1;const k=t.isClimbing;if(k&&t.position.z<p.wallHeight){const V=v>.001?m/v:0,C=v>.001?S/v:0,z=-C,L=V,T=d?c*V+y*C:0,M=d?c*z+y*L:0;if(d&&(T<-.3||!this.horizontalClimb&&g<-.1))return t.isClimbing=!1,t.velocity.x=c*3,t.velocity.y=y*3,s&&(this.climbSuppressedUntilRelease=!0),!1;if(t.isClimbing=!0,t.verticalVelocity=0,t.standingWall=null,this.horizontalClimb&&d&&Math.abs(M)>=.1){const h=t.baseMass,w=Math.max(.5,Math.min(this.maxClimbSpeed,this.maxClimbSpeed*h*t.strength/Math.max(.1,f)));t.velocity.x=z*M*w,t.velocity.y=L*M*w}else t.velocity.x=0,t.velocity.y=0;if(s){const h=t.baseMass,w=Math.max(.2,Math.min(this.maxClimbSpeed,this.maxClimbSpeed*h*t.strength/Math.max(.1,f)));t.position.z+=w*e,t.position.z>=p.wallHeight&&(t.position.z=p.wallHeight,t.supportingSurfaceHeight=p.wallHeight,t.standingWall=p,t.verticalVelocity=0,t.isClimbing=!1,this.dismountSuppressedUntilRelease=!0,this.isAssistClampArmed=!1,this.hasLeftClampZoneSinceDismount=!0)}return!0}if(!k&&t.position.z>.05&&t.position.z<p.wallHeight)return n?(t.isClimbing=!0,t.verticalVelocity=0,t.velocity.x=0,t.velocity.y=0,!0):(t.isClimbing=!1,!1);if(s&&d&&g>.01&&v<=o+.03&&t.position.z<p.wallHeight){if(v>.001){const z=m/v,L=S/v;t.position.x=t.position.x+m-z*o,t.position.y=t.position.y+S-L*o}t.isClimbing=!0,t.verticalVelocity=0,t.velocity.x=0,t.velocity.y=0;const V=t.baseMass,C=Math.max(.2,Math.min(this.maxClimbSpeed,this.maxClimbSpeed*V*t.strength/Math.max(.1,f)));return t.position.z+=C*e,!0}return t.isClimbing=!1,!1}}class wt{constructor(t={}){r(this,"id","strength");r(this,"name","Strength Module");r(this,"enabled",!0);r(this,"strength",1);this.strength=t.strength??1,this.enabled=t.enabled??!0}}class xt extends tt{constructor(i={}){super({name:"Player Character",position:{x:i.x??5,y:i.y??7,z:0},mass:i.mass??1.2,colliderRadius:i.colliderRadius??.44,color:i.color??"#f59e0b",bounceMod:.1});r(this,"strengthModule");r(this,"facingAngle");r(this,"heldObject");r(this,"isCharacter",!0);r(this,"isActivelyWalking",!1);r(this,"isClimbInputHeld",!1);r(this,"baseMass",1.2);r(this,"walkingModule");r(this,"pickupModule");r(this,"throwModule");r(this,"climbingModule");r(this,"isAiming");r(this,"aimTarget");r(this,"activeTrajectory");this.baseMass=i.mass??1.2,this.strength=i.strength??1,this.facingAngle=0,this.heldObject=null,this.isAiming=!1,this.aimTarget=null,this.activeTrajectory=null,this.strengthModule=new wt({strength:i.strength??1}),this.walkingModule=new Pt,this.pickupModule=new Rt,this.throwModule=new Wt,this.climbingModule=new Ft}get hasStrength(){return!!(this.strengthModule&&this.strengthModule.enabled&&this.strengthModule.strength>0)}get strength(){return this.hasStrength?this.strengthModule.strength:0}set strength(i){this.strengthModule?this.strengthModule.strength=Math.max(.1,i):this.strengthModule=new wt({strength:i})}get mass(){const i=this.hasMass?this.baseMass:0,s=this.heldObject&&this.heldObject.hasMass?this.heldObject.mass:0;return i+s}set mass(i){this.baseMass=Math.max(.1,i),this.massModule&&(this.massModule.mass=this.baseMass)}get carriedMass(){return this.heldObject&&this.heldObject.hasMass?this.heldObject.mass:0}get hangDistance(){return this.climbingModule?this.climbingModule.hangDistance:.1}set hangDistance(i){this.climbingModule&&(this.climbingModule.hangDistance=Math.max(0,i))}updateFacingDirection(i,s,e){if((this.heldObject!==null||i)&&s&&(this.throwModule!==null||this.pickupModule!==null)){const l=s.x-this.position.x,n=s.y-this.position.y;if(Math.hypot(l,n)>.1){this.facingAngle=Math.atan2(n,l);return}}e&&Math.hypot(e.x,e.y)>.05&&(this.facingAngle=Math.atan2(e.y,e.x))}updateCharacter(i,s,e,l,n,o=!1){if(this.isClimbInputHeld=o,this.climbingModule&&this.climbingModule.update(this,s,o,i,n),this.walkingModule&&this.walkingModule.update(this,s,i,n),this.updatePosition(i,n),this.updateFacingDirection(e,l,s),this.heldObject){const a=this.colliderRadius+this.heldObject.colliderRadius*.5+.08;this.heldObject.position.x=this.position.x+Math.cos(this.facingAngle)*a,this.heldObject.position.y=this.position.y+Math.sin(this.facingAngle)*a,this.heldObject.position.z=this.heldObject.hasVerticalPosition?this.position.z+.45:0,this.heldObject.velocity.x=this.velocity.x,this.heldObject.velocity.y=this.velocity.y,this.heldObject.verticalVelocity=0}this.isAiming=this.heldObject!==null||e,this.aimTarget=l,this.heldObject&&this.throwModule&&l?this.activeTrajectory=this.throwModule.calculateTrajectory(this,l.x,l.y,n):this.activeTrajectory=null}}class Mt{constructor(t={}){r(this,"enabled",!0);r(this,"angularVelocity",{x:0,y:0,z:0});r(this,"rollResistance",.4);r(this,"visualPhase",0);var i,s,e;this.enabled=t.enabled??!0,this.angularVelocity={x:((i=t.angularVelocity)==null?void 0:i.x)??0,y:((s=t.angularVelocity)==null?void 0:s.y)??0,z:((e=t.angularVelocity)==null?void 0:e.z)??0},this.rollResistance=t.rollResistance??.4}get angularSpeed(){return Math.hypot(this.angularVelocity.x,this.angularVelocity.y,this.angularVelocity.z)}updateVisualPhase(t){const i=this.angularSpeed;i>.001&&(this.visualPhase=(this.visualPhase+i*t)%(Math.PI*2))}}class rt{constructor(t){r(this,"ctx");this.ctx=t}render(t,i,s,e,l=!1,n,o,a=!1,d){const c=this.ctx,y=c.canvas.width/t.width;c.clearRect(0,0,c.canvas.width,c.canvas.height),this.drawFloorGrid(t,y),this.drawWalls(t,y),a&&d&&this.drawWallEditorHover(t,d,y);const p=[i,...s];p.sort((v,g)=>Math.abs(v.position.z-g.position.z)>.001?v.position.z-g.position.z:Math.abs(v.verticalVelocity-g.verticalVelocity)>.001?v.verticalVelocity-g.verticalVelocity:v.position.y-g.position.y);for(const v of p)v instanceof xt?this.drawCharacter(v,p,y,t):this.drawFreebodyObject(v,p,i,y,v===o,t),this.drawObjectShadow(v,t,y);i.activeTrajectory&&this.drawTrajectory(i.activeTrajectory,y),l&&(n&&n!==e&&this.drawHoverGizmo(n,y),e&&this.drawSelectionGizmo(e,l,y))}drawFloorGrid(t,i){const s=this.ctx;s.fillStyle="#0f172a",s.fillRect(0,0,t.width*i,t.height*i),s.strokeStyle="rgba(148, 163, 184, 0.08)",s.lineWidth=1;for(let e=1;e<t.width;e++)s.beginPath(),s.moveTo(e*i,0),s.lineTo(e*i,t.height*i),s.stroke();for(let e=1;e<t.height;e++)s.beginPath(),s.moveTo(0,e*i),s.lineTo(t.width*i,e*i),s.stroke();s.strokeStyle="rgba(148, 163, 184, 0.35)",s.lineWidth=3,s.strokeRect(1.5,1.5,t.width*i-3,t.height*i-3)}drawWalls(t,i){const s=this.ctx;for(const e of t.walls)s.fillStyle="#1e293b",s.fillRect(e.x*i,e.y*i,e.width*i,e.height*i),s.strokeStyle="#475569",s.lineWidth=2,s.strokeRect(e.x*i,e.y*i,e.width*i,e.height*i)}drawWallEditorHover(t,i,s){if(i.col<0||i.col>=t.cols||i.row<0||i.row>=t.rows)return;const e=this.ctx,l=i.col*t.tileSize*s,n=i.row*t.tileSize*s,o=t.tileSize*s,a=t.hasWall(i.col,i.row);e.save(),a?(e.fillStyle="rgba(239, 68, 68, 0.35)",e.strokeStyle="#ef4444",e.lineWidth=2.5,e.fillRect(l,n,o,o),e.strokeRect(l,n,o,o),e.font="bold 12px system-ui, sans-serif",e.fillStyle="#fca5a5",e.textAlign="center",e.textBaseline="middle",e.fillText("✕ Erase",l+o/2,n+o/2)):(e.fillStyle="rgba(56, 189, 248, 0.3)",e.strokeStyle="#38bdf8",e.lineWidth=2.5,e.fillRect(l,n,o,o),e.strokeRect(l,n,o,o),e.font="bold 12px system-ui, sans-serif",e.fillStyle="#7dd3fc",e.textAlign="center",e.textBaseline="middle",e.fillText("+ Draw",l+o/2,n+o/2)),e.restore()}static getAltitudeScale(t,i){return 1+Math.max(0,t)/Math.max(.1,i)*.5}isEntityPassingOverAnother(t,i,s){var a,d;const e=t.position.z,l=rt.getAltitudeScale(e,s.wallHeight),n=t.hasCollider?t.colliderRadius:((a=t.colliderModule)==null?void 0:a.radius)??.32,o=n*l;for(const c of i){if(c===t)continue;const y=c.position.z;if(!(e>y+.001||Math.abs(e-y)<=.01&&t.verticalVelocity>c.verticalVelocity))continue;const v=rt.getAltitudeScale(y,s.wallHeight),g=c.hasCollider?c.colliderRadius:((d=c.colliderModule)==null?void 0:d.radius)??.32,m=g*v,S=Math.hypot(t.position.x-c.position.x,t.position.y-c.position.y),f=Math.max(n+g,o+m*.7);if(S<f)return!0}return!1}drawObjectShadow(t,i,s){const e=this.ctx,l=t.position.x*s,n=t.position.y*s,o=t.position.z,a=t.colliderRadius*s,d=o>=i.wallHeight-.001;if(e.save(),e.beginPath(),t.visualShape==="box"){const c=a*2,y=Math.max(3,a*.16);e.roundRect?e.roundRect(l-a,n-a,c,c,y):e.rect(l-a,n-a,c,c)}else e.arc(l,n,a,0,Math.PI*2);o>.01&&e.setLineDash([7,4]),e.strokeStyle="rgba(0, 0, 0, 0.85)",e.lineWidth=d?5.2:4,e.stroke(),d?(e.strokeStyle="#38bdf8",e.lineWidth=3.2,e.shadowColor="#0284c7",e.shadowBlur=8):(e.strokeStyle="#ffffff",e.lineWidth=2.2),e.stroke(),e.restore()}drawFreebodyObject(t,i,s,e,l=!1,n){var S,f;const o=this.ctx,a=t.position.x*e,d=t.position.y*e,c=rt.getAltitudeScale(t.position.z,n.wallHeight),p=(t.hasCollider?t.colliderRadius:((S=t.colliderModule)==null?void 0:S.radius)??.32)*e*c,g=!s.heldObject&&s.pickupModule!==null&&s.pickupModule.enabled&&!t.isHeld&&(((f=s.pickupModule)==null?void 0:f.isObjectInReach(s,t,n.wallHeight))??!1);if(g){if(o.save(),o.beginPath(),t.visualShape==="box"){const b=(p+5)*2;o.roundRect?o.roundRect(a-p-5,d-p-5,b,b,6):o.rect(a-p-5,d-p-5,b,b)}else o.arc(a,d,p+5,0,Math.PI*2);l?(o.strokeStyle="#38bdf8",o.lineWidth=3,o.setLineDash([]),o.stroke(),o.fillStyle="#38bdf8",o.font="bold 11px sans-serif",o.textAlign="center",o.fillText("GRAB",a,d-p-8)):(o.strokeStyle="rgba(56, 189, 248, 0.45)",o.lineWidth=1.8,o.setLineDash([4,4]),o.stroke()),o.restore()}const m=this.isEntityPassingOverAnother(t,i,n);if(o.save(),o.globalAlpha=m?.55:1,t.visualShape==="box"){const b=p*2,k=Math.max(3,p*.16),D=a-p,V=d-p;o.beginPath(),o.roundRect?o.roundRect(D,V,b,b,k):o.rect(D,V,b,b),o.fillStyle=t.color,o.fill(),o.strokeStyle=g?"#ffffff":"rgba(255, 255, 255, 0.45)",o.lineWidth=g?2.5:2,o.stroke();const C=Math.max(3,p*.22);o.beginPath(),o.roundRect?o.roundRect(D+C,V+C,b-C*2,b-C*2,k*.7):o.rect(D+C,V+C,b-C*2,b-C*2),o.strokeStyle="rgba(0, 0, 0, 0.25)",o.lineWidth=1.6,o.stroke(),o.beginPath(),o.moveTo(D+C,V+C),o.lineTo(D+b-C,V+b-C),o.moveTo(D+b-C,V+C),o.lineTo(D+C,V+b-C),o.strokeStyle="rgba(0, 0, 0, 0.16)",o.lineWidth=1.4,o.stroke()}else o.beginPath(),o.arc(a,d,p,0,Math.PI*2),o.fillStyle=t.color,o.fill(),o.strokeStyle=g?"#ffffff":"rgba(255, 255, 255, 0.45)",o.lineWidth=g?2.5:2,o.stroke();this.drawRollIndicator(t,a,d,p),o.restore()}drawCharacter(t,i,s,e){const l=this.ctx,n=t.position.x*s,o=t.position.y*s,a=rt.getAltitudeScale(t.position.z,e.wallHeight),d=t.colliderRadius*s*a,c=this.isEntityPassingOverAnother(t,i,e);l.save(),l.globalAlpha=c?.55:1,l.beginPath(),l.arc(n,o,d,0,Math.PI*2),l.fillStyle=t.color,l.fill(),l.strokeStyle="#ffffff",l.lineWidth=2.5,l.stroke(),this.drawRollIndicator(t,n,o,d);const y=.52,p=d*.72,v=Math.max(3.5,d*.18),g=t.facingAngle-y,m=t.facingAngle+y,S=n+Math.cos(g)*p,f=o+Math.sin(g)*p,b=n+Math.cos(m)*p,k=o+Math.sin(m)*p;l.fillStyle="#000000",l.beginPath(),l.arc(S,f,v,0,Math.PI*2),l.arc(b,k,v,0,Math.PI*2),l.fill(),t.heldObject&&(l.strokeStyle="rgba(255, 255, 255, 0.6)",l.setLineDash([3,3]),l.lineWidth=1.5,l.beginPath(),l.moveTo(n,o),l.lineTo(t.heldObject.position.x*s,t.heldObject.position.y*s),l.stroke(),l.setLineDash([])),l.restore()}drawRollIndicator(t,i,s,e){if(!t.rollModule||!t.rollModule.enabled)return;const l=t.rollModule,n=l.angularVelocity.x,o=l.angularVelocity.y,a=l.angularVelocity.z,d=Math.hypot(n,o,a);if(d<.02)return;const c=this.ctx,p=Math.hypot(n,o)<.05*d,v=2.5,g=5,m=4;if(c.save(),c.shadowColor="rgba(0, 0, 0, 0.75)",c.shadowBlur=3,p){const S=e*.5,f=e*.88;c.beginPath(),c.arc(i,s,S,0,Math.PI*2),c.strokeStyle="rgba(255, 255, 255, 0.5)",c.lineWidth=1.8,c.setLineDash([]),c.stroke(),c.beginPath(),c.arc(i,s,f,0,Math.PI*2),c.strokeStyle="rgba(255, 255, 255, 0.98)",c.lineWidth=v,c.setLineDash([g,m]),c.lineDashOffset=-l.visualPhase*f*Math.sign(a||1),c.stroke()}else{const S=Math.atan2(-n,o),f=e*.9,b=Math.abs(a)/d,k=f*Math.max(.35,Math.pow(b,.65));c.translate(i,s),c.rotate(S);const D=a!==0?Math.sign(a):1;c.beginPath(),c.ellipse(0,0,f,k,0,0,Math.PI),c.strokeStyle="rgba(255, 255, 255, 0.98)",c.lineWidth=v,c.setLineDash([g,m]),c.lineDashOffset=-l.visualPhase*f*D,c.stroke(),c.beginPath(),c.ellipse(0,0,f,k,0,Math.PI,Math.PI*2),c.strokeStyle="rgba(255, 255, 255, 0.35)",c.lineWidth=1.8,c.setLineDash([g,m]),c.lineDashOffset=-l.visualPhase*f*D,c.stroke()}c.restore()}drawTrajectory(t,i){const s=this.ctx,e=t.points;if(e.length<2)return;s.save();for(let n=0;n<e.length-1;n++){const o=e[n],a=e[n+1];s.beginPath(),s.moveTo(o.x*i,o.y*i),s.lineTo(a.x*i,a.y*i),o.couldClearWall||a.couldClearWall?(s.strokeStyle="#38bdf8",s.lineWidth=4,s.setLineDash([6,3])):(s.strokeStyle="#f59e0b",s.lineWidth=2.5,s.setLineDash([4,4])),s.stroke()}const l=e[e.length-1];if(t.isBlockedByWall){s.strokeStyle="#ef4444",s.lineWidth=3,s.setLineDash([]);const n=8;s.beginPath(),s.moveTo(l.x*i-n,l.y*i-n),s.lineTo(l.x*i+n,l.y*i+n),s.moveTo(l.x*i+n,l.y*i-n),s.lineTo(l.x*i-n,l.y*i+n),s.stroke()}else t.isLandingOnWallTop?(s.strokeStyle="#38bdf8",s.fillStyle="rgba(56, 189, 248, 0.35)",s.lineWidth=2.5,s.setLineDash([]),s.beginPath(),s.arc(t.landPoint.x*i,t.landPoint.y*i,14,0,Math.PI*2),s.fill(),s.stroke(),s.beginPath(),s.arc(t.landPoint.x*i,t.landPoint.y*i,4,0,Math.PI*2),s.fillStyle="#38bdf8",s.fill()):(s.strokeStyle="#22c55e",s.fillStyle="rgba(34, 197, 94, 0.25)",s.lineWidth=2,s.setLineDash([]),s.beginPath(),s.arc(t.landPoint.x*i,t.landPoint.y*i,14,0,Math.PI*2),s.fill(),s.stroke(),s.beginPath(),s.arc(t.landPoint.x*i,t.landPoint.y*i,4,0,Math.PI*2),s.fillStyle="#22c55e",s.fill());s.restore()}drawHoverGizmo(t,i){var a;const s=this.ctx,e=t.position.x*i,l=t.position.y*i,o=((t.hasCollider?t.colliderRadius:((a=t.colliderModule)==null?void 0:a.radius)??.32)+.08)*i;s.save(),s.strokeStyle="rgba(251, 191, 36, 0.6)",s.lineWidth=1.5,s.setLineDash([4,4]),s.beginPath(),s.arc(e,l,o,0,Math.PI*2),s.stroke(),s.restore()}drawSelectionGizmo(t,i,s){var p;const e=this.ctx,l=t.position.x*s,n=t.position.y*s,d=(t.hasCollider?t.colliderRadius:((p=t.colliderModule)==null?void 0:p.radius)??.32)*s+6,c=Math.max(6,d*.4),y=i?"#fbbf24":"#38bdf8";if(e.save(),e.strokeStyle=y,e.lineWidth=2,e.setLineDash([]),e.beginPath(),e.moveTo(l-d,n-d+c),e.lineTo(l-d,n-d),e.lineTo(l-d+c,n-d),e.stroke(),e.beginPath(),e.moveTo(l+d-c,n-d),e.lineTo(l+d,n-d),e.lineTo(l+d,n-d+c),e.stroke(),e.beginPath(),e.moveTo(l+d,n+d-c),e.lineTo(l+d,n+d),e.lineTo(l+d-c,n+d),e.stroke(),e.beginPath(),e.moveTo(l-d+c,n+d),e.lineTo(l-d,n+d),e.lineTo(l-d,n+d-c),e.stroke(),i){const v=`${t.name} (${t.mass.toFixed(1)}kg)`;e.font="bold 10px 'Segoe UI', system-ui, sans-serif";const m=e.measureText(v).width+12,S=16,f=l-m/2,b=n-d-S-4;e.fillStyle="rgba(15, 23, 42, 0.85)",e.strokeStyle=y,e.lineWidth=1,e.beginPath(),e.roundRect(f,b,m,S,4),e.fill(),e.stroke(),e.fillStyle=y,e.textAlign="center",e.textBaseline="middle",e.fillText(v,l,b+S/2)}e.restore()}}class At{constructor(t,i){r(this,"canvas");r(this,"arena");r(this,"keysPressed",new Set);r(this,"mousePos",{x:0,y:0});r(this,"isMouseDown",!1);r(this,"isRightMouseDown",!1);r(this,"hoverWallTile",null);r(this,"movementVector",{x:0,y:0});r(this,"justPickedUp",!1);r(this,"isThrowingPress",!1);r(this,"hoverEntity",null);r(this,"selectedCanvasEntity",null);r(this,"draggedEntity",null);r(this,"dragOffset",{x:0,y:0});r(this,"handleClick");r(this,"onMouseDown");r(this,"onRightMouseDown");r(this,"onMouseUp");r(this,"onRightClick");r(this,"onDropAttempt");r(this,"onMouseMove");this.canvas=t,this.arena=i,this.setupListeners()}get isGrabHeld(){return!this.isThrowingPress&&this.isMouseDown}get isClimbHeld(){return this.keysPressed.has("Space")}setupListeners(){window.addEventListener("keydown",t=>{this.keysPressed.add(t.code),this.updateMovementVector(),t.code==="KeyE"&&this.onDropAttempt&&this.onDropAttempt()}),window.addEventListener("keyup",t=>{this.keysPressed.delete(t.code),this.updateMovementVector()}),this.canvas.addEventListener("mousemove",t=>{this.updateMousePos(t),this.onMouseMove&&this.onMouseMove(this.mousePos.x,this.mousePos.y)}),this.canvas.addEventListener("mousedown",t=>{if(this.updateMousePos(t),t.button===2){this.isRightMouseDown=!0,this.onRightMouseDown&&this.onRightMouseDown(this.mousePos.x,this.mousePos.y);return}t.button===0&&(this.isMouseDown=!0,this.onMouseDown&&this.onMouseDown(this.mousePos.x,this.mousePos.y),this.handleClick&&this.handleClick(this.mousePos.x,this.mousePos.y))}),this.canvas.addEventListener("contextmenu",t=>{t.preventDefault(),this.updateMousePos(t),this.onRightClick&&this.onRightClick(this.mousePos.x,this.mousePos.y)}),window.addEventListener("mouseup",t=>{if(t.button===2){this.isRightMouseDown=!1;return}t.button===0&&(this.isMouseDown=!1,this.justPickedUp=!1,this.isThrowingPress=!1,this.onMouseUp&&this.onMouseUp(this.mousePos.x,this.mousePos.y))}),this.canvas.addEventListener("touchstart",t=>{t.touches.length>0&&(this.isMouseDown=!0,this.updateTouchPos(t.touches[0]),this.onMouseDown&&this.onMouseDown(this.mousePos.x,this.mousePos.y),this.handleClick&&this.handleClick(this.mousePos.x,this.mousePos.y))},{passive:!1}),this.canvas.addEventListener("touchmove",t=>{t.touches.length>0&&(this.updateTouchPos(t.touches[0]),this.onMouseMove&&this.onMouseMove(this.mousePos.x,this.mousePos.y))},{passive:!1}),window.addEventListener("touchend",()=>{this.isMouseDown=!1,this.justPickedUp=!1,this.isThrowingPress=!1,this.onMouseUp&&this.onMouseUp(this.mousePos.x,this.mousePos.y)})}updateMousePos(t){const i=this.canvas.getBoundingClientRect(),s=this.arena.width/i.width,e=this.arena.height/i.height;this.mousePos.x=(t.clientX-i.left)*s,this.mousePos.y=(t.clientY-i.top)*e}updateTouchPos(t){const i=this.canvas.getBoundingClientRect(),s=this.arena.width/i.width,e=this.arena.height/i.height;this.mousePos.x=(t.clientX-i.left)*s,this.mousePos.y=(t.clientY-i.top)*e}updateMovementVector(){let t=0,i=0;(this.keysPressed.has("KeyW")||this.keysPressed.has("ArrowUp"))&&(i-=1),(this.keysPressed.has("KeyS")||this.keysPressed.has("ArrowDown"))&&(i+=1),(this.keysPressed.has("KeyA")||this.keysPressed.has("ArrowLeft"))&&(t-=1),(this.keysPressed.has("KeyD")||this.keysPressed.has("ArrowRight"))&&(t+=1);const s=Math.hypot(t,i);s>0?(this.movementVector.x=t/s,this.movementVector.y=i/s):(this.movementVector.x=0,this.movementVector.y=0)}handleInteractions(t,i,s,e){e&&(this.selectedCanvasEntity=e.selectedEntity);const l=(a,d,c=.35)=>{var v;for(let g=s.length-1;g>=0;g--){const m=s[g],S=m.hasCollider?m.colliderRadius:((v=m.colliderModule)==null?void 0:v.radius)??.32;if(Math.hypot(m.position.x-a,m.position.y-d)<=S+c)return m}const y=t.hasCollider?t.colliderRadius:.44;return Math.hypot(t.position.x-a,t.position.y-d)<=y+c?t:null},n=(a,d)=>{var y;if(a<0||a>=i.cols||d<0||d>=i.rows)return;if(i.setWallTile(a,d,!0)){const p={id:`wall-${a}-${d}`,x:a*i.tileSize,y:d*i.tileSize,width:i.tileSize,height:i.tileSize,wallHeight:i.wallHeight},v=[t,...s];for(const g of v){const m=g.hasCollider?g.colliderRadius:((y=g.colliderModule)==null?void 0:y.radius)??.32;i.testWallOverlap(g.position.x,g.position.y,m,p)&&g.position.z<i.wallHeight&&(g.hasVerticalPosition||(g.verticalPositionModule?g.verticalPositionModule.enabled=!0:g.verticalPositionModule=new dt({z:i.wallHeight,hasVerticalVelocity:!0})),g.position.z=i.wallHeight,g.supportingSurfaceHeight=i.wallHeight,g.verticalVelocity=0)}i.currentPresetId="custom",e==null||e.updateWallPresetUI()}},o=(a,d)=>{a<0||a>=i.cols||d<0||d>=i.rows||i.tileGrid[d][a]===1&&(i.setWallTile(a,d,!1),i.currentPresetId="custom",e==null||e.updateWallPresetUI())};this.onMouseDown=(a,d)=>{if(e!=null&&e.isEditMode){if(e.editTool==="walls"){const y=Math.floor(a/i.tileSize),p=Math.floor(d/i.tileSize);n(y,p);return}const c=l(a,d,.35);c?(this.selectedCanvasEntity=c,e.setSelectedEntity(c),this.draggedEntity=c,this.dragOffset.x=c.position.x-a,this.dragOffset.y=c.position.y-d,this.canvas.style.cursor="grabbing"):(this.selectedCanvasEntity=null,this.draggedEntity=null)}},this.onRightMouseDown=(a,d)=>{if(e!=null&&e.isEditMode&&e.editTool==="walls"){const c=Math.floor(a/i.tileSize),y=Math.floor(d/i.tileSize);o(c,y)}},this.onMouseMove=(a,d)=>{var p;const c=Math.floor(a/i.tileSize),y=Math.floor(d/i.tileSize);if(c>=0&&c<i.cols&&y>=0&&y<i.rows?this.hoverWallTile={col:c,row:y}:this.hoverWallTile=null,e!=null&&e.isEditMode){if(e.editTool==="walls"){this.hoverEntity=null,this.draggedEntity=null,this.canvas.style.cursor="cell",this.isMouseDown&&this.hoverWallTile?n(this.hoverWallTile.col,this.hoverWallTile.row):this.isRightMouseDown&&this.hoverWallTile&&o(this.hoverWallTile.col,this.hoverWallTile.row);return}if(this.isMouseDown&&this.draggedEntity){const v=a+this.dragOffset.x,g=d+this.dragOffset.y,m=this.draggedEntity.hasCollider?this.draggedEntity.colliderRadius:((p=this.draggedEntity.colliderModule)==null?void 0:p.radius)??.32;this.draggedEntity.position.x=Math.max(m,Math.min(i.width-m,v)),this.draggedEntity.position.y=Math.max(m,Math.min(i.height-m,g)),this.draggedEntity.velocity.x=0,this.draggedEntity.velocity.y=0,this.draggedEntity.verticalVelocity=0,this.draggedEntity.rollModule&&(this.draggedEntity.rollModule.angularVelocity.x=0,this.draggedEntity.rollModule.angularVelocity.y=0,this.draggedEntity.rollModule.angularVelocity.z=0),this.canvas.style.cursor="grabbing"}else{const v=l(a,d,.3);this.hoverEntity=v,this.canvas.style.cursor=v?"grab":"crosshair"}}else this.hoverEntity=null,this.draggedEntity=null,this.canvas.style.cursor="default"},this.onMouseUp=(a,d)=>{if(this.draggedEntity&&(i.syncEntitiesWithWalls([this.draggedEntity]),this.draggedEntity=null),e!=null&&e.isEditMode)if(e.editTool==="walls")this.canvas.style.cursor="cell";else{const c=l(this.mousePos.x,this.mousePos.y,.3);this.hoverEntity=c,this.canvas.style.cursor=c?"grab":"crosshair"}},this.handleClick=(a,d)=>{if(!(e!=null&&e.isEditMode)){if(t.heldObject&&t.throwModule&&!this.justPickedUp){t.throwModule.throwHeldObject(t,a,d,i),this.isThrowingPress=!0;return}if(!t.heldObject&&t.pickupModule){const c=t.pickupModule.findTargetObject(t,a,d,s,i.wallHeight);c&&(t.pickupModule.pickup(t,c),this.justPickedUp=!0)}}},this.onRightClick=(a,d)=>{if(e!=null&&e.isEditMode&&e.editTool==="walls"||!e)return;const c=l(a,d,.4);c&&(this.selectedCanvasEntity=c,e.setSelectedEntity(c))},this.onDropAttempt=()=>{if(t.heldObject&&t.pickupModule)t.pickupModule.drop(t)&&(this.isThrowingPress=!0);else if(!t.heldObject&&t.pickupModule){const a=t.pickupModule.findTargetObject(t,this.mousePos.x,this.mousePos.y,s,i.wallHeight);a&&t.pickupModule.pickup(t,a)}}}}class zt{constructor(t){r(this,"container");r(this,"character");r(this,"arena");r(this,"objects");r(this,"onSpawnObject");r(this,"onDeleteObject");r(this,"onClearObjects");r(this,"selectedEntity");r(this,"isEditMode",!1);r(this,"editTool","entities");r(this,"onSelectionChange");r(this,"creatorState",{name:"Custom Box",visualShape:"box",color:"#38bdf8",hasCollider:!0,colliderRadius:.3,hasMass:!0,mass:1,hasFriction:!0,staticFrictionMod:1,dynamicFrictionMod:1,hasBounce:!0,bounceMod:.2,verticalBounce:!0,hasVerticalPosition:!0,elevation:.1,hasVerticalVelocity:!0,hasGravity:!0,hasRollModule:!1,rollResistance:.4});r(this,"presets",{"Light Blue Box":{name:"Light Blue Box",visualShape:"box",color:"#38bdf8",hasCollider:!0,colliderRadius:.26,hasMass:!0,mass:.7,hasFriction:!0,staticFrictionMod:1,dynamicFrictionMod:1,hasBounce:!0,bounceMod:.25,verticalBounce:!0,hasVerticalPosition:!0,elevation:.1,hasVerticalVelocity:!0,hasGravity:!0,hasRollModule:!1,rollResistance:.4},"Heavy Red Box":{name:"Heavy Red Box",visualShape:"box",color:"#f87171",hasCollider:!0,colliderRadius:.4,hasMass:!0,mass:2.6,hasFriction:!0,staticFrictionMod:1.2,dynamicFrictionMod:1.2,hasBounce:!1,bounceMod:.05,verticalBounce:!1,hasVerticalPosition:!0,elevation:.1,hasVerticalVelocity:!0,hasGravity:!0,hasRollModule:!1,rollResistance:.4},"Bouncy Ball":{name:"Super Bouncy Ball",visualShape:"circle",color:"#4ade80",hasCollider:!0,colliderRadius:.24,hasMass:!0,mass:.5,hasFriction:!0,staticFrictionMod:.8,dynamicFrictionMod:.8,hasBounce:!0,bounceMod:.88,verticalBounce:!0,hasVerticalPosition:!0,elevation:.6,hasVerticalVelocity:!0,hasGravity:!0,hasRollModule:!1,rollResistance:.4},"Rolling Ball":{name:"Rolling Ball",visualShape:"circle",color:"#a855f7",hasCollider:!0,colliderRadius:.28,hasMass:!0,mass:.6,hasFriction:!0,staticFrictionMod:.5,dynamicFrictionMod:.5,hasBounce:!0,bounceMod:.95,verticalBounce:!0,hasVerticalPosition:!0,elevation:.1,hasVerticalVelocity:!0,hasGravity:!0,hasRollModule:!0,rollResistance:0},"Ghost Box":{name:"Ghost Box (No Collider)",visualShape:"box",color:"#94a3b8",hasCollider:!1,colliderRadius:.3,hasMass:!1,mass:0,hasFriction:!1,staticFrictionMod:0,dynamicFrictionMod:0,hasBounce:!1,bounceMod:0,verticalBounce:!1,hasVerticalPosition:!1,elevation:0,hasVerticalVelocity:!1,hasGravity:!1,hasRollModule:!1,rollResistance:0}});r(this,"inspectorEl");r(this,"entitySelectorEl");r(this,"characterSpecificControlsEl");r(this,"objectSpecificControlsEl");r(this,"modePlayBtn");r(this,"modeEditBtn");this.container=t.container,this.character=t.character,this.arena=t.arena,this.objects=t.objects,this.onSpawnObject=t.onSpawnObject,this.onDeleteObject=t.onDeleteObject,this.onClearObjects=t.onClearObjects,this.selectedEntity=this.character,this.renderPanel()}setSelectedEntity(t){var i;this.selectedEntity=t,this.updateSelectorOptions(),this.syncEntitySliders(),(i=this.onSelectionChange)==null||i.call(this,t)}setMode(t){this.isEditMode=t,this.modePlayBtn&&this.modeEditBtn&&(this.isEditMode?(this.modePlayBtn.classList.remove("active-play"),this.modeEditBtn.classList.add("active-edit")):(this.modePlayBtn.classList.add("active-play"),this.modeEditBtn.classList.remove("active-edit")));const i=this.container.querySelector("#edit-submode-container");i&&(i.style.display=this.isEditMode?"flex":"none"),this.updateToolVisibility()}setEditTool(t){this.editTool=t;const i=this.container.querySelector("#submode-entities"),s=this.container.querySelector("#submode-walls");i&&s&&(i.classList.toggle("active",t==="entities"),s.classList.toggle("active",t==="walls")),this.updateToolVisibility()}updateToolVisibility(){const t=this.container.querySelector("#wall-editor-section");t&&(t.style.display=this.isEditMode&&this.editTool==="walls"?"block":"none");const i=this.container.querySelector("#edit-hint-label");i&&(this.isEditMode?this.editTool==="walls"?i.textContent="Left-drag: Draw | Right-drag: Erase":i.textContent="Click & drag object in arena":i.textContent="Right-click in arena to select")}updateSelectorOptions(){if(!this.entitySelectorEl)return;const t=this.selectedEntity.id;let i=`<option value="${this.character.id}" ${t===this.character.id?"selected":""}>⭐ Player Character (${this.character.mass.toFixed(1)}kg)</option>`;for(const e of this.objects){const l=e.id===t?"selected":"",n=e.visualShape==="box"?"📦":"⚪",o=e.hasMass?`${e.mass.toFixed(1)}kg`:"Massless";i+=`<option value="${e.id}" ${l}>${n} ${e.name} (${o})</option>`}this.entitySelectorEl.innerHTML=i;const s=this.selectedEntity===this.character;this.characterSpecificControlsEl&&(this.characterSpecificControlsEl.style.display=s?"flex":"none"),this.objectSpecificControlsEl&&(this.objectSpecificControlsEl.style.display=s?"none":"flex")}renderPanel(){var t,i,s,e,l,n,o,a,d,c,y,p,v,g,m,S,f,b,k,D,V,C,z,L,T,M,h,w,F,x,P,R,$,B,E,W,A,q,H,j,G,U,u,I,X,Y,K,et,pt,it,st,vt,lt,ot,bt,at,nt,ft,ct,Q,Z,N,_,kt,Vt,Et,Ct;this.container.innerHTML=`
        ...
        <div class="dev-section">
          ...
          <div class="module-card" id="card-mod-bounce">
            <div class="toggle-row">
              ...
              <button id="toggle-mod-bounce" class="btn-toggle ${(g=this.selectedEntity.bounceModule)!=null&&g.enabled?"active":""}">
            ...
            <div id="group-mod-bounce" style="display: ${(f=this.selectedEntity.bounceModule)!=null&&f.enabled?"block":"none"};">
              <div class="slider-group">
                <div class="slider-label">
              ...
              <div class="toggle-subrow" style="margin-top: 8px; display: flex; align-items: center; justify-content: space-between;">
                <label style="font-size: 0.8rem; color: #e2e8f0; cursor: pointer; display: flex; align-items: center; gap: 6px;">
                  <input type="checkbox" id="check-mod-vert-bounce" ${(D=this.selectedEntity.bounceModule)!=null&&D.verticalBounce?"checked":""}>
          ...
          <div class="module-card">
            ...
            <div id="group-mod-roll" style="display: ${(h=this.selectedEntity.rollModule)!=null&&h.enabled?"block":"none"};">
              <div class="slider-group">
                ...
                <input type="range" id="slide-entity-roll-resist" min="0.0" max="4.0" step="0.05" value="${((F=this.selectedEntity.rollModule)==null?void 0:F.rollResistance)??.4}">
              </div>
            </div>
          </div>
          ...
          <div id="character-specific-controls" style="display: ${this.selectedEntity===this.character?"flex":"none"}; flex-direction: column; gap: 10px;">
            ...
            <div class="module-card" id="card-mod-walking">
              ...
              <div id="warn-walk-friction" class="module-dep-warning" style="display: ${!this.character.hasFriction&&((R=this.character.walkingModule)!=null&&R.enabled)?"block":"none"};">
              ...
              <div id="group-mod-throw" style="display: ${(st=this.character.throwModule)!=null&&st.enabled?"block":"none"};">
                <div class="slider-group">
                  <div class="slider-label">
                    ...
                    <span id="val-throw-force">${(((vt=this.character.throwModule)==null?void 0:vt.baseThrowForce)??7.6).toFixed(1)}</span>
                  </div>
            ...
            <div class="module-card">
              <div class="toggle-row">
                ...
                <button id="toggle-climb" class="btn-toggle ${(ot=this.character.climbingModule)!=null&&ot.enabled?"active":""}">
                  ${(bt=this.character.climbingModule)!=null&&bt.enabled?"Attached":"Detached"}
                </button>
              </div>
    ...
    `,this.inspectorEl=this.container.querySelector("#dev-inspector"),this.entitySelectorEl=this.container.querySelector("#entity-selector"),this.characterSpecificControlsEl=this.container.querySelector("#character-specific-controls"),this.objectSpecificControlsEl=this.container.querySelector("#object-actions-row"),this.modePlayBtn=this.container.querySelector("#mode-play"),this.modeEditBtn=this.container.querySelector("#mode-edit"),this.updateSelectorOptions(),this.bindEvents()}syncEntitySliders(){var W,A,q,H,j,G,U;const t=this.selectedEntity,i=t===this.character,s=this.container.querySelector("#row-visual-shape");s&&(s.style.display=i?"none":"flex");const e=this.container.querySelector("#toggle-entity-shape");e&&(t.visualShape==="box"?(e.textContent="Box 📦",e.classList.add("active")):(e.textContent="Circle ⚪",e.classList.remove("active")));const l=this.container.querySelector("#toggle-mod-collider"),n=this.container.querySelector("#group-mod-collider"),o=this.container.querySelector("#note-mod-collider");l&&(l.textContent=t.hasCollider?"Attached":"Detached",l.classList.toggle("active",t.hasCollider)),n&&(n.style.display=t.hasCollider?"block":"none"),o&&(o.style.display=t.hasCollider?"none":"block"),this.setSliderVal("slide-entity-radius","val-entity-radius",((W=t.colliderModule)==null?void 0:W.radius)??.32,2);const a=this.container.querySelector("#toggle-mod-mass"),d=this.container.querySelector("#group-mod-mass"),c=this.container.querySelector("#note-mod-mass");a&&(a.textContent=t.hasMass?"Attached":"Detached",a.classList.toggle("active",t.hasMass)),d&&(d.style.display=t.hasMass?"block":"none"),c&&(c.style.display=t.hasMass?"none":"block"),this.setSliderVal("slide-entity-mass","val-entity-mass",((A=t.massModule)==null?void 0:A.mass)??1,1);const y=this.container.querySelector("#toggle-mod-friction"),p=this.container.querySelector("#group-mod-friction"),v=this.container.querySelector("#note-mod-friction"),g=this.container.querySelector("#warn-friction-mass"),m=!!(t.frictionModule&&t.frictionModule.enabled);y&&(y.textContent=m?"Attached":"Detached",y.classList.toggle("active",m)),p&&(p.style.display=m?"flex":"none"),v&&(v.style.display=m?"none":"block"),g&&(g.style.display=!t.hasMass&&m?"block":"none"),this.setSliderVal("slide-entity-static-fric","val-entity-static-fric",((q=t.frictionModule)==null?void 0:q.staticFrictionMod)??1,2),this.setSliderVal("slide-entity-dynamic-fric","val-entity-dynamic-fric",((H=t.frictionModule)==null?void 0:H.dynamicFrictionMod)??1,2);const S=this.container.querySelector("#toggle-mod-bounce"),f=this.container.querySelector("#group-mod-bounce"),b=this.container.querySelector("#note-mod-bounce"),k=this.container.querySelector("#warn-bounce-mass"),D=!!(t.bounceModule&&t.bounceModule.enabled);S&&(S.textContent=D?"Attached":"Detached",S.classList.toggle("active",D)),f&&(f.style.display=D?"block":"none"),b&&(b.style.display=D?"none":"block"),k&&(k.style.display=!t.hasMass&&D?"block":"none"),this.setSliderVal("slide-entity-bounce","val-entity-bounce",((j=t.bounceModule)==null?void 0:j.bounceMod)??.4,2);const V=this.container.querySelector("#check-mod-vert-bounce"),C=this.container.querySelector("#warn-bounce-vert-vel");if(V&&(V.checked=!!((G=t.bounceModule)!=null&&G.verticalBounce)),C){const u=!!(D&&((U=t.bounceModule)!=null&&U.verticalBounce)&&!t.hasVerticalVelocity);C.style.display=u?"block":"none"}const z=this.container.querySelector("#toggle-mod-vert-pos"),L=this.container.querySelector("#group-mod-vert-pos"),T=this.container.querySelector("#note-mod-vert-pos"),M=t.hasVerticalPosition;z&&(z.textContent=M?"Attached":"Detached",z.classList.toggle("active",M)),L&&(L.style.display=M?"block":"none"),T&&(T.style.display=M?"none":"block"),this.setSliderVal("slide-entity-elevation","val-entity-elevation",t.position.z,2);const h=this.container.querySelector("#toggle-mod-vert-vel"),w=this.container.querySelector("#group-mod-vert-vel"),F=t.hasVerticalVelocity;h&&(h.textContent=F?"Enabled":"Disabled",h.classList.toggle("active",F)),w&&(w.style.display=F?"block":"none"),this.setSliderVal("slide-entity-vert-vel","val-entity-vert-vel",t.verticalVelocity,2);const x=this.container.querySelector("#toggle-mod-gravity"),P=this.container.querySelector("#note-mod-gravity");x&&(x.textContent=t.hasGravity?"Attached":"Detached",x.classList.toggle("active",t.hasGravity)),P&&(P.textContent=t.hasGravity?"Subject to static world gravity acceleration":"Zero-G: never falls, flies horizontally in a straight line");const R=this.container.querySelector("#toggle-mod-roll"),$=this.container.querySelector("#group-mod-roll"),B=this.container.querySelector("#note-roll-friction"),E=!!(t.rollModule&&t.rollModule.enabled);if(R&&(R.textContent=E?"Attached":"Detached",R.classList.toggle("active",E)),$&&($.style.display=E?"block":"none"),B&&(B.style.display=E&&!t.hasFriction?"block":"none"),t.rollModule&&this.setSliderVal("slide-entity-roll-resist","val-entity-roll-resist",t.rollModule.rollResistance,2),i){const u=this.container.querySelector("#toggle-walk"),I=this.container.querySelector("#group-mod-walking"),X=this.container.querySelector("#warn-walk-friction"),Y=this.container.querySelector("#warn-walk-strength"),K=!!(this.character.walkingModule&&this.character.walkingModule.enabled);u&&(u.textContent=K?"Attached":"Detached",u.classList.toggle("active",K)),I&&(I.style.display=K?"flex":"none"),X&&(X.style.display=K&&!this.character.hasFriction?"block":"none"),Y&&(Y.style.display=K&&!this.character.hasStrength?"block":"none"),this.character.walkingModule&&(this.setSliderVal("slide-walk-force","val-walk-force",this.character.walkingModule.maxWalkForce,0),this.setSliderVal("slide-walk-speed","val-walk-speed",this.character.walkingModule.maxWalkSpeed,1));const et=this.container.querySelector("#toggle-strength"),pt=this.container.querySelector("#group-mod-strength"),it=!!(this.character.strengthModule&&this.character.strengthModule.enabled);et&&(et.textContent=it?"Attached":"Detached",et.classList.toggle("active",it)),pt&&(pt.style.display=it?"block":"none"),this.character.strengthModule&&this.setSliderVal("slide-strength","val-strength",this.character.strength,1);const st=this.container.querySelector("#toggle-pickup"),vt=this.container.querySelector("#group-mod-pickup"),lt=!!(this.character.pickupModule&&this.character.pickupModule.enabled);st&&(st.textContent=lt?"Attached":"Detached",st.classList.toggle("active",lt)),vt&&(vt.style.display=lt?"block":"none"),this.character.pickupModule&&(this.setSliderVal("slide-pickup-reach","val-pickup-reach",this.character.pickupModule.pickupReach,1),this.setSliderVal("slide-pickup-cross-layer","val-pickup-cross-layer",this.character.pickupModule.crossLayerReachRatio,2));const ot=this.container.querySelector("#toggle-throw"),bt=this.container.querySelector("#group-mod-throw"),at=!!(this.character.throwModule&&this.character.throwModule.enabled);ot&&(ot.textContent=at?"Attached":"Detached",ot.classList.toggle("active",at)),bt&&(bt.style.display=at?"block":"none"),this.character.throwModule&&this.setSliderVal("slide-throw-force","val-throw-force",this.character.throwModule.baseThrowForce,1);const nt=this.container.querySelector("#toggle-climb"),ft=this.container.querySelector("#group-mod-climb"),ct=this.container.querySelector("#warn-climb-deps"),Q=!!(this.character.climbingModule&&this.character.climbingModule.enabled);if(nt&&(nt.textContent=Q?"Attached":"Detached",nt.classList.toggle("active",Q)),ft&&(ft.style.display=Q?"block":"none"),ct){const Z=!this.character.hasVerticalPosition,N=!this.character.hasStrength;ct.style.display=Q&&(Z||N)?"block":"none",ct.textContent=Z?"⚠️ Requires Vertical Position (3D Z-axis)":N?"⚠️ Requires Strength Ability to climb":""}if(this.character.climbingModule){const Z=this.container.querySelector("#toggle-climb-walkoff");if(Z){const _=!!this.character.climbingModule.preventWalkOff;Z.textContent=_?"Active":"Inactive",Z.classList.toggle("active",_)}const N=this.container.querySelector("#toggle-climb-sideways");if(N){const _=!!this.character.climbingModule.horizontalClimb;N.textContent=_?"Active":"Inactive",N.classList.toggle("active",_)}this.setSliderVal("slide-climb-adhesion","val-climb-adhesion",this.character.climbingModule.maxAdhesion,0),this.setSliderVal("slide-climb-speed","val-climb-speed",this.character.climbingModule.maxClimbSpeed,1),this.setSliderVal("slide-climb-hang","val-climb-hang",this.character.climbingModule.hangDistance,2)}}}setSliderVal(t,i,s,e){const l=this.container.querySelector(`#${t}`),n=this.container.querySelector(`#${i}`);l&&(l.value=s.toString()),n&&(n.textContent=e>0?s.toFixed(e):Math.round(s).toString())}syncCreatorInputs(){const t=this.creatorState,i=this.container.querySelector("#creator-name");i&&(i.value=t.name);const s=this.container.querySelector("#creator-toggle-shape");s&&(s.textContent=t.visualShape==="box"?"Box 📦":"Circle ⚪",s.classList.toggle("active",t.visualShape==="box"));const e=this.container.querySelector("#creator-color"),l=this.container.querySelector("#val-creator-color");e&&(e.value=t.color),l&&(l.textContent=t.color);const n=this.container.querySelector("#creator-toggle-collider"),o=this.container.querySelector("#grp-creator-radius");n&&(n.textContent=t.hasCollider?"Attached":"Detached",n.classList.toggle("active",t.hasCollider)),o&&(o.style.display=t.hasCollider?"block":"none"),this.setSliderVal("slide-creator-radius","val-creator-radius",t.colliderRadius,2);const a=this.container.querySelector("#creator-toggle-mass"),d=this.container.querySelector("#grp-creator-mass");a&&(a.textContent=t.hasMass?"Attached":"Detached",a.classList.toggle("active",t.hasMass)),d&&(d.style.display=t.hasMass?"block":"none"),this.setSliderVal("slide-creator-mass","val-creator-mass",t.mass,1);const c=this.container.querySelector("#creator-toggle-friction"),y=this.container.querySelector("#grp-creator-fric");c&&(c.textContent=t.hasFriction?"Attached":"Detached",c.classList.toggle("active",t.hasFriction)),y&&(y.style.display=t.hasFriction?"block":"none"),this.setSliderVal("slide-creator-fric","val-creator-fric",t.dynamicFrictionMod,2);const p=this.container.querySelector("#creator-toggle-bounce"),v=this.container.querySelector("#grp-creator-bounce"),g=this.container.querySelector("#creator-check-vert-bounce"),m=this.container.querySelector("#creator-warn-bounce-vert");p&&(p.textContent=t.hasBounce?"Attached":"Detached",p.classList.toggle("active",t.hasBounce)),v&&(v.style.display=t.hasBounce?"block":"none"),g&&(g.checked=t.verticalBounce),m&&(m.style.display=t.hasBounce&&t.verticalBounce&&(!t.hasVerticalPosition||!t.hasVerticalVelocity)?"block":"none"),this.setSliderVal("slide-creator-bounce","val-creator-bounce",t.bounceMod,2);const S=this.container.querySelector("#creator-toggle-vert-pos"),f=this.container.querySelector("#grp-creator-vert-pos");S&&(S.textContent=t.hasVerticalPosition?"Attached":"Detached",S.classList.toggle("active",t.hasVerticalPosition)),f&&(f.style.display=t.hasVerticalPosition?"block":"none"),this.setSliderVal("slide-creator-elevation","val-creator-elevation",t.elevation,2);const b=this.container.querySelector("#creator-toggle-vert-vel");b&&(b.textContent=t.hasVerticalVelocity?"Enabled":"Disabled",b.classList.toggle("active",t.hasVerticalVelocity));const k=this.container.querySelector("#creator-toggle-gravity");k&&(k.textContent=t.hasGravity?"Attached":"Detached",k.classList.toggle("active",t.hasGravity));const D=this.container.querySelector("#creator-toggle-roll"),V=this.container.querySelector("#group-creator-roll-resist");D&&(D.textContent=t.hasRollModule?"Enabled":"Disabled",D.classList.toggle("active",t.hasRollModule)),V&&(V.style.display=t.hasRollModule?"block":"none"),this.setSliderVal("slide-creator-roll-resist","val-creator-roll-resist",t.rollResistance,2)}bindEvents(){var $,B,E,W,A,q,H,j,G,U;this.modePlayBtn.addEventListener("click",()=>{this.setMode(!1)}),this.modeEditBtn.addEventListener("click",()=>{this.setMode(!0)}),($=this.container.querySelector("#submode-entities"))==null||$.addEventListener("click",()=>{this.setEditTool("entities")}),(B=this.container.querySelector("#submode-walls"))==null||B.addEventListener("click",()=>{this.setEditTool("walls")}),this.entitySelectorEl.addEventListener("change",()=>{var I;const u=this.entitySelectorEl.value;if(u===this.character.id)this.selectedEntity=this.character;else{const X=this.objects.find(Y=>Y.id===u);X&&(this.selectedEntity=X)}this.updateSelectorOptions(),this.syncEntitySliders(),(I=this.onSelectionChange)==null||I.call(this,this.selectedEntity)}),(E=this.container.querySelector("#btn-duplicate-entity"))==null||E.addEventListener("click",()=>{this.duplicateSelectedEntity()}),(W=this.container.querySelector("#btn-delete-entity"))==null||W.addEventListener("click",()=>{this.deleteSelectedEntity()});const t=this.container.querySelector("#toggle-entity-shape");t==null||t.addEventListener("click",()=>{this.selectedEntity.visualShape=this.selectedEntity.visualShape==="box"?"circle":"box",t.textContent=this.selectedEntity.visualShape==="box"?"Box 📦":"Circle ⚪",t.classList.toggle("active",this.selectedEntity.visualShape==="box"),this.updateSelectorOptions()});const i=this.container.querySelector("#toggle-mod-collider");i==null||i.addEventListener("click",()=>{this.selectedEntity.colliderModule?this.selectedEntity.colliderModule.enabled=!this.selectedEntity.colliderModule.enabled:this.selectedEntity.colliderModule=new ht({radius:.32}),this.syncEntitySliders()}),this.setupSlider("slide-entity-radius","val-entity-radius",u=>{this.selectedEntity.colliderRadius=u},2);const s=this.container.querySelector("#toggle-mod-mass");s==null||s.addEventListener("click",()=>{this.selectedEntity.massModule?this.selectedEntity.massModule.enabled=!this.selectedEntity.massModule.enabled:this.selectedEntity.massModule=new ut({mass:1}),this.syncEntitySliders(),this.updateSelectorOptions()}),this.setupSlider("slide-entity-mass","val-entity-mass",u=>{this.selectedEntity.mass=u,this.updateSelectorOptions()},1);const e=this.container.querySelector("#toggle-mod-friction");e==null||e.addEventListener("click",()=>{this.selectedEntity.frictionModule?this.selectedEntity.frictionModule.enabled=!this.selectedEntity.frictionModule.enabled:this.selectedEntity.frictionModule=new yt,this.syncEntitySliders()}),this.setupSlider("slide-entity-static-fric","val-entity-static-fric",u=>{this.selectedEntity.staticGroundFrictionMod=u},2),this.setupSlider("slide-entity-dynamic-fric","val-entity-dynamic-fric",u=>{this.selectedEntity.dynamicGroundFrictionMod=u},2);const l=this.container.querySelector("#toggle-mod-bounce");l==null||l.addEventListener("click",()=>{this.selectedEntity.bounceModule?this.selectedEntity.bounceModule.enabled=!this.selectedEntity.bounceModule.enabled:this.selectedEntity.bounceModule=new gt({bounceMod:.4}),this.syncEntitySliders()}),this.setupSlider("slide-entity-bounce","val-entity-bounce",u=>{this.selectedEntity.bounceMod=u},2);const n=this.container.querySelector("#check-mod-vert-bounce");n==null||n.addEventListener("change",()=>{this.selectedEntity.bounceModule&&(this.selectedEntity.bounceModule.verticalBounce=n.checked),this.syncEntitySliders(),this.updateInspector()});const o=this.container.querySelector("#toggle-mod-vert-pos");o==null||o.addEventListener("click",()=>{this.selectedEntity.verticalPositionModule?(this.selectedEntity.verticalPositionModule.enabled=!this.selectedEntity.verticalPositionModule.enabled,this.selectedEntity.verticalPositionModule.enabled||(this.selectedEntity.position.z=0,this.selectedEntity.verticalVelocity=0)):this.selectedEntity.verticalPositionModule=new dt({z:this.selectedEntity.position.z,hasVerticalVelocity:!0,verticalVelocity:0,enabled:!0}),this.syncEntitySliders(),this.updateInspector()}),this.setupSlider("slide-entity-elevation","val-entity-elevation",u=>{this.selectedEntity.verticalPositionModule&&(this.selectedEntity.verticalPositionModule.z=u),this.selectedEntity.position.z=u,this.syncEntitySliders(),this.updateInspector()},2);const a=this.container.querySelector("#toggle-mod-vert-vel");a==null||a.addEventListener("click",()=>{this.selectedEntity.verticalPositionModule&&(this.selectedEntity.verticalPositionModule.hasVerticalVelocity=!this.selectedEntity.verticalPositionModule.hasVerticalVelocity,this.selectedEntity.verticalPositionModule.hasVerticalVelocity||(this.selectedEntity.verticalVelocity=0)),this.syncEntitySliders(),this.updateInspector()}),this.setupSlider("slide-entity-vert-vel","val-entity-vert-vel",u=>{this.selectedEntity.verticalVelocity=u},2);const d=this.container.querySelector("#toggle-mod-gravity");d==null||d.addEventListener("click",()=>{this.selectedEntity.gravityModule?this.selectedEntity.gravityModule.enabled=!this.selectedEntity.gravityModule.enabled:this.selectedEntity.gravityModule=new mt,this.syncEntitySliders()});const c=this.container.querySelector("#toggle-mod-roll");c==null||c.addEventListener("click",()=>{this.selectedEntity.rollModule?this.selectedEntity.rollModule.enabled=!this.selectedEntity.rollModule.enabled:this.selectedEntity.rollModule=new Mt({rollResistance:.4}),this.syncEntitySliders()}),this.setupSlider("slide-entity-roll-resist","val-entity-roll-resist",u=>{this.selectedEntity.rollModule&&(this.selectedEntity.rollModule.rollResistance=u)},2);const y=this.container.querySelector("#toggle-walk");y==null||y.addEventListener("click",()=>{this.character.walkingModule?this.character.walkingModule.enabled=!this.character.walkingModule.enabled:this.character.walkingModule=new Pt,this.syncEntitySliders()}),this.setupSlider("slide-walk-force","val-walk-force",u=>{this.character.walkingModule&&(this.character.walkingModule.maxWalkForce=u)},0),this.setupSlider("slide-walk-speed","val-walk-speed",u=>{this.character.walkingModule&&(this.character.walkingModule.maxWalkSpeed=u)},1);const p=this.container.querySelector("#toggle-strength");p==null||p.addEventListener("click",()=>{this.character.strengthModule?this.character.strengthModule.enabled=!this.character.strengthModule.enabled:this.character.strengthModule=new wt({strength:1}),this.syncEntitySliders()}),this.setupSlider("slide-strength","val-strength",u=>{this.character.strength=u},1);const v=this.container.querySelector("#toggle-pickup");v==null||v.addEventListener("click",()=>{this.character.pickupModule?this.character.pickupModule.enabled=!this.character.pickupModule.enabled:this.character.pickupModule=new Rt,this.syncEntitySliders()}),this.setupSlider("slide-pickup-reach","val-pickup-reach",u=>{this.character.pickupModule&&(this.character.pickupModule.pickupReach=u)},1),this.setupSlider("slide-pickup-cross-layer","val-pickup-cross-layer",u=>{this.character.pickupModule&&(this.character.pickupModule.crossLayerReachRatio=u)},2);const g=this.container.querySelector("#toggle-throw");g==null||g.addEventListener("click",()=>{this.character.throwModule?this.character.throwModule.enabled=!this.character.throwModule.enabled:this.character.throwModule=new Wt,this.syncEntitySliders()}),this.setupSlider("slide-throw-force","val-throw-force",u=>{this.character.throwModule&&(this.character.throwModule.baseThrowForce=u)},1);const m=this.container.querySelector("#toggle-climb");m==null||m.addEventListener("click",()=>{this.character.climbingModule?this.character.climbingModule.enabled=!this.character.climbingModule.enabled:this.character.climbingModule=new Ft,this.syncEntitySliders()});const S=this.container.querySelector("#toggle-climb-walkoff");S==null||S.addEventListener("click",()=>{this.character.climbingModule&&(this.character.climbingModule.preventWalkOff=!this.character.climbingModule.preventWalkOff),this.syncEntitySliders()});const f=this.container.querySelector("#toggle-climb-sideways");f==null||f.addEventListener("click",()=>{this.character.climbingModule&&(this.character.climbingModule.horizontalClimb=!this.character.climbingModule.horizontalClimb),this.syncEntitySliders()}),this.setupSlider("slide-climb-adhesion","val-climb-adhesion",u=>{this.character.climbingModule&&(this.character.climbingModule.maxAdhesion=u)},0),this.setupSlider("slide-climb-speed","val-climb-speed",u=>{this.character.climbingModule&&(this.character.climbingModule.maxClimbSpeed=u)},1),this.setupSlider("slide-climb-hang","val-climb-hang",u=>{this.character.climbingModule&&(this.character.climbingModule.hangDistance=u)},2),this.setupSlider("slide-gravity","val-gravity",u=>{this.arena.gravity=u},1),this.setupSlider("slide-wall-height","val-wall-height",u=>{this.arena.setStandardWallHeight(u),this.setSliderVal("slide-editor-wall-height","val-editor-wall-height",u,1)},1),this.setupSlider("slide-editor-wall-height","val-editor-wall-height",u=>{this.arena.setStandardWallHeight(u),this.setSliderVal("slide-wall-height","val-wall-height",u,1)},1);const b=this.container.querySelector("#select-wall-preset");b==null||b.addEventListener("change",()=>{this.arena.loadWallPreset(b.value,[this.character,...this.objects]),this.updateWallPresetUI()}),(A=this.container.querySelector("#btn-prev-wall-map"))==null||A.addEventListener("click",()=>{const u=J.WALL_PRESETS,X=(u.findIndex(Y=>Y.id===this.arena.currentPresetId)-1+u.length)%u.length;this.arena.loadWallPreset(u[X].id,[this.character,...this.objects]),this.updateWallPresetUI()}),(q=this.container.querySelector("#btn-next-wall-map"))==null||q.addEventListener("click",()=>{const u=J.WALL_PRESETS,X=(u.findIndex(Y=>Y.id===this.arena.currentPresetId)+1)%u.length;this.arena.loadWallPreset(u[X].id,[this.character,...this.objects]),this.updateWallPresetUI()}),(H=this.container.querySelector("#btn-reset-walls"))==null||H.addEventListener("click",()=>{this.arena.resetDefaultWalls([this.character,...this.objects]),this.updateWallPresetUI()}),(j=this.container.querySelector("#btn-clear-walls"))==null||j.addEventListener("click",()=>{this.arena.clearAllWalls([this.character,...this.objects]),this.updateWallPresetUI()}),this.setupSlider("slide-friction","val-friction",u=>{this.arena.frictionCoeff=u},1),this.setupSlider("slide-static-thresh","val-static-thresh",u=>{this.arena.staticFrictionThreshold=u},2),this.container.querySelectorAll(".preset-chip").forEach(u=>{u.addEventListener("click",()=>{const I=u.getAttribute("data-preset");I&&this.presets[I]&&(this.creatorState={...this.presets[I]},this.syncCreatorInputs())})});const D=this.container.querySelector("#creator-name");D==null||D.addEventListener("input",()=>{this.creatorState.name=D.value});const V=this.container.querySelector("#creator-toggle-shape");V==null||V.addEventListener("click",()=>{this.creatorState.visualShape=this.creatorState.visualShape==="box"?"circle":"box",V.textContent=this.creatorState.visualShape==="box"?"Box 📦":"Circle ⚪",V.classList.toggle("active",this.creatorState.visualShape==="box")});const C=this.container.querySelector("#creator-color"),z=this.container.querySelector("#val-creator-color");C==null||C.addEventListener("input",()=>{this.creatorState.color=C.value,z&&(z.textContent=C.value)});const L=this.container.querySelector("#creator-toggle-collider");L==null||L.addEventListener("click",()=>{this.creatorState.hasCollider=!this.creatorState.hasCollider,L.textContent=this.creatorState.hasCollider?"Attached":"Detached",L.classList.toggle("active",this.creatorState.hasCollider);const u=this.container.querySelector("#grp-creator-radius");u&&(u.style.display=this.creatorState.hasCollider?"block":"none")}),this.setupSlider("slide-creator-radius","val-creator-radius",u=>{this.creatorState.colliderRadius=u},2);const T=this.container.querySelector("#creator-toggle-mass");T==null||T.addEventListener("click",()=>{this.creatorState.hasMass=!this.creatorState.hasMass,T.textContent=this.creatorState.hasMass?"Attached":"Detached",T.classList.toggle("active",this.creatorState.hasMass);const u=this.container.querySelector("#grp-creator-mass");u&&(u.style.display=this.creatorState.hasMass?"block":"none")}),this.setupSlider("slide-creator-mass","val-creator-mass",u=>{this.creatorState.mass=u},1);const M=this.container.querySelector("#creator-toggle-friction");M==null||M.addEventListener("click",()=>{this.creatorState.hasFriction=!this.creatorState.hasFriction,M.textContent=this.creatorState.hasFriction?"Attached":"Detached",M.classList.toggle("active",this.creatorState.hasFriction);const u=this.container.querySelector("#grp-creator-fric");u&&(u.style.display=this.creatorState.hasFriction?"block":"none")}),this.setupSlider("slide-creator-fric","val-creator-fric",u=>{this.creatorState.dynamicFrictionMod=u},2);const h=this.container.querySelector("#creator-toggle-bounce");h==null||h.addEventListener("click",()=>{this.creatorState.hasBounce=!this.creatorState.hasBounce,h.textContent=this.creatorState.hasBounce?"Attached":"Detached",h.classList.toggle("active",this.creatorState.hasBounce);const u=this.container.querySelector("#grp-creator-bounce");u&&(u.style.display=this.creatorState.hasBounce?"block":"none")}),this.setupSlider("slide-creator-bounce","val-creator-bounce",u=>{this.creatorState.bounceMod=u},2);const w=this.container.querySelector("#creator-check-vert-bounce");w==null||w.addEventListener("change",()=>{this.creatorState.verticalBounce=w.checked,this.syncCreatorInputs()});const F=this.container.querySelector("#creator-toggle-vert-pos");F==null||F.addEventListener("click",()=>{this.creatorState.hasVerticalPosition=!this.creatorState.hasVerticalPosition,this.syncCreatorInputs()}),this.setupSlider("slide-creator-elevation","val-creator-elevation",u=>{this.creatorState.elevation=u},2);const x=this.container.querySelector("#creator-toggle-vert-vel");x==null||x.addEventListener("click",()=>{this.creatorState.hasVerticalVelocity=!this.creatorState.hasVerticalVelocity,this.syncCreatorInputs()});const P=this.container.querySelector("#creator-toggle-gravity");P==null||P.addEventListener("click",()=>{this.creatorState.hasGravity=!this.creatorState.hasGravity,P.textContent=this.creatorState.hasGravity?"Attached":"Detached",P.classList.toggle("active",this.creatorState.hasGravity)});const R=this.container.querySelector("#creator-toggle-roll");R==null||R.addEventListener("click",()=>{this.creatorState.hasRollModule=!this.creatorState.hasRollModule,R.textContent=this.creatorState.hasRollModule?"Enabled":"Disabled",R.classList.toggle("active",this.creatorState.hasRollModule);const u=this.container.querySelector("#group-creator-roll-resist");u&&(u.style.display=this.creatorState.hasRollModule?"block":"none")}),this.setupSlider("slide-creator-roll-resist","val-creator-roll-resist",u=>{this.creatorState.rollResistance=u},2),(G=this.container.querySelector("#btn-spawn-configured"))==null||G.addEventListener("click",()=>{this.spawnFromCreator()}),(U=this.container.querySelector("#btn-clear-entities"))==null||U.addEventListener("click",()=>{this.onClearObjects(),this.setSelectedEntity(this.character)})}spawnFromCreator(){const t=this.creatorState,i=Math.min(Math.max(this.character.position.x+(Math.random()*2-1),1),this.arena.width-1),s=Math.min(Math.max(this.character.position.y+(Math.random()*2-1),1),this.arena.height-1),e=new tt({name:t.name||"Custom Object",position:{x:i,y:s,z:t.hasVerticalPosition?t.elevation:0},visualShape:t.visualShape,color:t.color,colliderModule:t.hasCollider?new ht({radius:t.colliderRadius}):null,massModule:t.hasMass?new ut({mass:t.mass}):null,frictionModule:t.hasFriction?new yt({staticFrictionMod:t.staticFrictionMod,dynamicFrictionMod:t.dynamicFrictionMod}):null,bounceModule:t.hasBounce?new gt({bounceMod:t.bounceMod,verticalBounce:t.verticalBounce}):null,verticalPositionModule:t.hasVerticalPosition?new dt({z:t.elevation,hasVerticalVelocity:t.hasVerticalVelocity,verticalVelocity:0}):null,gravityModule:t.hasGravity?new mt:null,rollModule:t.hasRollModule?new Mt({rollResistance:t.rollResistance}):null});this.onSpawnObject(e),this.setSelectedEntity(e)}duplicateSelectedEntity(){if(this.selectedEntity===this.character)return;const t=this.selectedEntity,i=Math.min(Math.max(t.position.x+.6,1),this.arena.width-1),s=Math.min(Math.max(t.position.y+.6,1),this.arena.height-1),e=new tt({name:`${t.name} (Copy)`,position:{x:i,y:s,z:t.position.z},visualShape:t.visualShape,color:t.color,colliderModule:t.colliderModule?new ht({radius:t.colliderModule.radius,enabled:t.colliderModule.enabled}):null,massModule:t.massModule?new ut({mass:t.massModule.mass,enabled:t.massModule.enabled}):null,frictionModule:t.frictionModule?new yt({staticFrictionMod:t.frictionModule.staticFrictionMod,dynamicFrictionMod:t.frictionModule.dynamicFrictionMod,enabled:t.frictionModule.enabled}):null,bounceModule:t.bounceModule?new gt({bounceMod:t.bounceModule.bounceMod,verticalBounce:t.bounceModule.verticalBounce,enabled:t.bounceModule.enabled}):null,verticalPositionModule:t.verticalPositionModule?new dt({z:t.verticalPositionModule.z,hasVerticalVelocity:t.verticalPositionModule.hasVerticalVelocity,verticalVelocity:t.verticalPositionModule.verticalVelocity,enabled:t.verticalPositionModule.enabled}):null,gravityModule:t.gravityModule?new mt({enabled:t.gravityModule.enabled}):null,rollModule:t.rollModule?new Mt({rollResistance:t.rollModule.rollResistance,enabled:t.rollModule.enabled}):null});this.onSpawnObject(e),this.setSelectedEntity(e)}deleteSelectedEntity(){if(this.selectedEntity===this.character)return;const t=this.selectedEntity;this.character.heldObject===t&&(t.isHeld=!1,t.heldBy=null,this.character.heldObject=null),this.onDeleteObject&&this.onDeleteObject(t),this.setSelectedEntity(this.character)}setupSlider(t,i,s,e=0){const l=this.container.querySelector(`#${t}`),n=this.container.querySelector(`#${i}`);!l||!n||l.addEventListener("input",()=>{const o=parseFloat(l.value);n.textContent=e>0?o.toFixed(e):Math.round(o).toString(),s(o)})}updateInspector(){var e;const t=this.selectedEntity,i=Math.hypot(t.velocity.x,t.velocity.y).toFixed(2),s=t===this.character;this.inspectorEl.innerHTML=`
