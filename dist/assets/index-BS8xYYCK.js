        ...
        <div class="dev-section">
          ...
          <div class="module-card" id="card-mod-bounce">
            ...
            <div id="group-mod-bounce" style="display: ${(p=this.selectedEntity.bounceModule)!=null&&p.enabled?"block":"none"};">
              ...
              <div id="warn-bounce-vert-vel" class="module-dep-warning" style="display: ${(S=this.selectedEntity.bounceModule)!=null&&S.enabled&&((A=this.selectedEntity.bounceModule)!=null&&A.verticalBounce)&&!this.selectedEntity.hasVerticalVelocity?"block":"none"};">
          ...
          <div class="module-card">
            <div class="toggle-row">
              <label>🔄 Roll</label>
              <button id="toggle-mod-roll" class="btn-toggle ${(W=this.selectedEntity.rollModule)!=null&&W.enabled?"active":""}">
