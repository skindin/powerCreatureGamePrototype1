        ...
        <div class="dev-section">
          ...
          <div class="module-card" id="card-mod-bounce">
            ...
            <div id="group-mod-bounce" style="display: ${(p=this.selectedEntity.bounceModule)!=null&&p.enabled?"block":"none"};">
              ...
              <div id="warn-bounce-vert-vel" class="module-dep-warning" style="display: ${(V=this.selectedEntity.bounceModule)!=null&&V.enabled&&((D=this.selectedEntity.bounceModule)!=null&&D.verticalBounce)&&!this.selectedEntity.hasVerticalVelocity?"block":"none"};">
                ⚠️ Inactive without Vertical Velocity
              </div>
            </div>
            <div id="note-mod-bounce" class="module-detached-note" style="display: ${(F=this.selectedEntity.bounceModule)!=null&&F.enabled?"none":"block"};">
          ...
          <div class="module-card">
            <div class="toggle-row">
              ...
              <button id="toggle-mod-roll" class="btn-toggle ${(C=this.selectedEntity.rollModule)!=null&&C.enabled?"active":""}">
                ${(h=this.selectedEntity.rollModule)!=null&&h.enabled?"Attached":"Detached"}
              </button>
            </div>
            ...
            <div id="group-mod-roll" style="display: ${(k=this.selectedEntity.rollModule)!=null&&k.enabled?"block":"none"};">
              <div class="slider-group">
                <div class="slider-label">
                  ...
                  <span id="val-entity-roll-resist">${(((x=this.selectedEntity.rollModule)==null?void 0:x.rollResistance)??.4).toFixed(2)}</span>
                </div>
          ...
          <div id="character-specific-controls" style="display: ${this.selectedEntity===this.character?"flex":"none"}; flex-direction: column; gap: 10px;">
            ...
            <div class="module-card" id="card-mod-walking">
              ...
              <div id="warn-walk-strength" class="module-dep-warning" style="display: ${!this.character.hasStrength&&((A=this.character.walkingModule)!=null&&A.enabled)?"block":"none"};">
