        ...
        <div class="dev-section">
          ...
          <div class="module-card" id="card-mod-bounce">
            ...
            <div id="group-mod-bounce" style="display: ${(p=this.selectedEntity.bounceModule)!=null&&p.enabled?"block":"none"};">
              ...
              <div id="warn-bounce-vert-vel" class="module-dep-warning" style="display: ${(S=this.selectedEntity.bounceModule)!=null&&S.enabled&&((D=this.selectedEntity.bounceModule)!=null&&D.verticalBounce)&&!this.selectedEntity.hasVerticalVelocity?"block":"none"};">
                ⚠️ Inactive without Vertical Velocity
              </div>
            </div>
            <div id="note-mod-bounce" class="module-detached-note" style="display: ${(A=this.selectedEntity.bounceModule)!=null&&A.enabled?"none":"block"};">
            ...
            <div id="group-mod-roll" style="display: ${(E=this.selectedEntity.rollModule)!=null&&E.enabled?"block":"none"};">
              <div class="slider-group">
                <div class="slider-label">
                  ...
                  <span id="val-entity-roll-resist">${(((V=this.selectedEntity.rollModule)==null?void 0:V.rollResistance)??.4).toFixed(2)}</span>
                </div>
          ...
          <div id="character-specific-controls" style="display: ${this.selectedEntity===this.character?"flex":"none"}; flex-direction: column; gap: 10px;">
            ...
            <div class="module-card" id="card-mod-walking">
              <div class="toggle-row">
                ...
                <button id="toggle-walk" class="btn-toggle ${(z=this.character.walkingModule)!=null&&z.enabled?"active":""}">
