var $t=Object.defineProperty;var Dt=(I,t,i)=>t in I?$t(I,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):I[t]=i;var r=(I,t,i)=>Dt(I,typeof t!="symbol"?t+"":t,i);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const l of e)if(l.type==="childList")for(const o of l.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function i(e){const l={};return e.integrity&&(l.integrity=e.integrity),e.referrerPolicy&&(l.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?l.credentials="include":e.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(e){if(e.ep)return;e.ep=!0;const l=i(e);fetch(e.href,l)}})();class bt{constructor(t={}){r(this,"z");r(this,"hasVerticalVelocity");r(this,"verticalVelocity");r(this,"enabled");this.z=t.z??0,this.hasVerticalVelocity=t.hasVerticalVelocity!==void 0?t.hasVerticalVelocity:!0,this.verticalVelocity=t.verticalVelocity??0,this.enabled=t.enabled!==void 0?t.enabled:!0}}const St=class St{constructor(t=20,i=14,s=1){r(this,"width");r(this,"height");r(this,"tileSize");r(this,"cols");r(this,"rows");r(this,"wallHeight");r(this,"gravity");r(this,"frictionCoeff");r(this,"staticFrictionThreshold");r(this,"tileGrid");r(this,"walls",[]);r(this,"currentPresetId","trenches");this.width=t,this.height=i,this.tileSize=s,this.cols=Math.floor(t/s),this.rows=Math.floor(i/s),this.wallHeight=1,this.gravity=10,this.frictionCoeff=10.4,this.staticFrictionThreshold=.16,this.tileGrid=Array.from({length:this.rows},()=>Array.from({length:this.cols},()=>0)),this.loadWallPreset("trenches")}rebuildWalls(){this.walls=[];for(let t=0;t<this.rows;t++)for(let i=0;i<this.cols;i++)this.tileGrid[t][i]===1&&this.walls.push({id:`wall-${i}-${t}`,x:i*this.tileSize,y:t*this.tileSize,width:this.tileSize,height:this.tileSize,wallHeight:this.wallHeight})}setStandardWallHeight(t){this.wallHeight=t,this.rebuildWalls()}setWallTile(t,i,s){if(t<0||t>=this.cols||i<0||i>=this.rows)return!1;const e=s?1:0;return this.tileGrid[i][t]===e?!1:(this.tileGrid[i][t]=e,this.rebuildWalls(),!0)}hasWall(t,i){return t<0||t>=this.cols||i<0||i>=this.rows?!1:this.tileGrid[i][t]===1}loadWallPreset(t,i){const s=St.WALL_PRESETS.find(e=>e.id===t);return s?(this.currentPresetId=t,this.tileGrid=s.generate(this.cols,this.rows),this.rebuildWalls(),this.syncEntitiesWithWalls(i),!0):!1}syncEntitiesWithWalls(t){var i;if(t)for(const s of t){const e=s.hasCollider?s.colliderRadius:((i=s.colliderModule)==null?void 0:i.radius)??.32,l=this.getSupportingWall(s.position.x,s.position.y,e);if(l)s.position.z<l.wallHeight?(s.hasVerticalPosition||(s.verticalPositionModule?s.verticalPositionModule.enabled=!0:s.verticalPositionModule=new bt({z:l.wallHeight,hasVerticalVelocity:!0})),s.position.z=l.wallHeight,s.supportingSurfaceHeight=l.wallHeight,s.standingWall=l,s.verticalVelocity=0):(s.standingWall=l,s.supportingSurfaceHeight=l.wallHeight);else if((s.supportingSurfaceHeight>=this.wallHeight-.05||s.standingWall!==null)&&(s.standingWall=null,s.supportingSurfaceHeight=0,s.isCharacter)){const o=s;o.climbingModule&&(o.climbingModule.isDismountFreefall=!0,o.climbingModule.climbSuppressedUntilRelease=!0)}}}clearAllWalls(t){this.loadWallPreset("empty",t)}resetDefaultWalls(t){this.loadWallPreset("trenches",t)}getWallAt(t,i){for(const s of this.walls)if(t>=s.x&&t<=s.x+s.width&&i>=s.y&&i<=s.y+s.height)return s;return null}testWallOverlap(t,i,s,e){const l=Math.max(e.x,Math.min(t,e.x+e.width)),o=Math.max(e.y,Math.min(i,e.y+e.height)),n=t-l,a=i-o;return n*n+a*a<s*s}getSupportingWall(t,i,s=0){if(s<=0)return this.getWallAt(t,i);for(const e of this.walls)if(this.testWallOverlap(t,i,s,e))return e;return null}areWallsContiguous(t,i){if(t.id===i.id)return!0;const s=Math.max(0,Math.max(t.x,i.x)-Math.min(t.x+t.width,i.x+i.width)),e=Math.max(0,Math.max(t.y,i.y)-Math.min(t.y+t.height,i.y+i.height)),l=Math.min(t.x+t.width,i.x+i.width)-Math.max(t.x,i.x),o=Math.min(t.y+t.height,i.y+i.height)-Math.max(t.y,i.y);return s<.001&&o>.05||e<.001&&l>.05}getSupportingSurfaceHeight(t,i,s=0){const e=this.getSupportingWall(t,i,s);return e?e.wallHeight:0}};r(St,"WALL_PRESETS",[{id:"trenches",name:"⛏️ Trench Tunnels",badge:"Dense Walls",description:"Mostly elevated walls with a winding network of 1-tile-wide ground-level trench tunnels.",generate:(t,i)=>{const s=Array.from({length:i},()=>Array.from({length:t},()=>1));for(let e=2;e<=17;e++)s[3][e]=0,s[7][e]=0,s[10][e]=0;for(let e=2;e<=11;e++)s[e][5]=0,s[e][10]=0,s[e][14]=0;s[1][10]=0,s[12][10]=0,s[7][1]=0,s[7][18]=0;for(let e=5;e<=9;e++)s[e][2]=0;for(let e=5;e<=9;e++)s[e][17]=0;for(let e=2;e<=5;e++)s[5][e]=0;for(let e=10;e<=14;e++)s[5][e]=0;for(let e=5;e<=10;e++)s[9][e]=0;for(let e=14;e<=17;e++)s[9][e]=0;return s[7][5]=0,s}},{id:"standard",name:"🏛️ Standard Arena",badge:"Balanced",description:"Center dividing wall with an open gateway and two 2×2 cover obstacles.",generate:(t,i)=>{const s=Array.from({length:i},()=>Array.from({length:t},()=>0)),e=10;for(let l=1;l<=4;l++)s[l][e]=1;for(let l=8;l<=12;l++)s[l][e]=1;return s[4][4]=1,s[5][4]=1,s[4][5]=1,s[5][5]=1,s[7][15]=1,s[8][15]=1,s[7][16]=1,s[8][16]=1,s}},{id:"courtyards",name:"🏰 Courtyards & Platforms",badge:"4 Quadrants",description:"Four large raised platforms in each corner with a central dais and open courtyards.",generate:(t,i)=>{const s=Array.from({length:i},()=>Array.from({length:t},()=>0));for(let e=2;e<=4;e++){for(let l=3;l<=6;l++)s[e][l]=1;for(let l=13;l<=16;l++)s[e][l]=1}for(let e=9;e<=11;e++){for(let l=3;l<=6;l++)s[e][l]=1;for(let l=13;l<=16;l++)s[e][l]=1}for(let e=6;e<=7;e++)for(let l=9;l<=10;l++)s[e][l]=1;return s}},{id:"pillars",name:"🗿 Pillars & Monoliths",badge:"Tactical Cover",description:"Raised monoliths and stepping-stone pillars scattered across the arena.",generate:(t,i)=>{const s=Array.from({length:i},()=>Array.from({length:t},()=>0)),e=[[3,2],[8,2],[15,2],[3,10],[8,10],[15,10],[5,6],[13,6],[9,6]];for(const[l,o]of e)s[o][l]=1,s[o+1][l]=1,s[o][l+1]=1,s[o+1][l+1]=1;return s}},{id:"maze",name:"🌀 Labyrinth Maze",badge:"Winding Paths",description:"Interlocking corridors and winding paths with high walls to climb over or navigate.",generate:(t,i)=>{const s=Array.from({length:i},()=>Array.from({length:t},()=>0));for(let e=1;e<=9;e++)s[e][4]=1;for(let e=4;e<=12;e++)s[e][7]=1;for(let e=1;e<=9;e++)s[e][10]=1;for(let e=4;e<=12;e++)s[e][13]=1;for(let e=1;e<=9;e++)s[e][16]=1;for(let e=7;e<=10;e++)s[4][e]=1;for(let e=13;e<=16;e++)s[4][e]=1;for(let e=4;e<=7;e++)s[9][e]=1;for(let e=10;e<=13;e++)s[9][e]=1;return s}},{id:"empty",name:"⬜ Empty (Open Arena)",badge:"Clean Slate",description:"Completely open arena with zero walls for custom level design.",generate:(t,i)=>Array.from({length:i},()=>Array.from({length:t},()=>0))}]);let Q=St;class dt{constructor(t={}){r(this,"radius");r(this,"enabled");this.radius=t.radius??.32,this.enabled=t.enabled??!0}}class ht{constructor(t={}){r(this,"mass");r(this,"enabled");this.mass=t.mass??1,this.enabled=t.enabled??!0}}class ut{constructor(t={}){r(this,"staticFrictionMod");r(this,"dynamicFrictionMod");r(this,"enabled");this.staticFrictionMod=t.staticFrictionMod??1,this.dynamicFrictionMod=t.dynamicFrictionMod??1,this.enabled=t.enabled??!0}}class yt{constructor(t={}){r(this,"bounceMod");r(this,"verticalBounce");r(this,"enabled");this.bounceMod=t.bounceMod??.4,this.verticalBounce=t.verticalBounce??!0,this.enabled=t.enabled??!0}}class mt{constructor(t={}){r(this,"enabled");this.enabled=t.enabled??!0}}class it{constructor(t={}){r(this,"id");r(this,"name");r(this,"position");r(this,"velocity");r(this,"color");r(this,"isHeld");r(this,"heldBy");r(this,"lastThrower",null);r(this,"isCharacter",!1);r(this,"isClimbing",!1);r(this,"visualShape","circle");r(this,"colliderModule",null);r(this,"massModule",null);r(this,"frictionModule",null);r(this,"bounceModule",null);r(this,"verticalPositionModule",null);r(this,"gravityModule",null);r(this,"rollModule",null);r(this,"supportingSurfaceHeight",0);r(this,"standingWall",null);var i,s,e,l,o;this.id=t.id??`obj-${Math.random().toString(36).substring(2,9)}`,this.name=t.name??"Entity",this.position={x:((i=t.position)==null?void 0:i.x)??0,y:((s=t.position)==null?void 0:s.y)??0,z:((e=t.position)==null?void 0:e.z)??0},this.velocity={x:((l=t.velocity)==null?void 0:l.x)??0,y:((o=t.velocity)==null?void 0:o.y)??0},this.color=t.color??"#94a3b8",this.isHeld=!1,this.heldBy=null,this.visualShape=t.visualShape??"circle",this.colliderModule=t.colliderModule!==void 0?t.colliderModule:t.colliderRadius!==void 0?new dt({radius:t.colliderRadius}):new dt({radius:.35}),this.massModule=t.massModule!==void 0?t.massModule:t.mass!==void 0?new ht({mass:t.mass}):new ht({mass:1}),this.frictionModule=t.frictionModule!==void 0?t.frictionModule:new ut({staticFrictionMod:t.staticGroundFrictionMod??1,dynamicFrictionMod:t.dynamicGroundFrictionMod??1}),this.bounceModule=t.bounceModule!==void 0?t.bounceModule:t.bounceMod!==void 0&&t.bounceMod!==null?new yt({bounceMod:t.bounceMod}):new yt({bounceMod:.4}),this.verticalPositionModule=t.verticalPositionModule!==void 0?t.verticalPositionModule:t.hasVerticalPosition===!1?null:new bt({z:this.position.z,hasVerticalVelocity:t.hasVerticalVelocity!==!1,verticalVelocity:t.verticalVelocity??0}),this.hasVerticalPosition||(this.position.z=0),this.gravityModule=t.gravityModule!==void 0?t.gravityModule:t.hasGravity===!1?null:new mt,this.rollModule=t.rollModule??null}get hasCollider(){return!!(this.colliderModule&&this.colliderModule.enabled)}get colliderRadius(){return this.colliderModule&&this.colliderModule.enabled?this.colliderModule.radius:0}set colliderRadius(t){this.colliderModule?this.colliderModule.radius=t:this.colliderModule=new dt({radius:t})}get hasMass(){return!!(this.massModule&&this.massModule.enabled&&this.massModule.mass>0)}get mass(){return this.massModule&&this.massModule.enabled?this.massModule.mass:0}set mass(t){this.massModule?this.massModule.mass=t:this.massModule=new ht({mass:t})}get hasFriction(){return!!(this.hasMass&&this.frictionModule&&this.frictionModule.enabled)}get staticGroundFrictionMod(){return this.hasFriction&&this.frictionModule?this.frictionModule.staticFrictionMod:0}set staticGroundFrictionMod(t){this.frictionModule?this.frictionModule.staticFrictionMod=t:this.frictionModule=new ut({staticFrictionMod:t})}get dynamicGroundFrictionMod(){return this.hasFriction&&this.frictionModule?this.frictionModule.dynamicFrictionMod:0}set dynamicGroundFrictionMod(t){this.frictionModule?this.frictionModule.dynamicFrictionMod=t:this.frictionModule=new ut({dynamicFrictionMod:t})}get hasBounce(){return!!(this.hasMass&&this.bounceModule&&this.bounceModule.enabled)}get bounceMod(){return this.hasBounce&&this.bounceModule?this.bounceModule.bounceMod:null}set bounceMod(t){t===null||t<=.01?this.bounceModule=null:this.bounceModule?this.bounceModule.bounceMod=t:this.bounceModule=new yt({bounceMod:t})}get hasVerticalPosition(){return!!(this.verticalPositionModule&&this.verticalPositionModule.enabled)}get hasVerticalVelocity(){var t;return!!(this.hasVerticalPosition&&((t=this.verticalPositionModule)!=null&&t.hasVerticalVelocity))}get verticalVelocity(){return this.hasVerticalVelocity&&this.verticalPositionModule?this.verticalPositionModule.verticalVelocity:0}set verticalVelocity(t){this.hasVerticalVelocity&&this.verticalPositionModule&&(this.verticalPositionModule.verticalVelocity=t)}get hasVerticalBounce(){var t;return!!(this.hasBounce&&((t=this.bounceModule)!=null&&t.verticalBounce)&&this.hasVerticalVelocity)}get hasGravity(){return!!(this.gravityModule&&this.gravityModule.enabled)}get isRestingOnSurface(){return Math.abs(this.position.z-this.supportingSurfaceHeight)<=.01&&Math.abs(this.verticalVelocity)<=.05}get isAboveGround(){return this.hasVerticalPosition&&this.position.z>.001}get isAboveWalls(){return this.hasVerticalPosition&&(this.position.z>=.85||this.supportingSurfaceHeight>=.85||this.standingWall!==null)}updatePosition(t,i){var v,V,M,g,p,w,x,R,z,O,B,A;if(this.isHeld)return;if(this.lastThrower){const F=this.lastThrower.hasCollider?this.lastThrower.colliderRadius:.44,u=(((v=this.lastThrower.pickupModule)==null?void 0:v.pickupReach)??1.3)+this.colliderRadius+F;(Math.hypot(this.position.x-this.lastThrower.position.x,this.position.y-this.lastThrower.position.y)>u||this.isRestingOnSurface)&&(this.lastThrower=null)}this.hasVerticalPosition||(this.position.z=0,this.verticalVelocity=0,this.supportingSurfaceHeight=0);let s=0;if(this.hasCollider&&this.hasVerticalPosition&&i.walls.length>0)if(this.position.z>=i.wallHeight-.05||this.supportingSurfaceHeight>=i.wallHeight-.05&&this.position.z>=i.wallHeight-.2||this.standingWall!==null){const u=this.isCharacter?this:null;if(!!((V=u==null?void 0:u.climbingModule)!=null&&V.isDismountFreefall||(M=u==null?void 0:u.climbingModule)!=null&&M.climbSuppressedUntilRePress))this.standingWall=null,s=0;else if(this.isCharacter){if(this.standingWall){const k=i.walls.find(P=>P.id===this.standingWall.id),E=this.colliderRadius;if((k?i.testWallOverlap(this.position.x,this.position.y,E,k):!1)&&k)this.standingWall=k,s=k.wallHeight;else if(k&&((g=u==null?void 0:u.climbingModule)!=null&&g.dismountSuppressedUntilRelease))this.standingWall=k,s=k.wallHeight;else{let P=null;if(k){for(const W of i.walls)if(i.areWallsContiguous(k,W)&&i.testWallOverlap(this.position.x,this.position.y,E,W)){P=W;break}}else P=i.getSupportingWall(this.position.x,this.position.y,E);P?(this.standingWall=P,s=P.wallHeight):(this.standingWall=null,s=0,u!=null&&u.climbingModule&&(u.climbingModule.isDismountFreefall=!0,u.climbingModule.climbSuppressedUntilRelease=!0))}}else if(!this.isClimbing&&(this.position.z>=i.wallHeight-.05||this.supportingSurfaceHeight>=i.wallHeight-.05)){const k=i.getSupportingWall(this.position.x,this.position.y,this.colliderRadius);k&&(this.standingWall=k,s=k.wallHeight)}}else{const k=i.getSupportingWall(this.position.x,this.position.y,this.colliderRadius);k?(this.standingWall=k,s=k.wallHeight):(this.standingWall=null,s=0)}}else this.standingWall=null;else this.standingWall=null,s=0;if(this.isClimbing&&(s=Math.max(s,this.position.z),this.verticalVelocity=0),this.supportingSurfaceHeight=s,this.hasGravity&&this.hasVerticalVelocity){if((this.position.z>s||this.verticalVelocity!==0)&&(this.verticalVelocity-=i.gravity*t,this.position.z+=this.verticalVelocity*t,this.position.z<=s))if(this.position.z=s,!this.isCharacter&&this.hasVerticalBounce&&this.bounceMod!==null&&this.bounceMod>0&&Math.abs(this.verticalVelocity)>.25){const F=Math.abs(this.verticalVelocity);if(this.verticalVelocity=-this.verticalVelocity*this.bounceMod,this.hasFriction&&this.rollModule&&this.rollModule.enabled){const u=this.rollModule,S=this.colliderRadius>0?this.colliderRadius:.3,k=.4,E=this.bounceMod,D=(1+E)*this.mass*F,P=i.frictionCoeff*this.dynamicGroundFrictionMod*.05,W=this.velocity.x-u.angularVelocity.y*S,T=this.velocity.y+u.angularVelocity.x*S,L=Math.hypot(W,T);if(L>.001&&P>0){const C=P*D,q=L*this.mass/(1+1/k),H=Math.min(q,C),j=W/L*H,G=T/L*H;this.velocity.x-=j/this.mass,this.velocity.y-=G/this.mass,u.angularVelocity.y+=j/(k*this.mass*S),u.angularVelocity.x-=G/(k*this.mass*S)}const $=Math.max(.65,1-(1-E)*.35);u.angularVelocity.x*=$,u.angularVelocity.y*=$,u.angularVelocity.z*=$}}else this.verticalVelocity=0}else this.hasVerticalVelocity&&this.verticalVelocity!==0&&(this.position.z+=this.verticalVelocity*t,this.position.z<=s&&(this.position.z=s,this.hasVerticalBounce&&this.bounceMod!==null&&this.bounceMod>0&&Math.abs(this.verticalVelocity)>.25?this.verticalVelocity=-this.verticalVelocity*this.bounceMod:this.verticalVelocity=0));if(Math.abs(this.position.z-s)<=.01&&Math.abs(this.verticalVelocity)<=.05&&this.hasFriction){if(!(this.isCharacter&&((p=this.walkingModule)==null?void 0:p.enabled)))if(this.rollModule&&this.rollModule.enabled){const u=this.rollModule,S=this.colliderRadius>0?this.colliderRadius:.3,k=i.frictionCoeff*this.dynamicGroundFrictionMod,E=.4,D=this.velocity.x-u.angularVelocity.y*S,P=this.velocity.y+u.angularVelocity.x*S,W=Math.hypot(D,P);if(k>0&&W>.001){const L=k*(1+1/E)*t;if(W<=L){const $=this.velocity.x+E*u.angularVelocity.y*S,C=this.velocity.y-E*u.angularVelocity.x*S,q=$/(1+E),H=C/(1+E);this.velocity.x=q,this.velocity.y=H,u.angularVelocity.y=q/S,u.angularVelocity.x=-H/S}else{const $=D/W*k*t,C=P/W*k*t;this.velocity.x-=$,this.velocity.y-=C,u.angularVelocity.y+=$/(E*S),u.angularVelocity.x-=C/(E*S)}}const T=Math.hypot(this.velocity.x,this.velocity.y);if(T>0){if(u.rollResistance>0){const L=u.rollResistance*t,$=Math.max(0,T-L);if($<.005)this.velocity.x=0,this.velocity.y=0,u.angularVelocity.x=0,u.angularVelocity.y=0;else{const C=$/T;this.velocity.x*=C,this.velocity.y*=C,u.angularVelocity.x*=C,u.angularVelocity.y*=C}}}else{const L=Math.hypot(u.angularVelocity.x,u.angularVelocity.y);if(L>0&&k>0){const $=k/(E*S)*t,C=Math.max(0,L-$),q=L>0?C/L:0;u.angularVelocity.x*=q,u.angularVelocity.y*=q}}if(Math.abs(u.angularVelocity.z)>.001&&u.rollResistance>0){const L=u.rollResistance/(E*S)*t,$=Math.sign(u.angularVelocity.z),C=Math.abs(u.angularVelocity.z);u.angularVelocity.z=C<=L?0:$*(C-L)}u.updateVisualPhase(t)}else{const u=Math.hypot(this.velocity.x,this.velocity.y);if(u>0){const S=i.staticFrictionThreshold*this.staticGroundFrictionMod;if(u<S)this.velocity.x=0,this.velocity.y=0;else{const k=i.frictionCoeff*this.dynamicGroundFrictionMod*t,D=Math.max(0,u-k)/u;this.velocity.x*=D,this.velocity.y*=D}}}}else this.rollModule&&this.rollModule.enabled&&this.rollModule.updateVisualPhase(t);const l=this.isCharacter?this:null,o=l==null?void 0:l.climbingModule,n=!this.isClimbing&&this.supportingSurfaceHeight>=i.wallHeight-.05&&this.standingWall!==null,a=Math.max(.01,(o==null?void 0:o.hangDistance)??.1);if(o)if(this.position.z<=.01)o.isAssistClampArmed=!1,o.hasLeftClampZoneSinceDismount=!0;else if(n&&this.standingWall){const F=this.standingWall,u=[F];for(const E of i.walls)E.id!==F.id&&i.areWallsContiguous(F,E)&&u.push(E);let S=1/0;for(const E of u){const D=Math.max(E.x,Math.min(this.position.x,E.x+E.width)),P=Math.max(E.y,Math.min(this.position.y,E.y+E.height)),W=Math.hypot(this.position.x-D,this.position.y-P);W<S&&(S=W)}S<=a+.001?o.hasLeftClampZoneSinceDismount&&(o.isAssistClampArmed=!0):(o.hasLeftClampZoneSinceDismount=!0,o.isAssistClampArmed=!1)}else o.isAssistClampArmed=!1;const d=!!(l&&n&&(o!=null&&o.enabled)&&(o!=null&&o.preventWalkOff)&&(o!=null&&o.isAssistClampArmed)),c=this.velocity.x*t,h=this.velocity.y*t,m=Math.hypot(c,h);if(m>1e-4)if(d){const F=Math.max(.01,((w=l==null?void 0:l.climbingModule)==null?void 0:w.hangDistance)??.1);let u=this.standingWall??i.getSupportingWall(this.position.x,this.position.y,F);this.standingWall=u;const S=this.position.x+c,k=this.position.y+h,E=[];if(u){E.push(u);for(const P of i.walls)P.id!==u.id&&i.areWallsContiguous(u,P)&&E.push(P)}let D=null;for(const P of E)if(i.testWallOverlap(S,k,F,P)){D=P;break}if(D)this.position.x=S,this.position.y=k,this.standingWall=D;else if(E.length>0){let P=1/0,W=null;for(const T of E){const L=Math.max(T.x,Math.min(S,T.x+T.width)),$=Math.max(T.y,Math.min(k,T.y+T.height)),C=S-L,q=k-$,H=C*C+q*q;H<P&&(P=H,W={wall:T,closestX:L,closestY:$,dist:Math.sqrt(H),dx:C,dy:q})}if(W&&W.dist>0){const T=W.dx/W.dist,L=W.dy/W.dist,$=this.velocity.x*T+this.velocity.y*L,C=(l==null?void 0:l.movementInput)??{x:0,y:0},q=C.x*T+C.y*L;if(($>.001||q>.05)&&(l!=null&&l.isClimbInputHeld)&&!(o!=null&&o.dismountSuppressedUntilRelease))o&&(o.isAssistClampArmed=!1,o.hasLeftClampZoneSinceDismount=!1),this.position.x=S,this.position.y=k;else{$>0&&(this.velocity.x-=$*T,this.velocity.y-=$*L);const j=F-.002;W.dist>j?(this.position.x=W.closestX+T*j,this.position.y=W.closestY+L*j):(this.position.x=S,this.position.y=k);const G=i.testWallOverlap(this.position.x,this.position.y,F,W.wall)?W.wall:E.find(y=>i.testWallOverlap(this.position.x,this.position.y,F,y));G&&(this.standingWall=G)}}else this.velocity.x=0,this.velocity.y=0}}else{const u=Math.max(1,Math.ceil(m/.01)),S=c/u,k=h/u;let E=this.standingWall??(n?i.getSupportingWall(this.position.x,this.position.y,this.colliderRadius):null),D=!1;for(let P=1;P<=u;P++){const W=this.position.x+S,T=this.position.y+k;if(E){let $=null;if(i.testWallOverlap(W,T,this.colliderRadius,E))$=E;else for(const C of i.walls)if(i.areWallsContiguous(E,C)&&i.testWallOverlap(W,T,this.colliderRadius,C)){$=C;break}$?(E=$,this.standingWall=$):(x=l==null?void 0:l.climbingModule)!=null&&x.dismountSuppressedUntilRelease||(D=!0,E=null,this.standingWall=null,this.supportingSurfaceHeight=0,l!=null&&l.climbingModule&&(l.climbingModule.isDismountFreefall=!0,l.climbingModule.climbSuppressedUntilRelease=!0))}if(this.position.x=W,this.position.y=T,!this.isClimbing&&(D||!this.standingWall&&!!((R=l==null?void 0:l.climbingModule)!=null&&R.isDismountFreefall||(z=l==null?void 0:l.climbingModule)!=null&&z.climbSuppressedUntilRePress))&&this.hasCollider)for(const $ of i.walls)this.position.z<=$.wallHeight&&this.resolveWallCollision($)}}if(this.hasCollider){const F=this.colliderRadius,u=F,S=i.width-F,k=F,E=i.height-F,D=this.isCharacter?0:this.hasBounce&&this.bounceMod!==null?this.bounceMod:0;this.position.x<u?(this.position.x=u,this.resolveWallImpact(1,0,D)):this.position.x>S&&(this.position.x=S,this.resolveWallImpact(-1,0,D)),this.position.y<k?(this.position.y=k,this.resolveWallImpact(0,1,D)):this.position.y>E&&(this.position.y=E,this.resolveWallImpact(0,-1,D));const P=!!((O=l==null?void 0:l.climbingModule)!=null&&O.isDismountFreefall||(B=l==null?void 0:l.climbingModule)!=null&&B.climbSuppressedUntilRePress);for(const W of i.walls)if(this.position.z<=W.wallHeight){if(this.position.z>=W.wallHeight-.05&&!P&&(((A=this.standingWall)==null?void 0:A.id)===W.id||i.testWallOverlap(this.position.x,this.position.y,this.colliderRadius,W)))continue;if(this.position.z<W.wallHeight-.05||P||this.standingWall===null){if(this.standingWall&&(this.standingWall.id===W.id||i.areWallsContiguous(this.standingWall,W)))continue;this.resolveWallCollision(W)}}}const f=16,b=Math.hypot(this.velocity.x,this.velocity.y);if(b>f){const F=f/b;this.velocity.x*=F,this.velocity.y*=F}if(this.rollModule&&this.rollModule.enabled){const u=this.rollModule.angularSpeed;if(u>35){const S=35/u;this.rollModule.angularVelocity.x*=S,this.rollModule.angularVelocity.y*=S,this.rollModule.angularVelocity.z*=S}}this.verticalPositionModule&&(this.verticalPositionModule.z=this.position.z)}static getClosestWallPoint(t,i,s){if(!s.walls||s.walls.length===0)return null;let e=1/0,l=null;for(const o of s.walls){const n=Math.max(o.x,Math.min(t,o.x+o.width)),a=Math.max(o.y,Math.min(i,o.y+o.height)),d=t-n,c=i-a,h=d*d+c*c;h<e&&(e=h,l={wall:o,closestX:n,closestY:a,dist:Math.sqrt(h),dx:d,dy:c})}return l}resolveWallImpact(t,i,s){this.lastThrower=null;const e=this.velocity.x*t+this.velocity.y*i;if(e>=0)return;const l=e;if(s>0&&this.hasMass?(this.velocity.x-=(1+s)*l*t,this.velocity.y-=(1+s)*l*i):(this.velocity.x-=l*t,this.velocity.y-=l*i),this.hasFriction&&this.rollModule&&this.rollModule.enabled){const o=this.rollModule,n=this.colliderRadius>0?this.colliderRadius:.3,a=.4,d=.35,c=-i,h=t,m=this.velocity.x*c+this.velocity.y*h,f=-(1+s)*this.mass*l,b=m-o.angularVelocity.z*n,v=Math.abs(b)*this.mass/(1+1/a),V=d*f,M=Math.min(v,V),g=-Math.sign(b)*M,p=m,w=p+g/this.mass,x=Math.abs(w)<=Math.abs(p)+.01?w-p:-p*.1;this.velocity.x+=x*c,this.velocity.y+=x*h;const z=-(x*this.mass)/(a*this.mass*n);o.angularVelocity.z+=z,o.angularVelocity.z=Math.max(-30,Math.min(30,o.angularVelocity.z)),o.angularVelocity.y=this.velocity.x/n,o.angularVelocity.x=-this.velocity.y/n}}resolveWallCollision(t){if(!this.hasCollider)return;const i=this.colliderRadius,s=Math.max(t.x,Math.min(this.position.x,t.x+t.width)),e=Math.max(t.y,Math.min(this.position.y,t.y+t.height)),l=this.position.x-s,o=this.position.y-e,n=l*l+o*o;if(n<i*i){this.lastThrower=null;const a=Math.sqrt(n);let d=0,c=0,h=0;if(a===0){const f=Math.abs(this.position.x-t.x),b=Math.abs(t.x+t.width-this.position.x),v=Math.abs(this.position.y-t.y),V=Math.abs(t.y+t.height-this.position.y),M=Math.min(f,b,v,V);M===f?(d=-1,h=f+i):M===b?(d=1,h=b+i):M===v?(c=-1,h=v+i):(c=1,h=V+i)}else h=i-a,d=l/a,c=o/a;this.position.x+=d*h,this.position.y+=c*h;const m=this.isCharacter?0:this.hasBounce&&this.bounceMod!==null?this.bounceMod:0;this.resolveWallImpact(d,c,m)}}}class Rt{constructor(){r(this,"id","walking");r(this,"name","Walking Module");r(this,"enabled",!0);r(this,"maxWalkForce",35);r(this,"maxWalkSpeed",5.2);r(this,"dragDamping",8.01)}update(t,i,s,e){var O;if(!this.enabled||!t.isRestingOnSurface||t.isClimbing){t.isActivelyWalking=!1;return}if(!t.hasFriction||!((O=t.frictionModule)!=null&&O.enabled)||!t.hasMass||!t.hasStrength||t.strength<=0){t.isActivelyWalking=!1;return}const l=Math.hypot(i.x,i.y),o=l>.05;if(t.isActivelyWalking=o,t.mass<=.01)return;const a=t.dynamicGroundFrictionMod;if(a<=.001)return;const d=e.frictionCoeff/10,c=a*d,m=t.carriedMass/(Math.max(.1,t.strength)*8),f=this.maxWalkSpeed/(1+m);let b=0,v=0;if(o){const B=i.x/l,A=i.y/l;b=B*f,v=A*f}const V=b-t.velocity.x,M=v-t.velocity.y,g=Math.hypot(V,M);if(g<.001){t.velocity.x=b,t.velocity.y=v;return}const p=Math.hypot(t.velocity.x,t.velocity.y),w=Math.max(.02,e.staticFrictionThreshold*t.staticGroundFrictionMod),x=t.hasMass?Math.max(.2,t.baseMass):1,z=this.maxWalkForce*t.strength/x*c*s;if(g<=z||!o&&p<w)t.velocity.x=b,t.velocity.y=v;else{const B=z/g;t.velocity.x+=V*B,t.velocity.y+=M*B}}}class Wt{constructor(){r(this,"id","pickup");r(this,"name","Pickup Ability");r(this,"enabled",!0);r(this,"pickupReach",1.3);r(this,"crossLayerReachRatio",.55)}isObjectInReach(t,i,s=1){var c;if(!this.enabled||i===t||i.isHeld||i.isCharacter||i.lastThrower===t)return!1;const e=t.standingWall!==null||t.supportingSurfaceHeight>=s-.05?2:1,l=i.standingWall!==null||i.supportingSurfaceHeight>=s-.05?2:1,n=e===l?this.pickupReach:this.pickupReach*this.crossLayerReachRatio,a=i.hasCollider?i.colliderRadius:((c=i.colliderModule)==null?void 0:c.radius)??.32;return Math.hypot(i.position.x-t.position.x,i.position.y-t.position.y)<=n+a}findTargetObject(t,i,s,e,l=1){if(!this.enabled)return null;let o=null,n=1/0;for(const a of e){if(!this.isObjectInReach(t,a,l))continue;const d=Math.hypot(a.position.x-i,a.position.y-s);d<n&&(n=d,o=a)}return o}pickup(t,i){if(!this.enabled||t.heldObject)return!1;const s=i.velocity.x,e=i.velocity.y,l=i.mass/Math.max(.2,t.mass);return t.velocity.x+=s*l,t.velocity.y+=e*l,t.isAboveGround&&Math.abs(i.verticalVelocity)>.1&&(t.verticalVelocity+=i.verticalVelocity*l),t.heldObject=i,i.isHeld=!0,i.heldBy=t,i.velocity.x=0,i.velocity.y=0,i.verticalVelocity=0,i.rollModule&&(i.rollModule.angularVelocity.x=0,i.rollModule.angularVelocity.y=0,i.rollModule.angularVelocity.z=0),i.position.z=i.hasVerticalPosition?.45:0,!0}drop(t){if(!t.heldObject)return null;const i=t.heldObject;if(t.heldObject=null,i.isHeld=!1,i.heldBy=null,i.lastThrower=null,i.velocity.x=t.velocity.x,i.velocity.y=t.velocity.y,i.verticalVelocity=t.isAboveGround?t.verticalVelocity:0,i.hasFriction&&i.rollModule&&i.rollModule.enabled){const s=i.colliderRadius>0?i.colliderRadius:.3;i.rollModule.angularVelocity.y=i.velocity.x/s,i.rollModule.angularVelocity.x=-i.velocity.y/s}return i}}class Pt{constructor(){r(this,"id","throw");r(this,"name","Throw Ability");r(this,"enabled",!0);r(this,"baseThrowForce",7.6);r(this,"maxThrowAimDistance",13)}testWallIntersection(t,i,s,e){const l=Math.max(e.x,Math.min(t,e.x+e.width)),o=Math.max(e.y,Math.min(i,e.y+e.height)),n=t-l,a=i-o;return n*n+a*a<s*s}computeLaunchVelocity(t,i,s,e,l,o,n,a=!0,d=!0,c=.35,h){const m=e-t,f=l-i,b=Math.hypot(m,f);if(b<.1)return null;const v=Math.min(b,this.maxThrowAimDistance),V=m/b,M=f/b,g=t+V*v,p=i+M*v,w=(h==null?void 0:h.x)??0,x=(h==null?void 0:h.y)??0,R=w*V+x*M,z=w*-M+x*V,O=Math.sqrt(Math.max(.25,n*n-z*z)),B=Math.max(1.5,R+O);if(!a||!d){const $=Math.max(.14,v/B),C=V*B,q=M*B;return{vx:C,vy:q,vz:0,totalTime:$,finalTargetX:g,finalTargetY:p,targetSurfaceHeight:s}}const A=o.getSupportingSurfaceHeight(g,p),F=A-s;let S=Math.max(.14,v/B);F>0&&(S=Math.max(S,Math.sqrt(2*F/o.gravity)));const k=40,E=c>0?c:.35,D=.25;for(let $=1;$<k;$++){const C=$/k,q=t+(g-t)*C,H=i+(p-i)*C;for(const j of o.walls)if(this.testWallIntersection(q,H,E,j)){if(A>0&&g>=j.x&&g<=j.x+j.width&&p>=j.y&&p<=j.y+j.height&&C>.65)continue;const y=(1-C)*s+C*A,Y=j.wallHeight+D-y;if(Y>0){const U=o.gravity*C*(1-C);if(U>.001){const Z=2*Y/U;if(Z>0){const N=Math.sqrt(Z);N>S&&(S=N)}}}}}if(S<=.05)return null;const P=(F+.5*o.gravity*S*S)/S,W=v/S,T=V*W,L=M*W;return{vx:T,vy:L,vz:P,totalTime:S,finalTargetX:g,finalTargetY:p,targetSurfaceHeight:A}}calculateTrajectory(t,i,s,e){if(!this.enabled||!t.heldObject)return null;const l=t.heldObject,o=l.position.x,n=l.position.y,a=l.position.z,d=this.baseThrowForce*t.strength,c=l.hasGravity&&l.hasVerticalVelocity,h={x:t.velocity.x,y:t.velocity.y,z:t.isAboveGround?t.verticalVelocity:0},m=this.computeLaunchVelocity(o,n,a,i,s,e,d,l.hasGravity,l.hasVerticalVelocity,l.colliderRadius,h);if(!m)return null;const{vx:f,vy:b,vz:v,totalTime:V,finalTargetX:M,finalTargetY:g,targetSurfaceHeight:p}=m,w=90,x=V/w,R=[];let z=!1,O=p>0,B,A=a;for(let u=0;u<=w;u++){const S=u*x,k=u===w?M:o+f*S,E=u===w?g:n+b*S,D=c?a+v*S-.5*e.gravity*S*S:a,P=c?u===w?p:Math.max(p,D):a,W=c?v-e.gravity*S:0;P>A&&(A=P);const T=P>e.wallHeight;let L=!1,$=!1;for(const C of e.walls)if(this.testWallIntersection(k,E,l.colliderRadius,C)&&(L=!0,P<=C.wallHeight+.001)){if(R.length>0&&R[R.length-1].z>=C.wallHeight-.05&&W<=0){if(p>0&&M>=C.x-.1&&M<=C.x+C.width+.1&&g>=C.y-.1&&g<=C.y+C.height+.1||p>0&&u>=w-3){O=!0;break}else if(p===0){O=!0,$=!0,z=!0,B=C.id;break}}else if(P<C.wallHeight-.05&&u>1){$=!0,z=!0,B=C.id;break}}if(R.push({x:k,y:E,z:P,t:S,couldClearWall:T,isOverWall:L,collidesWall:$}),$)break}const F=R[R.length-1];return{points:R,landPoint:{x:z?F.x:M,y:z?F.y:g},isBlockedByWall:z,isLandingOnWallTop:z?O:p>0,blockedAtWallId:B,peakHeight:A,flightTime:V,colliderRadius:l.colliderRadius,visualShape:l.visualShape}}throwHeldObject(t,i,s,e){if(!this.enabled||!t.heldObject)return null;const l=t.heldObject,o=l.position.x,n=l.position.y,a=l.position.z,d=this.baseThrowForce*t.strength,c={x:t.velocity.x,y:t.velocity.y,z:t.isAboveGround?t.verticalVelocity:0},h=this.computeLaunchVelocity(o,n,a,i,s,e,d,l.hasGravity,l.hasVerticalVelocity,l.colliderRadius,c);if(!h)return null;if(l.isHeld=!1,l.heldBy=null,l.lastThrower=t,l.velocity.x=h.vx,l.velocity.y=h.vy,l.verticalVelocity=h.vz,l.position.z=l.hasVerticalPosition?Math.max(.3,l.position.z):0,l.hasFriction&&l.rollModule&&l.rollModule.enabled){const M=l.colliderRadius>0?l.colliderRadius:.3;l.rollModule.angularVelocity.y=h.vx/M,l.rollModule.angularVelocity.x=-h.vy/M}const m=l.hasMass?l.mass:0,f=t.hasMass?Math.max(.2,t.baseMass):0,b=m>0&&f>0?m/f:0;t.heldObject=null;const v=h.vx-t.velocity.x,V=h.vy-t.velocity.y;if(t.velocity.x-=v*b,t.velocity.y-=V*b,t.isAboveGround&&l.hasVerticalVelocity){const M=h.vz-t.verticalVelocity;t.verticalVelocity-=M*b}return l}}class Ft{constructor(t){r(this,"id","climbing");r(this,"name","Climbing Module");r(this,"enabled",!0);r(this,"maxAdhesion",35);r(this,"maxClimbSpeed",3);r(this,"preventWalkOff",!0);r(this,"horizontalClimb",!1);r(this,"hangDistance",.1);r(this,"dismountSuppressedUntilRelease",!1);r(this,"climbSuppressedUntilRelease",!1);r(this,"isDismountFreefall",!1);r(this,"isAssistClampArmed",!1);r(this,"hasLeftClampZoneSinceDismount",!0);r(this,"wasClimbHeldLastTick",!1);(t==null?void 0:t.maxAdhesion)!==void 0&&(this.maxAdhesion=t.maxAdhesion),(t==null?void 0:t.maxClimbSpeed)!==void 0&&(this.maxClimbSpeed=t.maxClimbSpeed),(t==null?void 0:t.preventWalkOff)!==void 0&&(this.preventWalkOff=t.preventWalkOff),(t==null?void 0:t.horizontalClimb)!==void 0&&(this.horizontalClimb=t.horizontalClimb),(t==null?void 0:t.hangDistance)!==void 0&&(this.hangDistance=t.hangDistance)}get climbSuppressedUntilRePress(){return this.isDismountFreefall||this.climbSuppressedUntilRelease}set climbSuppressedUntilRePress(t){this.isDismountFreefall=t,this.climbSuppressedUntilRelease=t}update(t,i,s,e,l){const o=s&&!this.wasClimbHeldLastTick;if(this.wasClimbHeldLastTick=s,s||(this.dismountSuppressedUntilRelease=!1,this.climbSuppressedUntilRelease=!1),(t.position.z<=.01||o)&&(this.isDismountFreefall=!1,t.position.z<=.01&&(this.isAssistClampArmed=!1,this.hasLeftClampZoneSinceDismount=!0)),this.climbSuppressedUntilRelease||!this.enabled||!t.hasVerticalPosition||!t.hasStrength||t.strength<=0)return t.isClimbing=!1,!1;const n=t.hasCollider?t.colliderRadius:.44,a=Math.hypot(i.x,i.y),d=a>=.05,c=d?i.x/a:0,h=d?i.y/a:0;if(!t.isClimbing&&(t.standingWall!==null||t.position.z>=l.wallHeight))return t.isClimbing=!1,!1;let m=null,f=1/0,b=0,v=0,V=0;for(const x of l.walls){const R=Math.max(x.x,Math.min(t.position.x,x.x+x.width)),z=Math.max(x.y,Math.min(t.position.y,x.y+x.height)),O=R-t.position.x,B=z-t.position.y,A=Math.hypot(O,B);A<=n+.15&&A<f&&(f=A,m=x,b=d?c*O+h*B:0,v=O,V=B)}if(!m)return t.isClimbing=!1,!1;const M=t.mass;if(M*l.gravity>this.maxAdhesion)return t.isClimbing=!1,!1;const p=t.isClimbing;if(p&&t.position.z<m.wallHeight){const x=f>.001?v/f:0,R=f>.001?V/f:0,z=-R,O=x,B=d?c*x+h*R:0,A=d?c*z+h*O:0;if(d&&(B<-.3||!this.horizontalClimb&&b<-.1))return t.isClimbing=!1,t.velocity.x=c*3,t.velocity.y=h*3,s&&(this.climbSuppressedUntilRelease=!0),!1;if(t.isClimbing=!0,t.verticalVelocity=0,t.standingWall=null,this.horizontalClimb&&d&&Math.abs(A)>=.1){const F=t.baseMass,u=Math.max(.5,Math.min(this.maxClimbSpeed,this.maxClimbSpeed*F*t.strength/Math.max(.1,M)));t.velocity.x=z*A*u,t.velocity.y=O*A*u}else t.velocity.x=0,t.velocity.y=0;if(s){const F=t.baseMass,u=Math.max(.2,Math.min(this.maxClimbSpeed,this.maxClimbSpeed*F*t.strength/Math.max(.1,M)));t.position.z+=u*e,t.position.z>=m.wallHeight&&(t.position.z=m.wallHeight,t.supportingSurfaceHeight=m.wallHeight,t.standingWall=m,t.verticalVelocity=0,t.isClimbing=!1,this.dismountSuppressedUntilRelease=!0,this.isAssistClampArmed=!1,this.hasLeftClampZoneSinceDismount=!0)}return!0}if(!p&&t.position.z>.05&&t.position.z<m.wallHeight)return o?(t.isClimbing=!0,t.verticalVelocity=0,t.velocity.x=0,t.velocity.y=0,!0):(t.isClimbing=!1,!1);if(s&&d&&b>.01&&f<=n+.03&&t.position.z<m.wallHeight){if(f>.001){const z=v/f,O=V/f;t.position.x=t.position.x+v-z*n,t.position.y=t.position.y+V-O*n}t.isClimbing=!0,t.verticalVelocity=0,t.velocity.x=0,t.velocity.y=0;const x=t.baseMass,R=Math.max(.2,Math.min(this.maxClimbSpeed,this.maxClimbSpeed*x*t.strength/Math.max(.1,M)));return t.position.z+=R*e,!0}return t.isClimbing=!1,!1}}class wt{constructor(t={}){r(this,"id","strength");r(this,"name","Strength Module");r(this,"enabled",!0);r(this,"strength",1);this.strength=t.strength??1,this.enabled=t.enabled??!0}}class xt extends it{constructor(i={}){super({name:"Player Character",position:{x:i.x??5,y:i.y??7,z:0},mass:i.mass??1.2,colliderRadius:i.colliderRadius??.44,color:i.color??"#f59e0b",bounceMod:.1});r(this,"strengthModule");r(this,"facingAngle");r(this,"heldObject");r(this,"isCharacter",!0);r(this,"isActivelyWalking",!1);r(this,"isClimbInputHeld",!1);r(this,"baseMass",1.2);r(this,"walkingModule");r(this,"pickupModule");r(this,"throwModule");r(this,"climbingModule");r(this,"isAiming");r(this,"aimTarget");r(this,"activeTrajectory");this.baseMass=i.mass??1.2,this.strength=i.strength??1,this.facingAngle=0,this.heldObject=null,this.isAiming=!1,this.aimTarget=null,this.activeTrajectory=null,this.strengthModule=new wt({strength:i.strength??1}),this.walkingModule=new Rt,this.pickupModule=new Wt,this.throwModule=new Pt,this.climbingModule=new Ft}get hasStrength(){return!!(this.strengthModule&&this.strengthModule.enabled&&this.strengthModule.strength>0)}get strength(){return this.hasStrength?this.strengthModule.strength:0}set strength(i){this.strengthModule?this.strengthModule.strength=Math.max(.1,i):this.strengthModule=new wt({strength:i})}get mass(){const i=this.hasMass?this.baseMass:0,s=this.heldObject&&this.heldObject.hasMass?this.heldObject.mass:0;return i+s}set mass(i){this.baseMass=Math.max(.1,i),this.massModule&&(this.massModule.mass=this.baseMass)}get carriedMass(){return this.heldObject&&this.heldObject.hasMass?this.heldObject.mass:0}get hangDistance(){return this.climbingModule?this.climbingModule.hangDistance:.1}set hangDistance(i){this.climbingModule&&(this.climbingModule.hangDistance=Math.max(0,i))}updateFacingDirection(i,s,e){if((this.heldObject!==null||i)&&s&&(this.throwModule!==null||this.pickupModule!==null)){const l=s.x-this.position.x,o=s.y-this.position.y;if(Math.hypot(l,o)>.1){this.facingAngle=Math.atan2(o,l);return}}e&&Math.hypot(e.x,e.y)>.05&&(this.facingAngle=Math.atan2(e.y,e.x))}updateCharacter(i,s,e,l,o,n=!1){if(this.isClimbInputHeld=n,this.climbingModule&&this.climbingModule.update(this,s,n,i,o),this.walkingModule&&this.walkingModule.update(this,s,i,o),this.updatePosition(i,o),this.updateFacingDirection(e,l,s),this.heldObject){const a=this.colliderRadius+this.heldObject.colliderRadius*.5+.08;this.heldObject.position.x=this.position.x+Math.cos(this.facingAngle)*a,this.heldObject.position.y=this.position.y+Math.sin(this.facingAngle)*a,this.heldObject.position.z=this.heldObject.hasVerticalPosition?this.position.z+.45:0,this.heldObject.velocity.x=this.velocity.x,this.heldObject.velocity.y=this.velocity.y,this.heldObject.verticalVelocity=0}this.isAiming=this.heldObject!==null||e,this.aimTarget=l,this.heldObject&&this.throwModule&&l?this.activeTrajectory=this.throwModule.calculateTrajectory(this,l.x,l.y,o):this.activeTrajectory=null}}class Mt{constructor(t={}){r(this,"enabled",!0);r(this,"angularVelocity",{x:0,y:0,z:0});r(this,"rollResistance",.4);r(this,"visualPhase",0);var i,s,e;this.enabled=t.enabled??!0,this.angularVelocity={x:((i=t.angularVelocity)==null?void 0:i.x)??0,y:((s=t.angularVelocity)==null?void 0:s.y)??0,z:((e=t.angularVelocity)==null?void 0:e.z)??0},this.rollResistance=t.rollResistance??.4}get angularSpeed(){return Math.hypot(this.angularVelocity.x,this.angularVelocity.y,this.angularVelocity.z)}updateVisualPhase(t){const i=this.angularSpeed;i>.001&&(this.visualPhase=(this.visualPhase+i*t)%(Math.PI*2))}}class et{constructor(t){r(this,"ctx");this.ctx=t}render(t,i,s,e,l=!1,o,n,a=!1,d){const c=this.ctx,h=c.canvas.width/t.width;c.clearRect(0,0,c.canvas.width,c.canvas.height),this.drawFloorGrid(t,h),this.drawWalls(t,h),a&&d&&this.drawWallEditorHover(t,d,h);const m=[i,...s];m.sort((f,b)=>f.isHeld&&f.heldBy===b||i.heldObject===f&&b===i?-1:b.isHeld&&b.heldBy===f||i.heldObject===b&&f===i?1:Math.abs(f.position.z-b.position.z)>.001?f.position.z-b.position.z:Math.abs(f.verticalVelocity-b.verticalVelocity)>.001?f.verticalVelocity-b.verticalVelocity:f.position.y-b.position.y);for(const f of m)f instanceof xt?this.drawCharacter(f,h,t):this.drawFreebodyObject(f,i,h,f===n,t),this.drawObjectShadow(f,t,h);i.activeTrajectory&&this.drawTrajectory(i.activeTrajectory,h,t),l&&(o&&o!==e&&this.drawHoverGizmo(o,h),e&&this.drawSelectionGizmo(e,l,h))}drawFloorGrid(t,i){const s=this.ctx;s.fillStyle="#0f172a",s.fillRect(0,0,t.width*i,t.height*i),s.strokeStyle="rgba(148, 163, 184, 0.08)",s.lineWidth=1;for(let e=1;e<t.width;e++)s.beginPath(),s.moveTo(e*i,0),s.lineTo(e*i,t.height*i),s.stroke();for(let e=1;e<t.height;e++)s.beginPath(),s.moveTo(0,e*i),s.lineTo(t.width*i,e*i),s.stroke();s.strokeStyle="rgba(148, 163, 184, 0.35)",s.lineWidth=3,s.strokeRect(1.5,1.5,t.width*i-3,t.height*i-3)}drawWalls(t,i){const s=this.ctx;for(const e of t.walls)s.fillStyle="#1e293b",s.fillRect(e.x*i,e.y*i,e.width*i,e.height*i),s.strokeStyle="#475569",s.lineWidth=2,s.strokeRect(e.x*i,e.y*i,e.width*i,e.height*i)}drawWallEditorHover(t,i,s){if(i.col<0||i.col>=t.cols||i.row<0||i.row>=t.rows)return;const e=this.ctx,l=i.col*t.tileSize*s,o=i.row*t.tileSize*s,n=t.tileSize*s,a=t.hasWall(i.col,i.row);e.save(),a?(e.fillStyle="rgba(239, 68, 68, 0.35)",e.strokeStyle="#ef4444",e.lineWidth=2.5,e.fillRect(l,o,n,n),e.strokeRect(l,o,n,n),e.font="bold 12px system-ui, sans-serif",e.fillStyle="#fca5a5",e.textAlign="center",e.textBaseline="middle",e.fillText("✕ Erase",l+n/2,o+n/2)):(e.fillStyle="rgba(56, 189, 248, 0.3)",e.strokeStyle="#38bdf8",e.lineWidth=2.5,e.fillRect(l,o,n,n),e.strokeRect(l,o,n,n),e.font="bold 12px system-ui, sans-serif",e.fillStyle="#7dd3fc",e.textAlign="center",e.textBaseline="middle",e.fillText("+ Draw",l+n/2,o+n/2)),e.restore()}static getAltitudeScale(t,i){return 1+Math.max(0,t)/Math.max(.1,i)*.5}static isEntityOnLayer2(t,i){const s=i-.05;return t.position.z>=s||t.supportingSurfaceHeight>=s||t.standingWall!==null||t.isAboveWalls}drawObjectShadow(t,i,s){const e=t.position.z;if(e<=.01)return;const l=this.ctx,o=t.position.x*s,n=t.position.y*s,a=t.colliderRadius*s;if(l.save(),l.beginPath(),t.visualShape==="box"){const d=a*2,c=Math.max(3,a*.16);l.roundRect?l.roundRect(o-a,n-a,d,d,c):l.rect(o-a,n-a,d,d)}else l.arc(o,n,a,0,Math.PI*2);if(l.strokeStyle="rgba(255, 255, 255, 0.85)",l.lineWidth=1.8,l.setLineDash([4,4]),l.stroke(),e>i.wallHeight+.01){const d=et.getAltitudeScale(i.wallHeight,i.wallHeight),c=t.colliderRadius*s*d;if(l.beginPath(),t.visualShape==="box"){const h=c*2,m=Math.max(3,c*.16);l.roundRect?l.roundRect(o-c,n-c,h,h,m):l.rect(o-c,n-c,h,h)}else l.arc(o,n,c,0,Math.PI*2);l.strokeStyle="rgba(255, 255, 255, 0.45)",l.lineWidth=1.8,l.setLineDash([4,4]),l.stroke()}l.restore()}drawFreebodyObject(t,i,s,e=!1,l){var V,M;const o=this.ctx,n=t.position.x*s,a=t.position.y*s,d=et.getAltitudeScale(t.position.z,l.wallHeight),h=(t.hasCollider?t.colliderRadius:((V=t.colliderModule)==null?void 0:V.radius)??.32)*s,m=h*d,b=!i.heldObject&&i.pickupModule!==null&&i.pickupModule.enabled&&!t.isHeld&&(((M=i.pickupModule)==null?void 0:M.isObjectInReach(i,t,l.wallHeight))??!1),v=et.isEntityOnLayer2(t,l.wallHeight);if(o.save(),o.globalAlpha=v?.55:1,t.visualShape==="box"){const g=m*2,p=Math.max(3,m*.16),w=n-m,x=a-m;o.beginPath(),o.roundRect?o.roundRect(w,x,g,g,p):o.rect(w,x,g,g),o.fillStyle=t.color,o.fill(),o.strokeStyle=b?"#ffffff":"rgba(255, 255, 255, 0.45)",o.lineWidth=b?2.5:2,o.stroke();const R=Math.max(3,m*.22);o.beginPath(),o.roundRect?o.roundRect(w+R,x+R,g-R*2,g-R*2,p*.7):o.rect(w+R,x+R,g-R*2,g-R*2),o.strokeStyle="rgba(0, 0, 0, 0.25)",o.lineWidth=1.6,o.stroke(),o.beginPath(),o.moveTo(w+R,x+R),o.lineTo(w+g-R,x+g-R),o.moveTo(w+g-R,x+R),o.lineTo(w+R,x+g-R),o.strokeStyle="rgba(0, 0, 0, 0.16)",o.lineWidth=1.4,o.stroke()}else o.beginPath(),o.arc(n,a,m,0,Math.PI*2),o.fillStyle=t.color,o.fill(),o.strokeStyle=b?"#ffffff":"rgba(255, 255, 255, 0.45)",o.lineWidth=b?2.5:2,o.stroke();if(this.drawRollIndicator(t,n,a,m),o.restore(),b){const g=h+2;if(o.save(),o.beginPath(),t.visualShape==="box"){const p=g*2,w=Math.max(3,g*.16);o.roundRect?o.roundRect(n-g,a-g,p,p,w):o.rect(n-g,a-g,p,p)}else o.arc(n,a,g,0,Math.PI*2);e?(o.strokeStyle="#38bdf8",o.lineWidth=2.8,o.setLineDash([]),o.stroke(),o.fillStyle="#38bdf8",o.font="bold 11px sans-serif",o.textAlign="center",o.fillText("GRAB",n,a-g-6)):(o.strokeStyle="rgba(56, 189, 248, 0.45)",o.lineWidth=1.8,o.setLineDash([4,4]),o.stroke()),o.restore()}}drawCharacter(t,i,s){const e=this.ctx,l=t.position.x*i,o=t.position.y*i,n=et.getAltitudeScale(t.position.z,s.wallHeight),a=t.colliderRadius*i*n,d=et.isEntityOnLayer2(t,s.wallHeight);e.save(),e.globalAlpha=d?.55:1,e.beginPath(),e.arc(l,o,a,0,Math.PI*2),e.fillStyle=t.color,e.fill(),e.strokeStyle="#ffffff",e.lineWidth=2.5,e.stroke(),this.drawRollIndicator(t,l,o,a);const c=.52,h=a*.72,m=Math.max(3.5,a*.18),f=t.facingAngle-c,b=t.facingAngle+c,v=l+Math.cos(f)*h,V=o+Math.sin(f)*h,M=l+Math.cos(b)*h,g=o+Math.sin(b)*h;e.fillStyle="#000000",e.beginPath(),e.arc(v,V,m,0,Math.PI*2),e.arc(M,g,m,0,Math.PI*2),e.fill(),t.heldObject&&(e.strokeStyle="rgba(255, 255, 255, 0.6)",e.setLineDash([3,3]),e.lineWidth=1.5,e.beginPath(),e.moveTo(l,o),e.lineTo(t.heldObject.position.x*i,t.heldObject.position.y*i),e.stroke(),e.setLineDash([])),e.restore()}drawRollIndicator(t,i,s,e){if(!t.rollModule||!t.rollModule.enabled)return;const l=t.rollModule,o=l.angularVelocity.x,n=l.angularVelocity.y,a=l.angularVelocity.z,d=Math.hypot(o,n,a);if(d<.02)return;const c=this.ctx,m=Math.hypot(o,n)<.05*d,f=!t.isHeld&&d>.02,b=2.5,v=5,V=4;if(c.save(),c.shadowColor="rgba(0, 0, 0, 0.75)",c.shadowBlur=3,m){const M=e*.5,g=e*.88,p=a!==0?Math.sign(a):1;c.beginPath(),c.arc(i,s,M,0,Math.PI*2),c.strokeStyle="rgba(255, 255, 255, 0.5)",c.lineWidth=1.8,c.setLineDash([]),c.stroke(),f&&this.drawFixedSpeedTriangles(c,i,s,g,g,0,p,e,!0),c.beginPath(),c.arc(i,s,g,0,Math.PI*2),c.strokeStyle="rgba(255, 255, 255, 0.98)",c.lineWidth=b,c.setLineDash([v,V]),c.lineDashOffset=-l.visualPhase*g*p,c.stroke()}else{const M=Math.atan2(-o,n),g=e*.9,p=Math.abs(a)/d,w=g*Math.max(.35,Math.pow(p,.65)),x=a!==0?Math.sign(a):1;f&&this.drawFixedSpeedTriangles(c,i,s,g,w,M,x,e,!1),c.save(),c.translate(i,s),c.rotate(M),c.beginPath(),c.ellipse(0,0,g,w,0,0,Math.PI),c.strokeStyle="rgba(255, 255, 255, 0.98)",c.lineWidth=b,c.setLineDash([v,V]),c.lineDashOffset=-l.visualPhase*g*x,c.stroke(),c.beginPath(),c.ellipse(0,0,g,w,0,Math.PI,Math.PI*2),c.strokeStyle="rgba(255, 255, 255, 0.35)",c.lineWidth=1.8,c.setLineDash([v,V]),c.lineDashOffset=-l.visualPhase*g*x,c.stroke(),c.restore()}c.restore()}drawRoundedTriangle(t,i,s,e,l,o,n,a){t.beginPath();const d=(e+i)*.5,c=(l+s)*.5;t.moveTo(d,c),t.arcTo(i,s,o,n,a),t.arcTo(o,n,e,l,a),t.arcTo(e,l,i,s,a),t.closePath(),t.fill()}drawFixedSpeedTriangles(t,i,s,e,l,o,n,a,d=!1){const h=performance.now()*.001*2.5%(Math.PI*2),m=a>24?3:2,f=Math.PI*2/m,b=Math.max(14,Math.min(22,a*.58)),v=Math.max(7,Math.min(12,a*.32)),V=1.2,M=Math.cos(o),g=Math.sin(o),p=n||1;t.save(),t.shadowColor="rgba(0, 0, 0, 0.75)",t.shadowBlur=3;for(let w=0;w<m;w++){const x=(w*f+p*h)%(Math.PI*2),R=e*Math.cos(x),z=l*Math.sin(x),O=i+R*M-z*g,B=s+R*g+z*M,A=-e*Math.sin(x)*p,F=l*Math.cos(x)*p,u=A*M-F*g,S=A*g+F*M,k=Math.hypot(u,S);if(k<1e-4)continue;const E=u/k,D=S/k,P=-D,W=E,T=Math.sin(x)>=0,L=d||T?.9:.32;t.fillStyle=`rgba(255, 255, 255, ${L})`;const $=O+E*(b*.55),C=B+D*(b*.55),q=O-E*(b*.45)+P*(v*.5),H=B-D*(b*.45)+W*(v*.5),j=O-E*(b*.45)-P*(v*.5),G=B-D*(b*.45)-W*(v*.5);this.drawRoundedTriangle(t,$,C,q,H,j,G,V)}t.restore()}drawTrajectory(t,i,s){const e=this.ctx,l=t.points;if(l.length<2)return;e.save(),e.shadowColor="rgba(0, 0, 0, 0.6)",e.shadowBlur=3;const o=.38,n=Math.max(2.2,.048*i),a=s.wallHeight-.05;let d=l[0].x,c=l[0].y,h=n,m=0,f=!0;for(let p=0;p<l.length-1;p++){const w=l[p],x=l[p+1],R=x.x-w.x,z=x.y-w.y,O=x.z-w.z,B=Math.hypot(R,z,O);if(B<=1e-4)continue;const A=Math.max(1,Math.ceil(B/.02)),F=R/A,u=z/A,S=O/A,k=B/A;for(let E=1;E<=A;E++){const D=w.x+F*E,P=w.y+u*E,W=w.z+S*E;m+=k;const T=Math.max(0,W)/Math.max(.1,s.wallHeight),L=n*(1+T*.75);if(f){if(m>=o*.5){const q=W>=a;e.fillStyle=q?"rgba(255, 255, 255, 0.38)":"rgba(255, 255, 255, 0.95)",e.beginPath(),e.arc(D*i,P*i,L,0,Math.PI*2),e.fill(),d=D,c=P,h=L,m=0,f=!1}continue}const $=Math.hypot(D-d,P-c)*i,C=Math.max(18,h+L+7);if(m>=o&&$>=C){const q=Math.hypot(D-t.landPoint.x,P-t.landPoint.y)*i,H=(t.colliderRadius??.35)*i;if(q>H*.8){const j=W>=a;e.fillStyle=j?"rgba(255, 255, 255, 0.38)":"rgba(255, 255, 255, 0.95)",e.beginPath(),e.arc(D*i,P*i,L,0,Math.PI*2),e.fill(),d=D,c=P,h=L,m=0}}}}e.shadowBlur=0;const b=l[l.length-1],v=(t.colliderRadius??.35)*i,V=t.landPoint.x*i,M=t.landPoint.y*i,g=(p,w)=>{if(e.beginPath(),t.visualShape==="box"){const x=v*2,R=Math.max(3,v*.16);e.roundRect?e.roundRect(p-v,w-v,x,x,R):e.rect(p-v,w-v,x,x)}else e.arc(p,w,v,0,Math.PI*2)};if(t.isBlockedByWall){const p=b.x*i,w=b.y*i;e.save(),e.strokeStyle="#ef4444",e.fillStyle="rgba(239, 68, 68, 0.25)",e.lineWidth=2.2,e.setLineDash([4,3]),g(p,w),e.fill(),e.stroke(),e.strokeStyle="#ef4444",e.lineWidth=2.5,e.setLineDash([]);const x=Math.min(8,v*.55);e.beginPath(),e.moveTo(p-x,w-x),e.lineTo(p+x,w+x),e.moveTo(p+x,w-x),e.lineTo(p-x,w+x),e.stroke(),e.restore()}else t.isLandingOnWallTop?(e.save(),e.strokeStyle="rgba(56, 189, 248, 0.85)",e.fillStyle="rgba(56, 189, 248, 0.25)",e.lineWidth=2.2,e.setLineDash([]),g(V,M),e.fill(),e.stroke(),e.beginPath(),e.arc(V,M,Math.min(4,v*.22),0,Math.PI*2),e.fillStyle="rgba(56, 189, 248, 0.95)",e.fill(),e.restore()):(e.save(),e.strokeStyle="#22c55e",e.fillStyle="rgba(34, 197, 94, 0.25)",e.lineWidth=2.2,e.setLineDash([]),g(V,M),e.fill(),e.stroke(),e.beginPath(),e.arc(V,M,Math.min(4,v*.22),0,Math.PI*2),e.fillStyle="#22c55e",e.fill(),e.restore());e.restore()}drawHoverGizmo(t,i){var a;const s=this.ctx,e=t.position.x*i,l=t.position.y*i,n=((t.hasCollider?t.colliderRadius:((a=t.colliderModule)==null?void 0:a.radius)??.32)+.08)*i;s.save(),s.strokeStyle="rgba(251, 191, 36, 0.6)",s.lineWidth=1.5,s.setLineDash([4,4]),s.beginPath(),s.arc(e,l,n,0,Math.PI*2),s.stroke(),s.restore()}drawSelectionGizmo(t,i,s){var m;const e=this.ctx,l=t.position.x*s,o=t.position.y*s,d=(t.hasCollider?t.colliderRadius:((m=t.colliderModule)==null?void 0:m.radius)??.32)*s+6,c=Math.max(6,d*.4),h=i?"#fbbf24":"#38bdf8";if(e.save(),e.strokeStyle=h,e.lineWidth=2,e.setLineDash([]),e.beginPath(),e.moveTo(l-d,o-d+c),e.lineTo(l-d,o-d),e.lineTo(l-d+c,o-d),e.stroke(),e.beginPath(),e.moveTo(l+d-c,o-d),e.lineTo(l+d,o-d),e.lineTo(l+d,o-d+c),e.stroke(),e.beginPath(),e.moveTo(l+d,o+d-c),e.lineTo(l+d,o+d),e.lineTo(l+d-c,o+d),e.stroke(),e.beginPath(),e.moveTo(l-d+c,o+d),e.lineTo(l-d,o+d),e.lineTo(l-d,o+d-c),e.stroke(),i){const f=`${t.name} (${t.mass.toFixed(1)}kg)`;e.font="bold 10px 'Segoe UI', system-ui, sans-serif";const v=e.measureText(f).width+12,V=16,M=l-v/2,g=o-d-V-4;e.fillStyle="rgba(15, 23, 42, 0.85)",e.strokeStyle=h,e.lineWidth=1,e.beginPath(),e.roundRect(M,g,v,V,4),e.fill(),e.stroke(),e.fillStyle=h,e.textAlign="center",e.textBaseline="middle",e.fillText(f,l,g+V/2)}e.restore()}}class At{constructor(t,i){r(this,"canvas");r(this,"arena");r(this,"keysPressed",new Set);r(this,"isEKeyDepressed",!1);r(this,"mousePos",{x:0,y:0});r(this,"isMouseDown",!1);r(this,"isRightMouseDown",!1);r(this,"hoverWallTile",null);r(this,"movementVector",{x:0,y:0});r(this,"justPickedUp",!1);r(this,"isThrowingPress",!1);r(this,"hoverEntity",null);r(this,"selectedCanvasEntity",null);r(this,"draggedEntity",null);r(this,"dragOffset",{x:0,y:0});r(this,"handleClick");r(this,"onMouseDown");r(this,"onRightMouseDown");r(this,"onMouseUp");r(this,"onRightClick");r(this,"onDropAttempt");r(this,"onMouseMove");this.canvas=t,this.arena=i,this.setupListeners()}get isGrabHeld(){return!this.isThrowingPress&&this.isMouseDown}get isClimbHeld(){return this.keysPressed.has("Space")}setupListeners(){window.addEventListener("keydown",t=>{if(this.keysPressed.add(t.code),this.updateMovementVector(),t.code==="KeyE"){if(t.repeat||this.isEKeyDepressed)return;this.isEKeyDepressed=!0,this.onDropAttempt&&this.onDropAttempt()}}),window.addEventListener("keyup",t=>{this.keysPressed.delete(t.code),this.updateMovementVector(),t.code==="KeyE"&&(this.isEKeyDepressed=!1)}),window.addEventListener("blur",()=>{this.isEKeyDepressed=!1,this.keysPressed.clear(),this.updateMovementVector()}),this.canvas.addEventListener("mousemove",t=>{this.updateMousePos(t),this.onMouseMove&&this.onMouseMove(this.mousePos.x,this.mousePos.y)}),this.canvas.addEventListener("mousedown",t=>{if(this.updateMousePos(t),t.button===2){this.isRightMouseDown=!0,this.onRightMouseDown&&this.onRightMouseDown(this.mousePos.x,this.mousePos.y);return}t.button===0&&(this.isMouseDown=!0,this.onMouseDown&&this.onMouseDown(this.mousePos.x,this.mousePos.y),this.handleClick&&this.handleClick(this.mousePos.x,this.mousePos.y))}),this.canvas.addEventListener("contextmenu",t=>{t.preventDefault(),this.updateMousePos(t),this.onRightClick&&this.onRightClick(this.mousePos.x,this.mousePos.y)}),window.addEventListener("mouseup",t=>{if(t.button===2){this.isRightMouseDown=!1;return}t.button===0&&(this.isMouseDown=!1,this.justPickedUp=!1,this.isThrowingPress=!1,this.onMouseUp&&this.onMouseUp(this.mousePos.x,this.mousePos.y))}),this.canvas.addEventListener("touchstart",t=>{t.touches.length>0&&(this.isMouseDown=!0,this.updateTouchPos(t.touches[0]),this.onMouseDown&&this.onMouseDown(this.mousePos.x,this.mousePos.y),this.handleClick&&this.handleClick(this.mousePos.x,this.mousePos.y))},{passive:!1}),this.canvas.addEventListener("touchmove",t=>{t.touches.length>0&&(this.updateTouchPos(t.touches[0]),this.onMouseMove&&this.onMouseMove(this.mousePos.x,this.mousePos.y))},{passive:!1}),window.addEventListener("touchend",()=>{this.isMouseDown=!1,this.justPickedUp=!1,this.isThrowingPress=!1,this.onMouseUp&&this.onMouseUp(this.mousePos.x,this.mousePos.y)})}updateMousePos(t){const i=this.canvas.getBoundingClientRect(),s=this.arena.width/i.width,e=this.arena.height/i.height;this.mousePos.x=(t.clientX-i.left)*s,this.mousePos.y=(t.clientY-i.top)*e}updateTouchPos(t){const i=this.canvas.getBoundingClientRect(),s=this.arena.width/i.width,e=this.arena.height/i.height;this.mousePos.x=(t.clientX-i.left)*s,this.mousePos.y=(t.clientY-i.top)*e}updateMovementVector(){let t=0,i=0;(this.keysPressed.has("KeyW")||this.keysPressed.has("ArrowUp"))&&(i-=1),(this.keysPressed.has("KeyS")||this.keysPressed.has("ArrowDown"))&&(i+=1),(this.keysPressed.has("KeyA")||this.keysPressed.has("ArrowLeft"))&&(t-=1),(this.keysPressed.has("KeyD")||this.keysPressed.has("ArrowRight"))&&(t+=1);const s=Math.hypot(t,i);s>0?(this.movementVector.x=t/s,this.movementVector.y=i/s):(this.movementVector.x=0,this.movementVector.y=0)}handleInteractions(t,i,s,e){e&&(this.selectedCanvasEntity=e.selectedEntity);const l=(a,d,c=.35)=>{var f;for(let b=s.length-1;b>=0;b--){const v=s[b],V=v.hasCollider?v.colliderRadius:((f=v.colliderModule)==null?void 0:f.radius)??.32;if(Math.hypot(v.position.x-a,v.position.y-d)<=V+c)return v}const h=t.hasCollider?t.colliderRadius:.44;return Math.hypot(t.position.x-a,t.position.y-d)<=h+c?t:null},o=(a,d)=>{if(a<0||a>=i.cols||d<0||d>=i.rows)return;if(i.setWallTile(a,d,!0)){const h=[t,...s];i.syncEntitiesWithWalls(h),i.currentPresetId="custom",e==null||e.updateWallPresetUI()}},n=(a,d)=>{if(!(a<0||a>=i.cols||d<0||d>=i.rows)&&i.tileGrid[d][a]===1){i.setWallTile(a,d,!1);const c=[t,...s];i.syncEntitiesWithWalls(c),i.currentPresetId="custom",e==null||e.updateWallPresetUI()}};this.onMouseDown=(a,d)=>{if(e!=null&&e.isEditMode){if(e.editTool==="walls"){const h=Math.floor(a/i.tileSize),m=Math.floor(d/i.tileSize);o(h,m);return}const c=l(a,d,.35);c?(this.selectedCanvasEntity=c,e.setSelectedEntity(c),this.draggedEntity=c,this.dragOffset.x=c.position.x-a,this.dragOffset.y=c.position.y-d,this.canvas.style.cursor="grabbing"):(this.selectedCanvasEntity=null,this.draggedEntity=null)}},this.onRightMouseDown=(a,d)=>{if(e!=null&&e.isEditMode&&e.editTool==="walls"){const c=Math.floor(a/i.tileSize),h=Math.floor(d/i.tileSize);n(c,h)}},this.onMouseMove=(a,d)=>{var m;const c=Math.floor(a/i.tileSize),h=Math.floor(d/i.tileSize);if(c>=0&&c<i.cols&&h>=0&&h<i.rows?this.hoverWallTile={col:c,row:h}:this.hoverWallTile=null,e!=null&&e.isEditMode){if(e.editTool==="walls"){this.hoverEntity=null,this.draggedEntity=null,this.canvas.style.cursor="cell",this.isMouseDown&&this.hoverWallTile?o(this.hoverWallTile.col,this.hoverWallTile.row):this.isRightMouseDown&&this.hoverWallTile&&n(this.hoverWallTile.col,this.hoverWallTile.row);return}if(this.isMouseDown&&this.draggedEntity){const f=a+this.dragOffset.x,b=d+this.dragOffset.y,v=this.draggedEntity.hasCollider?this.draggedEntity.colliderRadius:((m=this.draggedEntity.colliderModule)==null?void 0:m.radius)??.32;this.draggedEntity.position.x=Math.max(v,Math.min(i.width-v,f)),this.draggedEntity.position.y=Math.max(v,Math.min(i.height-v,b)),this.draggedEntity.velocity.x=0,this.draggedEntity.velocity.y=0,this.draggedEntity.verticalVelocity=0,this.draggedEntity.rollModule&&(this.draggedEntity.rollModule.angularVelocity.x=0,this.draggedEntity.rollModule.angularVelocity.y=0,this.draggedEntity.rollModule.angularVelocity.z=0),this.canvas.style.cursor="grabbing"}else{const f=l(a,d,.3);this.hoverEntity=f,this.canvas.style.cursor=f?"grab":"crosshair"}}else this.hoverEntity=null,this.draggedEntity=null,this.canvas.style.cursor="default"},this.onMouseUp=(a,d)=>{if(this.draggedEntity&&(i.syncEntitiesWithWalls([this.draggedEntity]),this.draggedEntity=null),e!=null&&e.isEditMode)if(e.editTool==="walls")this.canvas.style.cursor="cell";else{const c=l(this.mousePos.x,this.mousePos.y,.3);this.hoverEntity=c,this.canvas.style.cursor=c?"grab":"crosshair"}},this.handleClick=(a,d)=>{if(!(e!=null&&e.isEditMode)){if(t.heldObject&&t.throwModule&&!this.justPickedUp){t.throwModule.throwHeldObject(t,a,d,i),this.isThrowingPress=!0;return}if(!t.heldObject&&t.pickupModule){const c=t.pickupModule.findTargetObject(t,a,d,s,i.wallHeight);c&&(t.pickupModule.pickup(t,c),this.justPickedUp=!0)}}},this.onRightClick=(a,d)=>{if(e!=null&&e.isEditMode&&e.editTool==="walls"||!e)return;const c=l(a,d,.4);c&&(this.selectedCanvasEntity=c,e.setSelectedEntity(c))},this.onDropAttempt=()=>{if(t.heldObject&&t.pickupModule)t.pickupModule.drop(t);else if(!t.heldObject&&t.pickupModule){const a=t.pickupModule.findTargetObject(t,this.mousePos.x,this.mousePos.y,s,i.wallHeight);a&&t.pickupModule.pickup(t,a)}}}}class Lt{constructor(t){r(this,"container");r(this,"character");r(this,"arena");r(this,"objects");r(this,"onSpawnObject");r(this,"onDeleteObject");r(this,"onClearObjects");r(this,"selectedEntity");r(this,"isEditMode",!1);r(this,"editTool","entities");r(this,"onSelectionChange");r(this,"creatorState",{name:"Custom Box",visualShape:"box",color:"#38bdf8",hasCollider:!0,colliderRadius:.3,hasMass:!0,mass:1,hasFriction:!0,staticFrictionMod:1,dynamicFrictionMod:1,hasBounce:!0,bounceMod:.2,verticalBounce:!0,hasVerticalPosition:!0,elevation:.1,hasVerticalVelocity:!0,hasGravity:!0,hasRollModule:!1,rollResistance:.4});r(this,"presets",{"Light Blue Box":{name:"Light Blue Box",visualShape:"box",color:"#38bdf8",hasCollider:!0,colliderRadius:.26,hasMass:!0,mass:.7,hasFriction:!0,staticFrictionMod:1,dynamicFrictionMod:1,hasBounce:!0,bounceMod:.25,verticalBounce:!0,hasVerticalPosition:!0,elevation:.1,hasVerticalVelocity:!0,hasGravity:!0,hasRollModule:!1,rollResistance:.4},"Heavy Red Box":{name:"Heavy Red Box",visualShape:"box",color:"#f87171",hasCollider:!0,colliderRadius:.4,hasMass:!0,mass:2.6,hasFriction:!0,staticFrictionMod:1.2,dynamicFrictionMod:1.2,hasBounce:!1,bounceMod:.05,verticalBounce:!1,hasVerticalPosition:!0,elevation:.1,hasVerticalVelocity:!0,hasGravity:!0,hasRollModule:!1,rollResistance:.4},"Bouncy Ball":{name:"Super Bouncy Ball",visualShape:"circle",color:"#4ade80",hasCollider:!0,colliderRadius:.24,hasMass:!0,mass:.5,hasFriction:!0,staticFrictionMod:.8,dynamicFrictionMod:.8,hasBounce:!0,bounceMod:.88,verticalBounce:!0,hasVerticalPosition:!0,elevation:.6,hasVerticalVelocity:!0,hasGravity:!0,hasRollModule:!1,rollResistance:.4},"Rolling Ball":{name:"Rolling Ball",visualShape:"circle",color:"#a855f7",hasCollider:!0,colliderRadius:.28,hasMass:!0,mass:.6,hasFriction:!0,staticFrictionMod:.5,dynamicFrictionMod:.5,hasBounce:!0,bounceMod:.95,verticalBounce:!0,hasVerticalPosition:!0,elevation:.1,hasVerticalVelocity:!0,hasGravity:!0,hasRollModule:!0,rollResistance:0},"Ghost Box":{name:"Ghost Box (No Collider)",visualShape:"box",color:"#94a3b8",hasCollider:!1,colliderRadius:.3,hasMass:!1,mass:0,hasFriction:!1,staticFrictionMod:0,dynamicFrictionMod:0,hasBounce:!1,bounceMod:0,verticalBounce:!1,hasVerticalPosition:!1,elevation:0,hasVerticalVelocity:!1,hasGravity:!1,hasRollModule:!1,rollResistance:0}});r(this,"inspectorEl");r(this,"entitySelectorEl");r(this,"characterSpecificControlsEl");r(this,"objectSpecificControlsEl");r(this,"modePlayBtn");r(this,"modeEditBtn");this.container=t.container,this.character=t.character,this.arena=t.arena,this.objects=t.objects,this.onSpawnObject=t.onSpawnObject,this.onDeleteObject=t.onDeleteObject,this.onClearObjects=t.onClearObjects,this.selectedEntity=this.character,this.renderPanel()}setSelectedEntity(t){var i;this.selectedEntity=t,this.updateSelectorOptions(),this.syncEntitySliders(),(i=this.onSelectionChange)==null||i.call(this,t)}setMode(t){this.isEditMode=t,this.modePlayBtn&&this.modeEditBtn&&(this.isEditMode?(this.modePlayBtn.classList.remove("active-play"),this.modeEditBtn.classList.add("active-edit")):(this.modePlayBtn.classList.add("active-play"),this.modeEditBtn.classList.remove("active-edit")));const i=this.container.querySelector("#edit-submode-container");i&&(i.style.display=this.isEditMode?"flex":"none"),this.updateToolVisibility()}setEditTool(t){this.editTool=t;const i=this.container.querySelector("#submode-entities"),s=this.container.querySelector("#submode-walls");i&&s&&(i.classList.toggle("active",t==="entities"),s.classList.toggle("active",t==="walls")),this.updateToolVisibility()}updateToolVisibility(){const t=this.container.querySelector("#wall-editor-section");t&&(t.style.display=this.isEditMode&&this.editTool==="walls"?"block":"none");const i=this.container.querySelector("#edit-hint-label");i&&(this.isEditMode?this.editTool==="walls"?i.textContent="Left-drag: Draw | Right-drag: Erase":i.textContent="Click & drag object in arena":i.textContent="Right-click in arena to select")}updateSelectorOptions(){if(!this.entitySelectorEl)return;const t=this.selectedEntity.id;let i=`<option value="${this.character.id}" ${t===this.character.id?"selected":""}>⭐ Player Character (${this.character.mass.toFixed(1)}kg)</option>`;for(const e of this.objects){const l=e.id===t?"selected":"",o=e.visualShape==="box"?"📦":"⚪",n=e.hasMass?`${e.mass.toFixed(1)}kg`:"Massless";i+=`<option value="${e.id}" ${l}>${o} ${e.name} (${n})</option>`}this.entitySelectorEl.innerHTML=i;const s=this.selectedEntity===this.character;this.characterSpecificControlsEl&&(this.characterSpecificControlsEl.style.display=s?"flex":"none"),this.objectSpecificControlsEl&&(this.objectSpecificControlsEl.style.display=s?"none":"flex")}renderPanel(){var t,i,s,e,l,o,n,a,d,c,h,m,f,b,v,V,M,g,p,w,x,R,z,O,B,A,F,u,S,k,E,D,P,W,T,L,$,C,q,H,j,G,y,X,Y,U,Z,N,gt,st,lt,pt,ot,at,vt,nt,ct,ft,rt,tt,K,_,J,kt,Et,Vt,Ct;this.container.innerHTML=`
        ...
        <div class="dev-section">
          ...
          <div class="module-card" id="card-mod-bounce">
            ...
            <div id="group-mod-bounce" style="display: ${(M=this.selectedEntity.bounceModule)!=null&&M.enabled?"block":"none"};">
              <div class="slider-group">
                ...
                <input type="range" id="slide-entity-bounce" min="0.05" max="1.0" step="0.05" value="${((p=this.selectedEntity.bounceModule)==null?void 0:p.bounceMod)??.4}">
              </div>
              ...
              <div id="warn-bounce-vert-vel" class="module-dep-warning" style="display: ${(x=this.selectedEntity.bounceModule)!=null&&x.enabled&&((R=this.selectedEntity.bounceModule)!=null&&R.verticalBounce)&&!this.selectedEntity.hasVerticalVelocity?"block":"none"};">
          ...
          <div id="character-specific-controls" style="display: ${this.selectedEntity===this.character?"flex":"none"}; flex-direction: column; gap: 10px;">
              ...
              <div id="group-mod-walking" style="display: ${(W=this.character.walkingModule)!=null&&W.enabled?"flex":"none"}; flex-direction: column; gap: 8px;">
                ...
                <div class="slider-group">
                  <div class="slider-label">
                    ...
                    <span id="val-walk-speed">${((($=this.character.walkingModule)==null?void 0:$.maxWalkSpeed)??5.2).toFixed(1)}</span>
                  </div>
            ...
            <div class="module-card">
              ...
              <div id="group-mod-strength" style="display: ${(j=this.character.strengthModule)!=null&&j.enabled?"block":"none"};">
                <div class="slider-group">
                  <div class="slider-label">
    ...
    `,this.inspectorEl=this.container.querySelector("#dev-inspector"),this.entitySelectorEl=this.container.querySelector("#entity-selector"),this.characterSpecificControlsEl=this.container.querySelector("#character-specific-controls"),this.objectSpecificControlsEl=this.container.querySelector("#object-actions-row"),this.modePlayBtn=this.container.querySelector("#mode-play"),this.modeEditBtn=this.container.querySelector("#mode-edit"),this.updateSelectorOptions(),this.bindEvents()}syncEntitySliders(){var L,$,C,q,H,j,G;const t=this.selectedEntity,i=t===this.character,s=this.container.querySelector("#row-visual-shape");s&&(s.style.display=i?"none":"flex");const e=this.container.querySelector("#toggle-entity-shape");e&&(t.visualShape==="box"?(e.textContent="Box 📦",e.classList.add("active")):(e.textContent="Circle ⚪",e.classList.remove("active")));const l=this.container.querySelector("#toggle-mod-collider"),o=this.container.querySelector("#group-mod-collider"),n=this.container.querySelector("#note-mod-collider");l&&(l.textContent=t.hasCollider?"Attached":"Detached",l.classList.toggle("active",t.hasCollider)),o&&(o.style.display=t.hasCollider?"block":"none"),n&&(n.style.display=t.hasCollider?"none":"block"),this.setSliderVal("slide-entity-radius","val-entity-radius",((L=t.colliderModule)==null?void 0:L.radius)??.32,2);const a=this.container.querySelector("#toggle-mod-mass"),d=this.container.querySelector("#group-mod-mass"),c=this.container.querySelector("#note-mod-mass");a&&(a.textContent=t.hasMass?"Attached":"Detached",a.classList.toggle("active",t.hasMass)),d&&(d.style.display=t.hasMass?"block":"none"),c&&(c.style.display=t.hasMass?"none":"block"),this.setSliderVal("slide-entity-mass","val-entity-mass",(($=t.massModule)==null?void 0:$.mass)??1,1);const h=this.container.querySelector("#toggle-mod-friction"),m=this.container.querySelector("#group-mod-friction"),f=this.container.querySelector("#note-mod-friction"),b=this.container.querySelector("#warn-friction-mass"),v=!!(t.frictionModule&&t.frictionModule.enabled);h&&(h.textContent=v?"Attached":"Detached",h.classList.toggle("active",v)),m&&(m.style.display=v?"flex":"none"),f&&(f.style.display=v?"none":"block"),b&&(b.style.display=!t.hasMass&&v?"block":"none"),this.setSliderVal("slide-entity-static-fric","val-entity-static-fric",((C=t.frictionModule)==null?void 0:C.staticFrictionMod)??1,2),this.setSliderVal("slide-entity-dynamic-fric","val-entity-dynamic-fric",((q=t.frictionModule)==null?void 0:q.dynamicFrictionMod)??1,2);const V=this.container.querySelector("#toggle-mod-bounce"),M=this.container.querySelector("#group-mod-bounce"),g=this.container.querySelector("#note-mod-bounce"),p=this.container.querySelector("#warn-bounce-mass"),w=!!(t.bounceModule&&t.bounceModule.enabled);V&&(V.textContent=w?"Attached":"Detached",V.classList.toggle("active",w)),M&&(M.style.display=w?"block":"none"),g&&(g.style.display=w?"none":"block"),p&&(p.style.display=!t.hasMass&&w?"block":"none"),this.setSliderVal("slide-entity-bounce","val-entity-bounce",((H=t.bounceModule)==null?void 0:H.bounceMod)??.4,2);const x=this.container.querySelector("#check-mod-vert-bounce"),R=this.container.querySelector("#warn-bounce-vert-vel");if(x&&(x.checked=!!((j=t.bounceModule)!=null&&j.verticalBounce)),R){const y=!!(w&&((G=t.bounceModule)!=null&&G.verticalBounce)&&!t.hasVerticalVelocity);R.style.display=y?"block":"none"}const z=this.container.querySelector("#toggle-mod-vert-pos"),O=this.container.querySelector("#group-mod-vert-pos"),B=this.container.querySelector("#note-mod-vert-pos"),A=t.hasVerticalPosition;z&&(z.textContent=A?"Attached":"Detached",z.classList.toggle("active",A)),O&&(O.style.display=A?"block":"none"),B&&(B.style.display=A?"none":"block"),this.setSliderVal("slide-entity-elevation","val-entity-elevation",t.position.z,2);const F=this.container.querySelector("#toggle-mod-vert-vel"),u=this.container.querySelector("#group-mod-vert-vel"),S=t.hasVerticalVelocity;F&&(F.textContent=S?"Enabled":"Disabled",F.classList.toggle("active",S)),u&&(u.style.display=S?"block":"none"),this.setSliderVal("slide-entity-vert-vel","val-entity-vert-vel",t.verticalVelocity,2);const k=this.container.querySelector("#toggle-mod-gravity"),E=this.container.querySelector("#note-mod-gravity");k&&(k.textContent=t.hasGravity?"Attached":"Detached",k.classList.toggle("active",t.hasGravity)),E&&(E.textContent=t.hasGravity?"Subject to static world gravity acceleration":"Zero-G: never falls, flies horizontally in a straight line");const D=this.container.querySelector("#toggle-mod-roll"),P=this.container.querySelector("#group-mod-roll"),W=this.container.querySelector("#note-roll-friction"),T=!!(t.rollModule&&t.rollModule.enabled);if(D&&(D.textContent=T?"Attached":"Detached",D.classList.toggle("active",T)),P&&(P.style.display=T?"block":"none"),W&&(W.style.display=T&&!t.hasFriction?"block":"none"),t.rollModule&&this.setSliderVal("slide-entity-roll-resist","val-entity-roll-resist",t.rollModule.rollResistance,2),i){const y=this.container.querySelector("#toggle-walk"),X=this.container.querySelector("#group-mod-walking"),Y=this.container.querySelector("#warn-walk-friction"),U=this.container.querySelector("#warn-walk-strength"),Z=!!(this.character.walkingModule&&this.character.walkingModule.enabled);y&&(y.textContent=Z?"Attached":"Detached",y.classList.toggle("active",Z)),X&&(X.style.display=Z?"flex":"none"),Y&&(Y.style.display=Z&&!this.character.hasFriction?"block":"none"),U&&(U.style.display=Z&&!this.character.hasStrength?"block":"none"),this.character.walkingModule&&(this.setSliderVal("slide-walk-force","val-walk-force",this.character.walkingModule.maxWalkForce,0),this.setSliderVal("slide-walk-speed","val-walk-speed",this.character.walkingModule.maxWalkSpeed,1));const N=this.container.querySelector("#toggle-strength"),gt=this.container.querySelector("#group-mod-strength"),st=!!(this.character.strengthModule&&this.character.strengthModule.enabled);N&&(N.textContent=st?"Attached":"Detached",N.classList.toggle("active",st)),gt&&(gt.style.display=st?"block":"none"),this.character.strengthModule&&this.setSliderVal("slide-strength","val-strength",this.character.strength,1);const lt=this.container.querySelector("#toggle-pickup"),pt=this.container.querySelector("#group-mod-pickup"),ot=!!(this.character.pickupModule&&this.character.pickupModule.enabled);lt&&(lt.textContent=ot?"Attached":"Detached",lt.classList.toggle("active",ot)),pt&&(pt.style.display=ot?"block":"none"),this.character.pickupModule&&(this.setSliderVal("slide-pickup-reach","val-pickup-reach",this.character.pickupModule.pickupReach,1),this.setSliderVal("slide-pickup-cross-layer","val-pickup-cross-layer",this.character.pickupModule.crossLayerReachRatio,2));const at=this.container.querySelector("#toggle-throw"),vt=this.container.querySelector("#group-mod-throw"),nt=!!(this.character.throwModule&&this.character.throwModule.enabled);at&&(at.textContent=nt?"Attached":"Detached",at.classList.toggle("active",nt)),vt&&(vt.style.display=nt?"block":"none"),this.character.throwModule&&this.setSliderVal("slide-throw-force","val-throw-force",this.character.throwModule.baseThrowForce,1);const ct=this.container.querySelector("#toggle-climb"),ft=this.container.querySelector("#group-mod-climb"),rt=this.container.querySelector("#warn-climb-deps"),tt=!!(this.character.climbingModule&&this.character.climbingModule.enabled);if(ct&&(ct.textContent=tt?"Attached":"Detached",ct.classList.toggle("active",tt)),ft&&(ft.style.display=tt?"block":"none"),rt){const K=!this.character.hasVerticalPosition,_=!this.character.hasStrength;rt.style.display=tt&&(K||_)?"block":"none",rt.textContent=K?"⚠️ Requires Vertical Position (3D Z-axis)":_?"⚠️ Requires Strength Ability to climb":""}if(this.character.climbingModule){const K=this.container.querySelector("#toggle-climb-walkoff");if(K){const J=!!this.character.climbingModule.preventWalkOff;K.textContent=J?"Active":"Inactive",K.classList.toggle("active",J)}const _=this.container.querySelector("#toggle-climb-sideways");if(_){const J=!!this.character.climbingModule.horizontalClimb;_.textContent=J?"Active":"Inactive",_.classList.toggle("active",J)}this.setSliderVal("slide-climb-adhesion","val-climb-adhesion",this.character.climbingModule.maxAdhesion,0),this.setSliderVal("slide-climb-speed","val-climb-speed",this.character.climbingModule.maxClimbSpeed,1),this.setSliderVal("slide-climb-hang","val-climb-hang",this.character.climbingModule.hangDistance,2)}}}setSliderVal(t,i,s,e){const l=this.container.querySelector(`#${t}`),o=this.container.querySelector(`#${i}`);l&&(l.value=s.toString()),o&&(o.textContent=e>0?s.toFixed(e):Math.round(s).toString())}syncCreatorInputs(){const t=this.creatorState,i=this.container.querySelector("#creator-name");i&&(i.value=t.name);const s=this.container.querySelector("#creator-toggle-shape");s&&(s.textContent=t.visualShape==="box"?"Box 📦":"Circle ⚪",s.classList.toggle("active",t.visualShape==="box"));const e=this.container.querySelector("#creator-color"),l=this.container.querySelector("#val-creator-color");e&&(e.value=t.color),l&&(l.textContent=t.color);const o=this.container.querySelector("#creator-toggle-collider"),n=this.container.querySelector("#grp-creator-radius");o&&(o.textContent=t.hasCollider?"Attached":"Detached",o.classList.toggle("active",t.hasCollider)),n&&(n.style.display=t.hasCollider?"block":"none"),this.setSliderVal("slide-creator-radius","val-creator-radius",t.colliderRadius,2);const a=this.container.querySelector("#creator-toggle-mass"),d=this.container.querySelector("#grp-creator-mass");a&&(a.textContent=t.hasMass?"Attached":"Detached",a.classList.toggle("active",t.hasMass)),d&&(d.style.display=t.hasMass?"block":"none"),this.setSliderVal("slide-creator-mass","val-creator-mass",t.mass,1);const c=this.container.querySelector("#creator-toggle-friction"),h=this.container.querySelector("#grp-creator-fric");c&&(c.textContent=t.hasFriction?"Attached":"Detached",c.classList.toggle("active",t.hasFriction)),h&&(h.style.display=t.hasFriction?"block":"none"),this.setSliderVal("slide-creator-fric","val-creator-fric",t.dynamicFrictionMod,2);const m=this.container.querySelector("#creator-toggle-bounce"),f=this.container.querySelector("#grp-creator-bounce"),b=this.container.querySelector("#creator-check-vert-bounce"),v=this.container.querySelector("#creator-warn-bounce-vert");m&&(m.textContent=t.hasBounce?"Attached":"Detached",m.classList.toggle("active",t.hasBounce)),f&&(f.style.display=t.hasBounce?"block":"none"),b&&(b.checked=t.verticalBounce),v&&(v.style.display=t.hasBounce&&t.verticalBounce&&(!t.hasVerticalPosition||!t.hasVerticalVelocity)?"block":"none"),this.setSliderVal("slide-creator-bounce","val-creator-bounce",t.bounceMod,2);const V=this.container.querySelector("#creator-toggle-vert-pos"),M=this.container.querySelector("#grp-creator-vert-pos");V&&(V.textContent=t.hasVerticalPosition?"Attached":"Detached",V.classList.toggle("active",t.hasVerticalPosition)),M&&(M.style.display=t.hasVerticalPosition?"block":"none"),this.setSliderVal("slide-creator-elevation","val-creator-elevation",t.elevation,2);const g=this.container.querySelector("#creator-toggle-vert-vel");g&&(g.textContent=t.hasVerticalVelocity?"Enabled":"Disabled",g.classList.toggle("active",t.hasVerticalVelocity));const p=this.container.querySelector("#creator-toggle-gravity");p&&(p.textContent=t.hasGravity?"Attached":"Detached",p.classList.toggle("active",t.hasGravity));const w=this.container.querySelector("#creator-toggle-roll"),x=this.container.querySelector("#group-creator-roll-resist");w&&(w.textContent=t.hasRollModule?"Enabled":"Disabled",w.classList.toggle("active",t.hasRollModule)),x&&(x.style.display=t.hasRollModule?"block":"none"),this.setSliderVal("slide-creator-roll-resist","val-creator-roll-resist",t.rollResistance,2)}bindEvents(){var P,W,T,L,$,C,q,H,j,G;this.modePlayBtn.addEventListener("click",()=>{this.setMode(!1)}),this.modeEditBtn.addEventListener("click",()=>{this.setMode(!0)}),(P=this.container.querySelector("#submode-entities"))==null||P.addEventListener("click",()=>{this.setEditTool("entities")}),(W=this.container.querySelector("#submode-walls"))==null||W.addEventListener("click",()=>{this.setEditTool("walls")}),this.entitySelectorEl.addEventListener("change",()=>{var X;const y=this.entitySelectorEl.value;if(y===this.character.id)this.selectedEntity=this.character;else{const Y=this.objects.find(U=>U.id===y);Y&&(this.selectedEntity=Y)}this.updateSelectorOptions(),this.syncEntitySliders(),(X=this.onSelectionChange)==null||X.call(this,this.selectedEntity)}),(T=this.container.querySelector("#btn-duplicate-entity"))==null||T.addEventListener("click",()=>{this.duplicateSelectedEntity()}),(L=this.container.querySelector("#btn-delete-entity"))==null||L.addEventListener("click",()=>{this.deleteSelectedEntity()});const t=this.container.querySelector("#toggle-entity-shape");t==null||t.addEventListener("click",()=>{this.selectedEntity.visualShape=this.selectedEntity.visualShape==="box"?"circle":"box",t.textContent=this.selectedEntity.visualShape==="box"?"Box 📦":"Circle ⚪",t.classList.toggle("active",this.selectedEntity.visualShape==="box"),this.updateSelectorOptions()});const i=this.container.querySelector("#toggle-mod-collider");i==null||i.addEventListener("click",()=>{this.selectedEntity.colliderModule?this.selectedEntity.colliderModule.enabled=!this.selectedEntity.colliderModule.enabled:this.selectedEntity.colliderModule=new dt({radius:.32}),this.syncEntitySliders()}),this.setupSlider("slide-entity-radius","val-entity-radius",y=>{this.selectedEntity.colliderRadius=y},2);const s=this.container.querySelector("#toggle-mod-mass");s==null||s.addEventListener("click",()=>{this.selectedEntity.massModule?this.selectedEntity.massModule.enabled=!this.selectedEntity.massModule.enabled:this.selectedEntity.massModule=new ht({mass:1}),this.syncEntitySliders(),this.updateSelectorOptions()}),this.setupSlider("slide-entity-mass","val-entity-mass",y=>{this.selectedEntity.mass=y,this.updateSelectorOptions()},1);const e=this.container.querySelector("#toggle-mod-friction");e==null||e.addEventListener("click",()=>{this.selectedEntity.frictionModule?this.selectedEntity.frictionModule.enabled=!this.selectedEntity.frictionModule.enabled:this.selectedEntity.frictionModule=new ut,this.syncEntitySliders()}),this.setupSlider("slide-entity-static-fric","val-entity-static-fric",y=>{this.selectedEntity.staticGroundFrictionMod=y},2),this.setupSlider("slide-entity-dynamic-fric","val-entity-dynamic-fric",y=>{this.selectedEntity.dynamicGroundFrictionMod=y},2);const l=this.container.querySelector("#toggle-mod-bounce");l==null||l.addEventListener("click",()=>{this.selectedEntity.bounceModule?this.selectedEntity.bounceModule.enabled=!this.selectedEntity.bounceModule.enabled:this.selectedEntity.bounceModule=new yt({bounceMod:.4}),this.syncEntitySliders()}),this.setupSlider("slide-entity-bounce","val-entity-bounce",y=>{this.selectedEntity.bounceMod=y},2);const o=this.container.querySelector("#check-mod-vert-bounce");o==null||o.addEventListener("change",()=>{this.selectedEntity.bounceModule&&(this.selectedEntity.bounceModule.verticalBounce=o.checked),this.syncEntitySliders(),this.updateInspector()});const n=this.container.querySelector("#toggle-mod-vert-pos");n==null||n.addEventListener("click",()=>{this.selectedEntity.verticalPositionModule?(this.selectedEntity.verticalPositionModule.enabled=!this.selectedEntity.verticalPositionModule.enabled,this.selectedEntity.verticalPositionModule.enabled||(this.selectedEntity.position.z=0,this.selectedEntity.verticalVelocity=0)):this.selectedEntity.verticalPositionModule=new bt({z:this.selectedEntity.position.z,hasVerticalVelocity:!0,verticalVelocity:0,enabled:!0}),this.syncEntitySliders(),this.updateInspector()}),this.setupSlider("slide-entity-elevation","val-entity-elevation",y=>{this.selectedEntity.verticalPositionModule&&(this.selectedEntity.verticalPositionModule.z=y),this.selectedEntity.position.z=y,this.syncEntitySliders(),this.updateInspector()},2);const a=this.container.querySelector("#toggle-mod-vert-vel");a==null||a.addEventListener("click",()=>{this.selectedEntity.verticalPositionModule&&(this.selectedEntity.verticalPositionModule.hasVerticalVelocity=!this.selectedEntity.verticalPositionModule.hasVerticalVelocity,this.selectedEntity.verticalPositionModule.hasVerticalVelocity||(this.selectedEntity.verticalVelocity=0)),this.syncEntitySliders(),this.updateInspector()}),this.setupSlider("slide-entity-vert-vel","val-entity-vert-vel",y=>{this.selectedEntity.verticalVelocity=y},2);const d=this.container.querySelector("#toggle-mod-gravity");d==null||d.addEventListener("click",()=>{this.selectedEntity.gravityModule?this.selectedEntity.gravityModule.enabled=!this.selectedEntity.gravityModule.enabled:this.selectedEntity.gravityModule=new mt,this.syncEntitySliders()});const c=this.container.querySelector("#toggle-mod-roll");c==null||c.addEventListener("click",()=>{this.selectedEntity.rollModule?this.selectedEntity.rollModule.enabled=!this.selectedEntity.rollModule.enabled:this.selectedEntity.rollModule=new Mt({rollResistance:.4}),this.syncEntitySliders()}),this.setupSlider("slide-entity-roll-resist","val-entity-roll-resist",y=>{this.selectedEntity.rollModule&&(this.selectedEntity.rollModule.rollResistance=y)},2);const h=this.container.querySelector("#toggle-walk");h==null||h.addEventListener("click",()=>{this.character.walkingModule?this.character.walkingModule.enabled=!this.character.walkingModule.enabled:this.character.walkingModule=new Rt,this.syncEntitySliders()}),this.setupSlider("slide-walk-force","val-walk-force",y=>{this.character.walkingModule&&(this.character.walkingModule.maxWalkForce=y)},0),this.setupSlider("slide-walk-speed","val-walk-speed",y=>{this.character.walkingModule&&(this.character.walkingModule.maxWalkSpeed=y)},1);const m=this.container.querySelector("#toggle-strength");m==null||m.addEventListener("click",()=>{this.character.strengthModule?this.character.strengthModule.enabled=!this.character.strengthModule.enabled:this.character.strengthModule=new wt({strength:1}),this.syncEntitySliders()}),this.setupSlider("slide-strength","val-strength",y=>{this.character.strength=y},1);const f=this.container.querySelector("#toggle-pickup");f==null||f.addEventListener("click",()=>{this.character.pickupModule?this.character.pickupModule.enabled=!this.character.pickupModule.enabled:this.character.pickupModule=new Wt,this.syncEntitySliders()}),this.setupSlider("slide-pickup-reach","val-pickup-reach",y=>{this.character.pickupModule&&(this.character.pickupModule.pickupReach=y)},1),this.setupSlider("slide-pickup-cross-layer","val-pickup-cross-layer",y=>{this.character.pickupModule&&(this.character.pickupModule.crossLayerReachRatio=y)},2);const b=this.container.querySelector("#toggle-throw");b==null||b.addEventListener("click",()=>{this.character.throwModule?this.character.throwModule.enabled=!this.character.throwModule.enabled:this.character.throwModule=new Pt,this.syncEntitySliders()}),this.setupSlider("slide-throw-force","val-throw-force",y=>{this.character.throwModule&&(this.character.throwModule.baseThrowForce=y)},1);const v=this.container.querySelector("#toggle-climb");v==null||v.addEventListener("click",()=>{this.character.climbingModule?this.character.climbingModule.enabled=!this.character.climbingModule.enabled:this.character.climbingModule=new Ft,this.syncEntitySliders()});const V=this.container.querySelector("#toggle-climb-walkoff");V==null||V.addEventListener("click",()=>{this.character.climbingModule&&(this.character.climbingModule.preventWalkOff=!this.character.climbingModule.preventWalkOff),this.syncEntitySliders()});const M=this.container.querySelector("#toggle-climb-sideways");M==null||M.addEventListener("click",()=>{this.character.climbingModule&&(this.character.climbingModule.horizontalClimb=!this.character.climbingModule.horizontalClimb),this.syncEntitySliders()}),this.setupSlider("slide-climb-adhesion","val-climb-adhesion",y=>{this.character.climbingModule&&(this.character.climbingModule.maxAdhesion=y)},0),this.setupSlider("slide-climb-speed","val-climb-speed",y=>{this.character.climbingModule&&(this.character.climbingModule.maxClimbSpeed=y)},1),this.setupSlider("slide-climb-hang","val-climb-hang",y=>{this.character.climbingModule&&(this.character.climbingModule.hangDistance=y)},2),this.setupSlider("slide-gravity","val-gravity",y=>{this.arena.gravity=y},1),this.setupSlider("slide-wall-height","val-wall-height",y=>{this.arena.setStandardWallHeight(y),this.setSliderVal("slide-editor-wall-height","val-editor-wall-height",y,1)},1),this.setupSlider("slide-editor-wall-height","val-editor-wall-height",y=>{this.arena.setStandardWallHeight(y),this.setSliderVal("slide-wall-height","val-wall-height",y,1)},1);const g=this.container.querySelector("#select-wall-preset");g==null||g.addEventListener("change",()=>{this.arena.loadWallPreset(g.value,[this.character,...this.objects]),this.updateWallPresetUI()}),($=this.container.querySelector("#btn-prev-wall-map"))==null||$.addEventListener("click",()=>{const y=Q.WALL_PRESETS,Y=(y.findIndex(U=>U.id===this.arena.currentPresetId)-1+y.length)%y.length;this.arena.loadWallPreset(y[Y].id,[this.character,...this.objects]),this.updateWallPresetUI()}),(C=this.container.querySelector("#btn-next-wall-map"))==null||C.addEventListener("click",()=>{const y=Q.WALL_PRESETS,Y=(y.findIndex(U=>U.id===this.arena.currentPresetId)+1)%y.length;this.arena.loadWallPreset(y[Y].id,[this.character,...this.objects]),this.updateWallPresetUI()}),(q=this.container.querySelector("#btn-reset-walls"))==null||q.addEventListener("click",()=>{this.arena.resetDefaultWalls([this.character,...this.objects]),this.updateWallPresetUI()}),(H=this.container.querySelector("#btn-clear-walls"))==null||H.addEventListener("click",()=>{this.arena.clearAllWalls([this.character,...this.objects]),this.updateWallPresetUI()}),this.setupSlider("slide-friction","val-friction",y=>{this.arena.frictionCoeff=y},1),this.setupSlider("slide-static-thresh","val-static-thresh",y=>{this.arena.staticFrictionThreshold=y},2),this.container.querySelectorAll(".preset-chip").forEach(y=>{y.addEventListener("click",()=>{const X=y.getAttribute("data-preset");X&&this.presets[X]&&(this.creatorState={...this.presets[X]},this.syncCreatorInputs())})});const w=this.container.querySelector("#creator-name");w==null||w.addEventListener("input",()=>{this.creatorState.name=w.value});const x=this.container.querySelector("#creator-toggle-shape");x==null||x.addEventListener("click",()=>{this.creatorState.visualShape=this.creatorState.visualShape==="box"?"circle":"box",x.textContent=this.creatorState.visualShape==="box"?"Box 📦":"Circle ⚪",x.classList.toggle("active",this.creatorState.visualShape==="box")});const R=this.container.querySelector("#creator-color"),z=this.container.querySelector("#val-creator-color");R==null||R.addEventListener("input",()=>{this.creatorState.color=R.value,z&&(z.textContent=R.value)});const O=this.container.querySelector("#creator-toggle-collider");O==null||O.addEventListener("click",()=>{this.creatorState.hasCollider=!this.creatorState.hasCollider,O.textContent=this.creatorState.hasCollider?"Attached":"Detached",O.classList.toggle("active",this.creatorState.hasCollider);const y=this.container.querySelector("#grp-creator-radius");y&&(y.style.display=this.creatorState.hasCollider?"block":"none")}),this.setupSlider("slide-creator-radius","val-creator-radius",y=>{this.creatorState.colliderRadius=y},2);const B=this.container.querySelector("#creator-toggle-mass");B==null||B.addEventListener("click",()=>{this.creatorState.hasMass=!this.creatorState.hasMass,B.textContent=this.creatorState.hasMass?"Attached":"Detached",B.classList.toggle("active",this.creatorState.hasMass);const y=this.container.querySelector("#grp-creator-mass");y&&(y.style.display=this.creatorState.hasMass?"block":"none")}),this.setupSlider("slide-creator-mass","val-creator-mass",y=>{this.creatorState.mass=y},1);const A=this.container.querySelector("#creator-toggle-friction");A==null||A.addEventListener("click",()=>{this.creatorState.hasFriction=!this.creatorState.hasFriction,A.textContent=this.creatorState.hasFriction?"Attached":"Detached",A.classList.toggle("active",this.creatorState.hasFriction);const y=this.container.querySelector("#grp-creator-fric");y&&(y.style.display=this.creatorState.hasFriction?"block":"none")}),this.setupSlider("slide-creator-fric","val-creator-fric",y=>{this.creatorState.dynamicFrictionMod=y},2);const F=this.container.querySelector("#creator-toggle-bounce");F==null||F.addEventListener("click",()=>{this.creatorState.hasBounce=!this.creatorState.hasBounce,F.textContent=this.creatorState.hasBounce?"Attached":"Detached",F.classList.toggle("active",this.creatorState.hasBounce);const y=this.container.querySelector("#grp-creator-bounce");y&&(y.style.display=this.creatorState.hasBounce?"block":"none")}),this.setupSlider("slide-creator-bounce","val-creator-bounce",y=>{this.creatorState.bounceMod=y},2);const u=this.container.querySelector("#creator-check-vert-bounce");u==null||u.addEventListener("change",()=>{this.creatorState.verticalBounce=u.checked,this.syncCreatorInputs()});const S=this.container.querySelector("#creator-toggle-vert-pos");S==null||S.addEventListener("click",()=>{this.creatorState.hasVerticalPosition=!this.creatorState.hasVerticalPosition,this.syncCreatorInputs()}),this.setupSlider("slide-creator-elevation","val-creator-elevation",y=>{this.creatorState.elevation=y},2);const k=this.container.querySelector("#creator-toggle-vert-vel");k==null||k.addEventListener("click",()=>{this.creatorState.hasVerticalVelocity=!this.creatorState.hasVerticalVelocity,this.syncCreatorInputs()});const E=this.container.querySelector("#creator-toggle-gravity");E==null||E.addEventListener("click",()=>{this.creatorState.hasGravity=!this.creatorState.hasGravity,E.textContent=this.creatorState.hasGravity?"Attached":"Detached",E.classList.toggle("active",this.creatorState.hasGravity)});const D=this.container.querySelector("#creator-toggle-roll");D==null||D.addEventListener("click",()=>{this.creatorState.hasRollModule=!this.creatorState.hasRollModule,D.textContent=this.creatorState.hasRollModule?"Enabled":"Disabled",D.classList.toggle("active",this.creatorState.hasRollModule);const y=this.container.querySelector("#group-creator-roll-resist");y&&(y.style.display=this.creatorState.hasRollModule?"block":"none")}),this.setupSlider("slide-creator-roll-resist","val-creator-roll-resist",y=>{this.creatorState.rollResistance=y},2),(j=this.container.querySelector("#btn-spawn-configured"))==null||j.addEventListener("click",()=>{this.spawnFromCreator()}),(G=this.container.querySelector("#btn-clear-entities"))==null||G.addEventListener("click",()=>{this.onClearObjects(),this.setSelectedEntity(this.character)})}spawnFromCreator(){const t=this.creatorState,i=Math.min(Math.max(this.character.position.x+(Math.random()*2-1),1),this.arena.width-1),s=Math.min(Math.max(this.character.position.y+(Math.random()*2-1),1),this.arena.height-1),e=new it({name:t.name||"Custom Object",position:{x:i,y:s,z:t.hasVerticalPosition?t.elevation:0},visualShape:t.visualShape,color:t.color,colliderModule:t.hasCollider?new dt({radius:t.colliderRadius}):null,massModule:t.hasMass?new ht({mass:t.mass}):null,frictionModule:t.hasFriction?new ut({staticFrictionMod:t.staticFrictionMod,dynamicFrictionMod:t.dynamicFrictionMod}):null,bounceModule:t.hasBounce?new yt({bounceMod:t.bounceMod,verticalBounce:t.verticalBounce}):null,verticalPositionModule:t.hasVerticalPosition?new bt({z:t.elevation,hasVerticalVelocity:t.hasVerticalVelocity,verticalVelocity:0}):null,gravityModule:t.hasGravity?new mt:null,rollModule:t.hasRollModule?new Mt({rollResistance:t.rollResistance}):null});this.onSpawnObject(e),this.setSelectedEntity(e)}duplicateSelectedEntity(){if(this.selectedEntity===this.character)return;const t=this.selectedEntity,i=Math.min(Math.max(t.position.x+.6,1),this.arena.width-1),s=Math.min(Math.max(t.position.y+.6,1),this.arena.height-1),e=new it({name:`${t.name} (Copy)`,position:{x:i,y:s,z:t.position.z},visualShape:t.visualShape,color:t.color,colliderModule:t.colliderModule?new dt({radius:t.colliderModule.radius,enabled:t.colliderModule.enabled}):null,massModule:t.massModule?new ht({mass:t.massModule.mass,enabled:t.massModule.enabled}):null,frictionModule:t.frictionModule?new ut({staticFrictionMod:t.frictionModule.staticFrictionMod,dynamicFrictionMod:t.frictionModule.dynamicFrictionMod,enabled:t.frictionModule.enabled}):null,bounceModule:t.bounceModule?new yt({bounceMod:t.bounceModule.bounceMod,verticalBounce:t.bounceModule.verticalBounce,enabled:t.bounceModule.enabled}):null,verticalPositionModule:t.verticalPositionModule?new bt({z:t.verticalPositionModule.z,hasVerticalVelocity:t.verticalPositionModule.hasVerticalVelocity,verticalVelocity:t.verticalPositionModule.verticalVelocity,enabled:t.verticalPositionModule.enabled}):null,gravityModule:t.gravityModule?new mt({enabled:t.gravityModule.enabled}):null,rollModule:t.rollModule?new Mt({rollResistance:t.rollModule.rollResistance,enabled:t.rollModule.enabled}):null});this.onSpawnObject(e),this.setSelectedEntity(e)}deleteSelectedEntity(){if(this.selectedEntity===this.character)return;const t=this.selectedEntity;this.character.heldObject===t&&(t.isHeld=!1,t.heldBy=null,this.character.heldObject=null),this.onDeleteObject&&this.onDeleteObject(t),this.setSelectedEntity(this.character)}setupSlider(t,i,s,e=0){const l=this.container.querySelector(`#${t}`),o=this.container.querySelector(`#${i}`);!l||!o||l.addEventListener("input",()=>{const n=parseFloat(l.value);o.textContent=e>0?n.toFixed(e):Math.round(n).toString(),s(n)})}updateInspector(){var e;const t=this.selectedEntity,i=Math.hypot(t.velocity.x,t.velocity.y).toFixed(2),s=t===this.character;this.inspectorEl.innerHTML=`
