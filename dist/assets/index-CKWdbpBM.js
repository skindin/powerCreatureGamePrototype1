        ...
        <div class="dev-section">
          ...
          <div class="module-card" id="card-mod-bounce">
            ...
            <div id="group-mod-bounce" style="display: ${(p=this.selectedEntity.bounceModule)!=null&&p.enabled?"block":"none"};">
              ...
              <div id="warn-bounce-vert-vel" class="module-dep-warning" style="display: ${(w=this.selectedEntity.bounceModule)!=null&&w.enabled&&((A=this.selectedEntity.bounceModule)!=null&&A.verticalBounce)&&!this.selectedEntity.hasVerticalVelocity?"block":"none"};">
