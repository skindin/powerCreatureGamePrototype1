            ...
            <div id="group-mod-bounce" style="display: ${(p=this.selectedEntity.bounceModule)!=null&&p.enabled?"block":"none"};">
              ...
              <div class="toggle-subrow" style="margin-top: 8px; display: flex; align-items: center; justify-content: space-between;">
                <label style="font-size: 0.8rem; color: #e2e8f0; cursor: pointer; display: flex; align-items: center; gap: 6px;">
                  <input type="checkbox" id="check-mod-vert-bounce" ${($=this.selectedEntity.bounceModule)!=null&&$.verticalBounce?"checked":""}>
                  <span>Vertical Bounce</span>
                </label>
              </div>
              <div id="warn-bounce-vert-vel" class="module-dep-warning" style="display: ${(M=this.selectedEntity.bounceModule)!=null&&M.enabled&&((B=this.selectedEntity.bounceModule)!=null&&B.verticalBounce)&&!this.selectedEntity.hasVerticalVelocity?"block":"none"};">
            ...
            <div class="module-card" id="card-mod-walking">
              ...
              <div id="group-mod-walking" style="display: ${(z=this.character.walkingModule)!=null&&z.enabled?"flex":"none"}; flex-direction: column; gap: 8px;">
                <div class="slider-group">
                  ...
                  <input type="range" id="slide-walk-force" min="10" max="200" step="5" value="${((P=this.character.walkingModule)==null?void 0:P.maxWalkForce)??35}">
                </div>
                <div class="slider-group">
                  <div class="slider-label">
