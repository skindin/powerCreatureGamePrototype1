        ...
        <div class="dev-section">
            ...
            <div id="group-mod-bounce" style="display: ${(v=this.selectedEntity.bounceModule)!=null&&v.enabled?"block":"none"};">
              ...
              <div class="toggle-subrow" style="margin-top: 8px; display: flex; align-items: center; justify-content: space-between;">
                <label style="font-size: 0.8rem; color: #e2e8f0; cursor: pointer; display: flex; align-items: center; gap: 6px;">
                  <input type="checkbox" id="check-mod-vert-bounce" ${(h=this.selectedEntity.bounceModule)!=null&&h.verticalBounce?"checked":""}>
                  <span>Vertical Bounce</span>
                </label>
              </div>
              <div id="warn-bounce-vert-vel" class="module-dep-warning" style="display: ${(p=this.selectedEntity.bounceModule)!=null&&p.enabled&&((k=this.selectedEntity.bounceModule)!=null&&k.verticalBounce)&&!this.selectedEntity.hasVerticalVelocity?"block":"none"};">
                ⚠️ Inactive without Vertical Velocity
              </div>
            </div>
            <div id="note-mod-bounce" class="module-detached-note" style="display: ${(S=this.selectedEntity.bounceModule)!=null&&S.enabled?"none":"block"};">
          ...
          <div id="character-specific-controls" style="display: ${this.selectedEntity===this.character?"flex":"none"}; flex-direction: column; gap: 10px;">
            ...
            <div class="module-card" id="card-mod-walking">
              ...
              <div id="group-mod-walking" style="display: ${(L=this.character.walkingModule)!=null&&L.enabled?"flex":"none"}; flex-direction: column; gap: 8px;">
                <div class="slider-group">
                  <div class="slider-label">
            ...
            <div class="module-card">
              ...
              <div id="group-mod-pickup" style="display: ${(O=this.character.pickupModule)!=null&&O.enabled?"block":"none"};">
                <div class="slider-group">
                  <div class="slider-label">
