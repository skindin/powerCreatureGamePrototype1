var Ft=Object.defineProperty;var $t=(H,t,i)=>t in H?Ft(H,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):H[t]=i;var r=(H,t,i)=>$t(H,typeof t!="symbol"?t+"":t,i);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const l of e)if(l.type==="childList")for(const n of l.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function i(e){const l={};return e.integrity&&(l.integrity=e.integrity),e.referrerPolicy&&(l.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?l.credentials="include":e.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(e){if(e.ep)return;e.ep=!0;const l=i(e);fetch(e.href,l)}})();class rt{constructor(t={}){r(this,"z");r(this,"hasVerticalVelocity");r(this,"verticalVelocity");r(this,"enabled");this.z=t.z??0,this.hasVerticalVelocity=t.hasVerticalVelocity!==void 0?t.hasVerticalVelocity:!0,this.verticalVelocity=t.verticalVelocity??0,this.enabled=t.enabled!==void 0?t.enabled:!0}}const xt=class xt{constructor(t=20,i=14,s=1){r(this,"width");r(this,"height");r(this,"tileSize");r(this,"cols");r(this,"rows");r(this,"wallHeight");r(this,"gravity");r(this,"frictionCoeff");r(this,"staticFrictionThreshold");r(this,"tileGrid");r(this,"walls",[]);r(this,"currentPresetId","trenches");this.width=t,this.height=i,this.tileSize=s,this.cols=Math.floor(t/s),this.rows=Math.floor(i/s),this.wallHeight=1,this.gravity=10,this.frictionCoeff=10.4,this.staticFrictionThreshold=.16,this.tileGrid=Array.from({length:this.rows},()=>Array.from({length:this.cols},()=>0)),this.loadWallPreset("trenches")}rebuildWalls(){this.walls=[];for(let t=0;t<this.rows;t++)for(let i=0;i<this.cols;i++)this.tileGrid[t][i]===1&&this.walls.push({id:`wall-${i}-${t}`,x:i*this.tileSize,y:t*this.tileSize,width:this.tileSize,height:this.tileSize,wallHeight:this.wallHeight})}setStandardWallHeight(t){this.wallHeight=t,this.rebuildWalls()}setWallTile(t,i,s){if(t<0||t>=this.cols||i<0||i>=this.rows)return!1;const e=s?1:0;return this.tileGrid[i][t]===e?!1:(this.tileGrid[i][t]=e,this.rebuildWalls(),!0)}hasWall(t,i){return t<0||t>=this.cols||i<0||i>=this.rows?!1:this.tileGrid[i][t]===1}loadWallPreset(t,i){const s=xt.WALL_PRESETS.find(e=>e.id===t);return s?(this.currentPresetId=t,this.tileGrid=s.generate(this.cols,this.rows),this.rebuildWalls(),this.syncEntitiesWithWalls(i),!0):!1}syncEntitiesWithWalls(t){var i;if(t)for(const s of t){const e=s.hasCollider?s.colliderRadius:((i=s.colliderModule)==null?void 0:i.radius)??.32,l=this.getSupportingWall(s.position.x,s.position.y,e);l&&s.position.z<l.wallHeight&&(s.hasVerticalPosition||(s.verticalPositionModule?s.verticalPositionModule.enabled=!0:s.verticalPositionModule=new rt({z:l.wallHeight,hasVerticalVelocity:!0})),s.position.z=l.wallHeight,s.supportingSurfaceHeight=l.wallHeight,s.standingWall=l,s.verticalVelocity=0)}}clearAllWalls(t){this.loadWallPreset("empty",t)}resetDefaultWalls(t){this.loadWallPreset("trenches",t)}getWallAt(t,i){for(const s of this.walls)if(t>=s.x&&t<=s.x+s.width&&i>=s.y&&i<=s.y+s.height)return s;return null}testWallOverlap(t,i,s,e){const l=Math.max(e.x,Math.min(t,e.x+e.width)),n=Math.max(e.y,Math.min(i,e.y+e.height)),o=t-l,a=i-n;return o*o+a*a<s*s}getSupportingWall(t,i,s=0){if(s<=0)return this.getWallAt(t,i);for(const e of this.walls)if(this.testWallOverlap(t,i,s,e))return e;return null}areWallsContiguous(t,i){if(t.id===i.id)return!0;const s=Math.max(0,Math.max(t.x,i.x)-Math.min(t.x+t.width,i.x+i.width)),e=Math.max(0,Math.max(t.y,i.y)-Math.min(t.y+t.height,i.y+i.height)),l=Math.min(t.x+t.width,i.x+i.width)-Math.max(t.x,i.x),n=Math.min(t.y+t.height,i.y+i.height)-Math.max(t.y,i.y);return s<.001&&n>.05||e<.001&&l>.05}getSupportingSurfaceHeight(t,i,s=0){const e=this.getSupportingWall(t,i,s);return e?e.wallHeight:0}};r(xt,"WALL_PRESETS",[{id:"trenches",name:"⛏️ Trench Tunnels",badge:"Dense Walls",description:"Mostly elevated walls with a winding network of 1-tile-wide ground-level trench tunnels.",generate:(t,i)=>{const s=Array.from({length:i},()=>Array.from({length:t},()=>1));for(let e=2;e<=17;e++)s[3][e]=0,s[7][e]=0,s[10][e]=0;for(let e=2;e<=11;e++)s[e][5]=0,s[e][10]=0,s[e][14]=0;s[1][10]=0,s[12][10]=0,s[7][1]=0,s[7][18]=0;for(let e=5;e<=9;e++)s[e][2]=0;for(let e=5;e<=9;e++)s[e][17]=0;for(let e=2;e<=5;e++)s[5][e]=0;for(let e=10;e<=14;e++)s[5][e]=0;for(let e=5;e<=10;e++)s[9][e]=0;for(let e=14;e<=17;e++)s[9][e]=0;return s[7][5]=0,s}},{id:"standard",name:"🏛️ Standard Arena",badge:"Balanced",description:"Center dividing wall with an open gateway and two 2×2 cover obstacles.",generate:(t,i)=>{const s=Array.from({length:i},()=>Array.from({length:t},()=>0)),e=10;for(let l=1;l<=4;l++)s[l][e]=1;for(let l=8;l<=12;l++)s[l][e]=1;return s[4][4]=1,s[5][4]=1,s[4][5]=1,s[5][5]=1,s[7][15]=1,s[8][15]=1,s[7][16]=1,s[8][16]=1,s}},{id:"courtyards",name:"🏰 Courtyards & Platforms",badge:"4 Quadrants",description:"Four large raised platforms in each corner with a central dais and open courtyards.",generate:(t,i)=>{const s=Array.from({length:i},()=>Array.from({length:t},()=>0));for(let e=2;e<=4;e++){for(let l=3;l<=6;l++)s[e][l]=1;for(let l=13;l<=16;l++)s[e][l]=1}for(let e=9;e<=11;e++){for(let l=3;l<=6;l++)s[e][l]=1;for(let l=13;l<=16;l++)s[e][l]=1}for(let e=6;e<=7;e++)for(let l=9;l<=10;l++)s[e][l]=1;return s}},{id:"pillars",name:"🗿 Pillars & Monoliths",badge:"Tactical Cover",description:"Raised monoliths and stepping-stone pillars scattered across the arena.",generate:(t,i)=>{const s=Array.from({length:i},()=>Array.from({length:t},()=>0)),e=[[3,2],[8,2],[15,2],[3,10],[8,10],[15,10],[5,6],[13,6],[9,6]];for(const[l,n]of e)s[n][l]=1,s[n+1][l]=1,s[n][l+1]=1,s[n+1][l+1]=1;return s}},{id:"maze",name:"🌀 Labyrinth Maze",badge:"Winding Paths",description:"Interlocking corridors and winding paths with high walls to climb over or navigate.",generate:(t,i)=>{const s=Array.from({length:i},()=>Array.from({length:t},()=>0));for(let e=1;e<=9;e++)s[e][4]=1;for(let e=4;e<=12;e++)s[e][7]=1;for(let e=1;e<=9;e++)s[e][10]=1;for(let e=4;e<=12;e++)s[e][13]=1;for(let e=1;e<=9;e++)s[e][16]=1;for(let e=7;e<=10;e++)s[4][e]=1;for(let e=13;e<=16;e++)s[4][e]=1;for(let e=4;e<=7;e++)s[9][e]=1;for(let e=10;e<=13;e++)s[9][e]=1;return s}},{id:"empty",name:"⬜ Empty (Open Arena)",badge:"Clean Slate",description:"Completely open arena with zero walls for custom level design.",generate:(t,i)=>Array.from({length:i},()=>Array.from({length:t},()=>0))}]);let J=xt;class dt{constructor(t={}){r(this,"radius");r(this,"enabled");this.radius=t.radius??.32,this.enabled=t.enabled??!0}}class ht{constructor(t={}){r(this,"mass");r(this,"enabled");this.mass=t.mass??1,this.enabled=t.enabled??!0}}class ut{constructor(t={}){r(this,"staticFrictionMod");r(this,"dynamicFrictionMod");r(this,"enabled");this.staticFrictionMod=t.staticFrictionMod??1,this.dynamicFrictionMod=t.dynamicFrictionMod??1,this.enabled=t.enabled??!0}}class yt{constructor(t={}){r(this,"bounceMod");r(this,"verticalBounce");r(this,"enabled");this.bounceMod=t.bounceMod??.4,this.verticalBounce=t.verticalBounce??!0,this.enabled=t.enabled??!0}}class ft{constructor(t={}){r(this,"enabled");this.enabled=t.enabled??!0}}class tt{constructor(t={}){r(this,"id");r(this,"name");r(this,"position");r(this,"velocity");r(this,"color");r(this,"isHeld");r(this,"heldBy");r(this,"lastThrower",null);r(this,"isCharacter",!1);r(this,"isClimbing",!1);r(this,"visualShape","circle");r(this,"colliderModule",null);r(this,"massModule",null);r(this,"frictionModule",null);r(this,"bounceModule",null);r(this,"verticalPositionModule",null);r(this,"gravityModule",null);r(this,"rollModule",null);r(this,"supportingSurfaceHeight",0);r(this,"standingWall",null);var i,s,e,l,n;this.id=t.id??`obj-${Math.random().toString(36).substring(2,9)}`,this.name=t.name??"Entity",this.position={x:((i=t.position)==null?void 0:i.x)??0,y:((s=t.position)==null?void 0:s.y)??0,z:((e=t.position)==null?void 0:e.z)??0},this.velocity={x:((l=t.velocity)==null?void 0:l.x)??0,y:((n=t.velocity)==null?void 0:n.y)??0},this.color=t.color??"#94a3b8",this.isHeld=!1,this.heldBy=null,this.visualShape=t.visualShape??"circle",this.colliderModule=t.colliderModule!==void 0?t.colliderModule:t.colliderRadius!==void 0?new dt({radius:t.colliderRadius}):new dt({radius:.35}),this.massModule=t.massModule!==void 0?t.massModule:t.mass!==void 0?new ht({mass:t.mass}):new ht({mass:1}),this.frictionModule=t.frictionModule!==void 0?t.frictionModule:new ut({staticFrictionMod:t.staticGroundFrictionMod??1,dynamicFrictionMod:t.dynamicGroundFrictionMod??1}),this.bounceModule=t.bounceModule!==void 0?t.bounceModule:t.bounceMod!==void 0&&t.bounceMod!==null?new yt({bounceMod:t.bounceMod}):new yt({bounceMod:.4}),this.verticalPositionModule=t.verticalPositionModule!==void 0?t.verticalPositionModule:t.hasVerticalPosition===!1?null:new rt({z:this.position.z,hasVerticalVelocity:t.hasVerticalVelocity!==!1,verticalVelocity:t.verticalVelocity??0}),this.hasVerticalPosition||(this.position.z=0),this.gravityModule=t.gravityModule!==void 0?t.gravityModule:t.hasGravity===!1?null:new ft,this.rollModule=t.rollModule??null}get hasCollider(){return!!(this.colliderModule&&this.colliderModule.enabled)}get colliderRadius(){return this.colliderModule&&this.colliderModule.enabled?this.colliderModule.radius:0}set colliderRadius(t){this.colliderModule?this.colliderModule.radius=t:this.colliderModule=new dt({radius:t})}get hasMass(){return!!(this.massModule&&this.massModule.enabled&&this.massModule.mass>0)}get mass(){return this.massModule&&this.massModule.enabled?this.massModule.mass:0}set mass(t){this.massModule?this.massModule.mass=t:this.massModule=new ht({mass:t})}get hasFriction(){return!!(this.hasMass&&this.frictionModule&&this.frictionModule.enabled)}get staticGroundFrictionMod(){return this.hasFriction&&this.frictionModule?this.frictionModule.staticFrictionMod:0}set staticGroundFrictionMod(t){this.frictionModule?this.frictionModule.staticFrictionMod=t:this.frictionModule=new ut({staticFrictionMod:t})}get dynamicGroundFrictionMod(){return this.hasFriction&&this.frictionModule?this.frictionModule.dynamicFrictionMod:0}set dynamicGroundFrictionMod(t){this.frictionModule?this.frictionModule.dynamicFrictionMod=t:this.frictionModule=new ut({dynamicFrictionMod:t})}get hasBounce(){return!!(this.hasMass&&this.bounceModule&&this.bounceModule.enabled)}get bounceMod(){return this.hasBounce&&this.bounceModule?this.bounceModule.bounceMod:null}set bounceMod(t){t===null||t<=.01?this.bounceModule=null:this.bounceModule?this.bounceModule.bounceMod=t:this.bounceModule=new yt({bounceMod:t})}get hasVerticalPosition(){return!!(this.verticalPositionModule&&this.verticalPositionModule.enabled)}get hasVerticalVelocity(){var t;return!!(this.hasVerticalPosition&&((t=this.verticalPositionModule)!=null&&t.hasVerticalVelocity))}get verticalVelocity(){return this.hasVerticalVelocity&&this.verticalPositionModule?this.verticalPositionModule.verticalVelocity:0}set verticalVelocity(t){this.hasVerticalVelocity&&this.verticalPositionModule&&(this.verticalPositionModule.verticalVelocity=t)}get hasVerticalBounce(){var t;return!!(this.hasBounce&&((t=this.bounceModule)!=null&&t.verticalBounce)&&this.hasVerticalVelocity)}get hasGravity(){return!!(this.gravityModule&&this.gravityModule.enabled)}get isRestingOnSurface(){return Math.abs(this.position.z-this.supportingSurfaceHeight)<=.01&&Math.abs(this.verticalVelocity)<=.05}get isAboveGround(){return this.hasVerticalPosition&&this.position.z>.001}get isAboveWalls(){return this.hasVerticalPosition&&(this.position.z>=.85||this.supportingSurfaceHeight>=.85||this.standingWall!==null)}updatePosition(t,i){var v,m,x,p,f,M,k,S,L,W,O,$,D,T,G,U,I,j;if(this.isHeld)return;if(this.lastThrower){const C=this.lastThrower.hasCollider?this.lastThrower.colliderRadius:.44,y=(((v=this.lastThrower.pickupModule)==null?void 0:v.pickupReach)??1.3)+this.colliderRadius+C;(Math.hypot(this.position.x-this.lastThrower.position.x,this.position.y-this.lastThrower.position.y)>y||this.isRestingOnSurface)&&(this.lastThrower=null)}this.hasVerticalPosition||(this.position.z=0,this.verticalVelocity=0,this.supportingSurfaceHeight=0);let s=0;if(this.hasCollider&&this.hasVerticalPosition&&i.walls.length>0)if(this.position.z>=i.wallHeight-.05||this.supportingSurfaceHeight>=i.wallHeight-.05&&this.position.z>=i.wallHeight-.2||this.standingWall!==null){const y=this.isCharacter?this:null;if(!!((m=y==null?void 0:y.climbingModule)!=null&&m.isDismountFreefall||(x=y==null?void 0:y.climbingModule)!=null&&x.climbSuppressedUntilRePress))this.standingWall=null,s=0;else if(this.standingWall){const w=(p=y==null?void 0:y.climbingModule)!=null&&p.enabled&&((f=y==null?void 0:y.climbingModule)!=null&&f.preventWalkOff)?Math.max(this.colliderRadius,y.climbingModule.hangDistance):this.colliderRadius;if(i.testWallOverlap(this.position.x,this.position.y,w,this.standingWall))s=this.standingWall.wallHeight;else if((M=y==null?void 0:y.climbingModule)!=null&&M.dismountSuppressedUntilRelease)s=this.standingWall.wallHeight;else{let F=null;for(const z of i.walls)if(i.areWallsContiguous(this.standingWall,z)&&i.testWallOverlap(this.position.x,this.position.y,w,z)){F=z;break}F?(this.standingWall=F,s=F.wallHeight):(this.standingWall=null,s=0,y!=null&&y.climbingModule&&(y.climbingModule.isDismountFreefall=!0,y.climbingModule.climbSuppressedUntilRelease=!0))}}else if(!this.isClimbing&&(this.position.z>=i.wallHeight-.05||this.supportingSurfaceHeight>=i.wallHeight-.05)){const w=(k=y==null?void 0:y.climbingModule)!=null&&k.enabled&&((S=y==null?void 0:y.climbingModule)!=null&&S.preventWalkOff)?Math.max(this.colliderRadius,y.climbingModule.hangDistance):this.colliderRadius,V=i.getSupportingWall(this.position.x,this.position.y,w);V&&(this.standingWall=V,s=V.wallHeight)}}else this.standingWall=null;if(this.isClimbing&&(s=Math.max(s,this.position.z),this.verticalVelocity=0),this.supportingSurfaceHeight=s,this.hasGravity&&this.hasVerticalVelocity){if((this.position.z>s||this.verticalVelocity!==0)&&(this.verticalVelocity-=i.gravity*t,this.position.z+=this.verticalVelocity*t,this.position.z<=s))if(this.position.z=s,!this.isCharacter&&this.hasVerticalBounce&&this.bounceMod!==null&&this.bounceMod>0&&Math.abs(this.verticalVelocity)>.25){const C=Math.abs(this.verticalVelocity);if(this.verticalVelocity=-this.verticalVelocity*this.bounceMod,this.hasFriction&&this.rollModule&&this.rollModule.enabled){const y=this.rollModule,E=this.colliderRadius>0?this.colliderRadius:.3,w=.4,V=this.bounceMod,F=(1+V)*this.mass*C,z=i.frictionCoeff*this.dynamicGroundFrictionMod*.05,P=this.velocity.x-y.angularVelocity.y*E,B=this.velocity.y+y.angularVelocity.x*E,A=Math.hypot(P,B);if(A>.001&&z>0){const h=z*F,q=A*this.mass/(1+1/w),X=Math.min(q,h),Y=P/A*X,N=B/A*X;this.velocity.x-=Y/this.mass,this.velocity.y-=N/this.mass,y.angularVelocity.y+=Y/(w*this.mass*E),y.angularVelocity.x-=N/(w*this.mass*E)}const R=Math.max(.65,1-(1-V)*.35);y.angularVelocity.x*=R,y.angularVelocity.y*=R,y.angularVelocity.z*=R}}else this.verticalVelocity=0}else this.hasVerticalVelocity&&this.verticalVelocity!==0&&(this.position.z+=this.verticalVelocity*t,this.position.z<=s&&(this.position.z=s,this.hasVerticalBounce&&this.bounceMod!==null&&this.bounceMod>0&&Math.abs(this.verticalVelocity)>.25?this.verticalVelocity=-this.verticalVelocity*this.bounceMod:this.verticalVelocity=0));if(Math.abs(this.position.z-s)<=.01&&Math.abs(this.verticalVelocity)<=.05&&this.hasFriction){if(!(this.isCharacter&&((L=this.walkingModule)==null?void 0:L.enabled)))if(this.rollModule&&this.rollModule.enabled){const y=this.rollModule,E=this.colliderRadius>0?this.colliderRadius:.3,w=i.frictionCoeff*this.dynamicGroundFrictionMod,V=.4,F=this.velocity.x-y.angularVelocity.y*E,z=this.velocity.y+y.angularVelocity.x*E,P=Math.hypot(F,z);if(w>0&&P>.001){const A=w*(1+1/V)*t;if(P<=A){const R=this.velocity.x+V*y.angularVelocity.y*E,h=this.velocity.y-V*y.angularVelocity.x*E,q=R/(1+V),X=h/(1+V);this.velocity.x=q,this.velocity.y=X,y.angularVelocity.y=q/E,y.angularVelocity.x=-X/E}else{const R=F/P*w*t,h=z/P*w*t;this.velocity.x-=R,this.velocity.y-=h,y.angularVelocity.y+=R/(V*E),y.angularVelocity.x-=h/(V*E)}}const B=Math.hypot(this.velocity.x,this.velocity.y);if(B>0){if(y.rollResistance>0){const A=y.rollResistance*t,R=Math.max(0,B-A);if(R<.005)this.velocity.x=0,this.velocity.y=0,y.angularVelocity.x=0,y.angularVelocity.y=0;else{const h=R/B;this.velocity.x*=h,this.velocity.y*=h,y.angularVelocity.x*=h,y.angularVelocity.y*=h}}}else{const A=Math.hypot(y.angularVelocity.x,y.angularVelocity.y);if(A>0&&w>0){const R=w/(V*E)*t,h=Math.max(0,A-R),q=A>0?h/A:0;y.angularVelocity.x*=q,y.angularVelocity.y*=q}}if(Math.abs(y.angularVelocity.z)>.001&&y.rollResistance>0){const A=y.rollResistance/(V*E)*t,R=Math.sign(y.angularVelocity.z),h=Math.abs(y.angularVelocity.z);y.angularVelocity.z=h<=A?0:R*(h-A)}y.updateVisualPhase(t)}else{const y=Math.hypot(this.velocity.x,this.velocity.y);if(y>0){const E=i.staticFrictionThreshold*this.staticGroundFrictionMod;if(y<E)this.velocity.x=0,this.velocity.y=0;else{const w=i.frictionCoeff*this.dynamicGroundFrictionMod*t,F=Math.max(0,y-w)/y;this.velocity.x*=F,this.velocity.y*=F}}}}else this.rollModule&&this.rollModule.enabled&&this.rollModule.updateVisualPhase(t);const l=this.isCharacter?this:null,n=!this.isClimbing&&this.supportingSurfaceHeight>=i.wallHeight-.05&&this.standingWall!==null,o=!!(n&&(l!=null&&l.isClimbInputHeld)&&!((W=l==null?void 0:l.climbingModule)!=null&&W.dismountSuppressedUntilRelease)),a=!!(l&&n&&((O=l.climbingModule)!=null&&O.enabled)&&(($=l.climbingModule)!=null&&$.preventWalkOff)&&!o),d=this.velocity.x*t,c=this.velocity.y*t,u=Math.hypot(d,c);if(u>1e-4)if(a){const C=Math.max(.01,((D=l==null?void 0:l.climbingModule)==null?void 0:D.hangDistance)??.5);let y=this.standingWall??i.getSupportingWall(this.position.x,this.position.y,C);this.standingWall=y;const E=this.position.x+d,w=this.position.y+c,V=[];if(y){V.push(y);for(const z of i.walls)z.id!==y.id&&i.areWallsContiguous(y,z)&&V.push(z)}let F=null;for(const z of V)if(i.testWallOverlap(E,w,C,z)){F=z;break}if(F)this.position.x=E,this.position.y=w,this.standingWall=F;else if(V.length>0){let z=1/0,P=null;for(const B of V){const A=Math.max(B.x,Math.min(E,B.x+B.width)),R=Math.max(B.y,Math.min(w,B.y+B.height)),h=E-A,q=w-R,X=h*h+q*q;X<z&&(z=X,P={wall:B,closestX:A,closestY:R,dist:Math.sqrt(X),dx:h,dy:q})}if(P&&P.dist>0){const B=P.dx/P.dist,A=P.dy/P.dist,R=this.velocity.x*B+this.velocity.y*A;R>0&&(this.velocity.x-=R*B,this.velocity.y-=R*A);const h=C-.002;P.dist>h?(this.position.x=P.closestX+B*h,this.position.y=P.closestY+A*h):(this.position.x=E,this.position.y=w);const q=i.testWallOverlap(this.position.x,this.position.y,C,P.wall)?P.wall:V.find(X=>i.testWallOverlap(this.position.x,this.position.y,C,X));q&&(this.standingWall=q)}else this.velocity.x=0,this.velocity.y=0}}else{const y=Math.max(1,Math.ceil(u/.01)),E=d/y,w=c/y;let V=this.standingWall??(n?i.getSupportingWall(this.position.x,this.position.y,this.colliderRadius):null),F=!1;for(let z=1;z<=y;z++){const P=this.position.x+E,B=this.position.y+w;if(V){let R=null;if(i.testWallOverlap(P,B,this.colliderRadius,V))R=V;else for(const h of i.walls)if(i.areWallsContiguous(V,h)&&i.testWallOverlap(P,B,this.colliderRadius,h)){R=h;break}R?(V=R,this.standingWall=R):(T=l==null?void 0:l.climbingModule)!=null&&T.dismountSuppressedUntilRelease||(F=!0,V=null,this.standingWall=null,this.supportingSurfaceHeight=0,l!=null&&l.climbingModule&&(l.climbingModule.isDismountFreefall=!0,l.climbingModule.climbSuppressedUntilRelease=!0))}if(this.position.x=P,this.position.y=B,!this.isClimbing&&(F||!this.standingWall&&!!((G=l==null?void 0:l.climbingModule)!=null&&G.isDismountFreefall||(U=l==null?void 0:l.climbingModule)!=null&&U.climbSuppressedUntilRePress))&&this.hasCollider)for(const R of i.walls)this.position.z<=R.wallHeight&&this.resolveWallCollision(R)}}if(this.hasCollider){const C=this.colliderRadius,y=C,E=i.width-C,w=C,V=i.height-C,F=this.isCharacter?0:this.hasBounce&&this.bounceMod!==null?this.bounceMod:0;this.position.x<y?(this.position.x=y,this.resolveWallImpact(1,0,F)):this.position.x>E&&(this.position.x=E,this.resolveWallImpact(-1,0,F)),this.position.y<w?(this.position.y=w,this.resolveWallImpact(0,1,F)):this.position.y>V&&(this.position.y=V,this.resolveWallImpact(0,-1,F));const z=!!((I=l==null?void 0:l.climbingModule)!=null&&I.isDismountFreefall||(j=l==null?void 0:l.climbingModule)!=null&&j.climbSuppressedUntilRePress);for(const P of i.walls)if(this.position.z<=P.wallHeight&&(this.position.z<P.wallHeight-.05||z||this.standingWall===null)){if(this.standingWall&&(this.standingWall.id===P.id||i.areWallsContiguous(this.standingWall,P)))continue;this.resolveWallCollision(P)}}const b=16,g=Math.hypot(this.velocity.x,this.velocity.y);if(g>b){const C=b/g;this.velocity.x*=C,this.velocity.y*=C}if(this.rollModule&&this.rollModule.enabled){const y=this.rollModule.angularSpeed;if(y>35){const E=35/y;this.rollModule.angularVelocity.x*=E,this.rollModule.angularVelocity.y*=E,this.rollModule.angularVelocity.z*=E}}this.verticalPositionModule&&(this.verticalPositionModule.z=this.position.z)}static getClosestWallPoint(t,i,s){if(!s.walls||s.walls.length===0)return null;let e=1/0,l=null;for(const n of s.walls){const o=Math.max(n.x,Math.min(t,n.x+n.width)),a=Math.max(n.y,Math.min(i,n.y+n.height)),d=t-o,c=i-a,u=d*d+c*c;u<e&&(e=u,l={wall:n,closestX:o,closestY:a,dist:Math.sqrt(u),dx:d,dy:c})}return l}resolveWallImpact(t,i,s){this.lastThrower=null;const e=this.velocity.x*t+this.velocity.y*i;if(e>=0)return;const l=e;if(s>0&&this.hasMass?(this.velocity.x-=(1+s)*l*t,this.velocity.y-=(1+s)*l*i):(this.velocity.x-=l*t,this.velocity.y-=l*i),this.hasFriction&&this.rollModule&&this.rollModule.enabled){const n=this.rollModule,o=this.colliderRadius>0?this.colliderRadius:.3,a=.4,d=.35,c=-i,u=t,b=this.velocity.x*c+this.velocity.y*u,g=-(1+s)*this.mass*l,v=b-n.angularVelocity.z*o,m=Math.abs(v)*this.mass/(1+1/a),x=d*g,p=Math.min(m,x),f=-Math.sign(v)*p,M=b,k=M+f/this.mass,S=Math.abs(k)<=Math.abs(M)+.01?k-M:-M*.1;this.velocity.x+=S*c,this.velocity.y+=S*u;const W=-(S*this.mass)/(a*this.mass*o);n.angularVelocity.z+=W,n.angularVelocity.z=Math.max(-30,Math.min(30,n.angularVelocity.z)),n.angularVelocity.y=this.velocity.x/o,n.angularVelocity.x=-this.velocity.y/o}}resolveWallCollision(t){if(!this.hasCollider)return;const i=this.colliderRadius,s=Math.max(t.x,Math.min(this.position.x,t.x+t.width)),e=Math.max(t.y,Math.min(this.position.y,t.y+t.height)),l=this.position.x-s,n=this.position.y-e,o=l*l+n*n;if(o<i*i){this.lastThrower=null;const a=Math.sqrt(o);let d=0,c=0,u=0;if(a===0){const g=Math.abs(this.position.x-t.x),v=Math.abs(t.x+t.width-this.position.x),m=Math.abs(this.position.y-t.y),x=Math.abs(t.y+t.height-this.position.y),p=Math.min(g,v,m,x);p===g?(d=-1,u=g+i):p===v?(d=1,u=v+i):p===m?(c=-1,u=m+i):(c=1,u=x+i)}else u=i-a,d=l/a,c=n/a;this.position.x+=d*u,this.position.y+=c*u;const b=this.isCharacter?0:this.hasBounce&&this.bounceMod!==null?this.bounceMod:0;this.resolveWallImpact(d,c,b)}}}class Ct{constructor(){r(this,"id","walking");r(this,"name","Walking Module");r(this,"enabled",!0);r(this,"maxWalkForce",35);r(this,"maxWalkSpeed",5.2);r(this,"dragDamping",8.01)}update(t,i,s,e){var O;if(!this.enabled||!t.isRestingOnSurface||t.isClimbing){t.isActivelyWalking=!1;return}if(!t.hasFriction||!((O=t.frictionModule)!=null&&O.enabled)||!t.hasMass||!t.hasStrength||t.strength<=0){t.isActivelyWalking=!1;return}const l=Math.hypot(i.x,i.y),n=l>.05;if(t.isActivelyWalking=n,t.mass<=.01)return;const a=t.dynamicGroundFrictionMod;if(a<=.001)return;const d=e.frictionCoeff/10,c=a*d,b=t.carriedMass/(Math.max(.1,t.strength)*8),g=this.maxWalkSpeed/(1+b);let v=0,m=0;if(n){const $=i.x/l,D=i.y/l;v=$*g,m=D*g}const x=v-t.velocity.x,p=m-t.velocity.y,f=Math.hypot(x,p);if(f<.001){t.velocity.x=v,t.velocity.y=m;return}const M=Math.hypot(t.velocity.x,t.velocity.y),k=Math.max(.02,e.staticFrictionThreshold*t.staticGroundFrictionMod),S=t.hasMass?Math.max(.2,t.baseMass):1,W=this.maxWalkForce*t.strength/S*c*s;if(f<=W||!n&&M<k)t.velocity.x=v,t.velocity.y=m;else{const $=W/f;t.velocity.x+=x*$,t.velocity.y+=p*$}}}class Rt{constructor(){r(this,"id","pickup");r(this,"name","Pickup Ability");r(this,"enabled",!0);r(this,"pickupReach",1.3);r(this,"crossLayerReachRatio",.55)}isObjectInReach(t,i,s=1){var c;if(!this.enabled||i===t||i.isHeld||i.isCharacter||i.lastThrower===t)return!1;const e=t.position.z>=s-.05?1:0,l=i.position.z>=s-.05?1:0,o=e!==l?this.pickupReach*this.crossLayerReachRatio:this.pickupReach,a=i.hasCollider?i.colliderRadius:((c=i.colliderModule)==null?void 0:c.radius)??.32;return Math.hypot(i.position.x-t.position.x,i.position.y-t.position.y)<=o+a}findTargetObject(t,i,s,e,l=1){if(!this.enabled)return null;let n=null,o=1/0;for(const a of e){if(!this.isObjectInReach(t,a,l))continue;const d=Math.hypot(a.position.x-i,a.position.y-s);d<o&&(o=d,n=a)}return n}pickup(t,i){if(!this.enabled||t.heldObject)return!1;const s=i.velocity.x,e=i.velocity.y,l=i.mass/Math.max(.2,t.mass);return t.velocity.x+=s*l,t.velocity.y+=e*l,t.isAboveGround&&Math.abs(i.verticalVelocity)>.1&&(t.verticalVelocity+=i.verticalVelocity*l),t.heldObject=i,i.isHeld=!0,i.heldBy=t,i.velocity.x=0,i.velocity.y=0,i.verticalVelocity=0,i.position.z=i.hasVerticalPosition?.45:0,!0}drop(t){if(!t.heldObject)return null;const i=t.heldObject;return t.heldObject=null,i.isHeld=!1,i.heldBy=null,i.velocity.x=t.velocity.x*.4,i.velocity.y=t.velocity.y*.4,i.verticalVelocity=0,i}}class Pt{constructor(){r(this,"id","throw");r(this,"name","Throw Ability");r(this,"enabled",!0);r(this,"baseThrowForce",7.6);r(this,"maxThrowAimDistance",13)}testWallIntersection(t,i,s,e){const l=Math.max(e.x,Math.min(t,e.x+e.width)),n=Math.max(e.y,Math.min(i,e.y+e.height)),o=t-l,a=i-n;return o*o+a*a<s*s}computeLaunchVelocity(t,i,s,e,l,n,o,a=!0,d=!0,c=.35){const u=e-t,b=l-i,g=Math.hypot(u,b);if(g<.1)return null;const v=Math.min(g,this.maxThrowAimDistance),m=u/g,x=b/g,p=t+m*v,f=i+x*v;if(!a||!d){const j=Math.max(3,o),C=Math.max(.14,v/j),y=m*j,E=x*j;return{vx:y,vy:E,vz:0,totalTime:C,finalTargetX:p,finalTargetY:f,targetSurfaceHeight:s}}const M=n.getSupportingSurfaceHeight(p,f),k=M-s,S=Math.max(3,o);let W=Math.max(.14,v/S);k>0&&(W=Math.max(W,Math.sqrt(2*k/n.gravity)));const O=40,$=c>0?c:.35,D=.25;for(let j=1;j<O;j++){const C=j/O,y=t+(p-t)*C,E=i+(f-i)*C;for(const w of n.walls)if(this.testWallIntersection(y,E,$,w)){if(M>0&&p>=w.x&&p<=w.x+w.width&&f>=w.y&&f<=w.y+w.height&&C>.65)continue;const F=(1-C)*s+C*M,P=w.wallHeight+D-F;if(P>0){const B=n.gravity*C*(1-C);if(B>.001){const A=2*P/B;if(A>0){const R=Math.sqrt(A);R>W&&(W=R)}}}}}if(W<=.05)return null;const T=(k+.5*n.gravity*W*W)/W,G=v/W,U=m*G,I=x*G;return{vx:U,vy:I,vz:T,totalTime:W,finalTargetX:p,finalTargetY:f,targetSurfaceHeight:M}}calculateTrajectory(t,i,s,e){if(!this.enabled||!t.heldObject)return null;const l=t.heldObject,n=l.position.x,o=l.position.y,a=l.position.z,d=this.baseThrowForce*t.strength,c=l.hasGravity&&l.hasVerticalVelocity,u=this.computeLaunchVelocity(n,o,a,i,s,e,d,l.hasGravity,l.hasVerticalVelocity,l.colliderRadius);if(!u)return null;const{vx:b,vy:g,vz:v,totalTime:m,finalTargetX:x,finalTargetY:p,targetSurfaceHeight:f}=u,M=90,k=m/M,S=[];let L=!1,W=f>0,O;for(let D=0;D<=M;D++){const T=D*k,G=D===M?x:n+b*T,U=D===M?p:o+g*T,I=c?a+v*T-.5*e.gravity*T*T:a,j=c?D===M?f:Math.max(f,I):a,C=c?v-e.gravity*T:0,y=j>e.wallHeight;let E=!1,w=!1;for(const V of e.walls)if(this.testWallIntersection(G,U,l.colliderRadius,V)&&(E=!0,j<=V.wallHeight+.001)){if(S.length>0&&S[S.length-1].z>=V.wallHeight-.05&&C<=0){if(f>0&&(D>=M-2||Math.hypot(G-x,U-p)<.2)){W=!0;break}else if(f===0){W=!0,w=!0,L=!0,O=V.id;break}}else if(j<V.wallHeight-.05){w=!0,L=!0,O=V.id;break}}if(S.push({x:G,y:U,z:j,t:T,couldClearWall:y,isOverWall:E,collidesWall:w}),w)break}const $=S[S.length-1];return{points:S,landPoint:{x:L?$.x:x,y:L?$.y:p},isBlockedByWall:L,isLandingOnWallTop:L?W:f>0,blockedAtWallId:O}}throwHeldObject(t,i,s,e){if(!this.enabled||!t.heldObject)return null;const l=t.heldObject,n=l.position.x,o=l.position.y,a=l.position.z,d=this.baseThrowForce*t.strength,c=this.computeLaunchVelocity(n,o,a,i,s,e,d,l.hasGravity,l.hasVerticalVelocity,l.colliderRadius);if(!c)return null;if(l.isHeld=!1,l.heldBy=null,l.lastThrower=t,l.velocity.x=c.vx,l.velocity.y=c.vy,l.verticalVelocity=c.vz,l.position.z=l.hasVerticalPosition?Math.max(.3,l.position.z):0,l.hasFriction&&l.rollModule&&l.rollModule.enabled){const x=l.colliderRadius>0?l.colliderRadius:.3;l.rollModule.angularVelocity.y=c.vx/x,l.rollModule.angularVelocity.x=-c.vy/x}const u=l.hasMass?l.mass:0,b=t.hasMass?Math.max(.2,t.baseMass):0,g=u>0&&b>0?u/b:0;t.heldObject=null;const v=c.vx-t.velocity.x,m=c.vy-t.velocity.y;if(t.velocity.x-=v*g,t.velocity.y-=m*g,t.isAboveGround&&l.hasVerticalVelocity){const x=c.vz-t.verticalVelocity;t.verticalVelocity-=x*g}return l}}class Wt{constructor(t){r(this,"id","climbing");r(this,"name","Climbing Module");r(this,"enabled",!0);r(this,"maxAdhesion",35);r(this,"maxClimbSpeed",3);r(this,"preventWalkOff",!0);r(this,"horizontalClimb",!1);r(this,"hangDistance",.5);r(this,"dismountSuppressedUntilRelease",!1);r(this,"climbSuppressedUntilRelease",!1);r(this,"isDismountFreefall",!1);r(this,"wasClimbHeldLastTick",!1);(t==null?void 0:t.maxAdhesion)!==void 0&&(this.maxAdhesion=t.maxAdhesion),(t==null?void 0:t.maxClimbSpeed)!==void 0&&(this.maxClimbSpeed=t.maxClimbSpeed),(t==null?void 0:t.preventWalkOff)!==void 0&&(this.preventWalkOff=t.preventWalkOff),(t==null?void 0:t.horizontalClimb)!==void 0&&(this.horizontalClimb=t.horizontalClimb),(t==null?void 0:t.hangDistance)!==void 0&&(this.hangDistance=t.hangDistance)}get climbSuppressedUntilRePress(){return this.isDismountFreefall||this.climbSuppressedUntilRelease}set climbSuppressedUntilRePress(t){this.isDismountFreefall=t,this.climbSuppressedUntilRelease=t}update(t,i,s,e,l){const n=s&&!this.wasClimbHeldLastTick;if(this.wasClimbHeldLastTick=s,s||(this.dismountSuppressedUntilRelease=!1,this.climbSuppressedUntilRelease=!1),(t.position.z<=.01||n)&&(this.isDismountFreefall=!1),this.climbSuppressedUntilRelease||!this.enabled||!t.hasVerticalPosition||!t.hasStrength||t.strength<=0)return t.isClimbing=!1,!1;const o=t.hasCollider?t.colliderRadius:.44,a=Math.hypot(i.x,i.y),d=a>=.05,c=d?i.x/a:0,u=d?i.y/a:0;if(!t.isClimbing&&(t.standingWall!==null||t.position.z>=l.wallHeight))return t.isClimbing=!1,!1;let b=null,g=1/0,v=0,m=0,x=0;for(const k of l.walls){const S=Math.max(k.x,Math.min(t.position.x,k.x+k.width)),L=Math.max(k.y,Math.min(t.position.y,k.y+k.height)),W=S-t.position.x,O=L-t.position.y,$=Math.hypot(W,O);$<=o+.15&&$<g&&(g=$,b=k,v=d?c*W+u*O:0,m=W,x=O)}if(!b)return t.isClimbing=!1,!1;const p=t.mass;if(p*l.gravity>this.maxAdhesion)return t.isClimbing=!1,!1;const M=t.isClimbing;if(M&&t.position.z<b.wallHeight){const k=g>.001?m/g:0,S=g>.001?x/g:0,L=-S,W=k,O=d?c*k+u*S:0,$=d?c*L+u*W:0;if(d&&(O<-.3||!this.horizontalClimb&&v<-.1))return t.isClimbing=!1,t.velocity.x=c*3,t.velocity.y=u*3,s&&(this.climbSuppressedUntilRelease=!0),!1;if(t.isClimbing=!0,t.verticalVelocity=0,t.standingWall=null,this.horizontalClimb&&d&&Math.abs($)>=.1){const D=t.baseMass,T=Math.max(.5,Math.min(this.maxClimbSpeed,this.maxClimbSpeed*D*t.strength/Math.max(.1,p)));t.velocity.x=L*$*T,t.velocity.y=W*$*T}else t.velocity.x=0,t.velocity.y=0;if(s){const D=t.baseMass,T=Math.max(.2,Math.min(this.maxClimbSpeed,this.maxClimbSpeed*D*t.strength/Math.max(.1,p)));if(t.position.z+=T*e,t.position.z>=b.wallHeight){t.position.z=b.wallHeight,t.supportingSurfaceHeight=b.wallHeight,t.standingWall=b,t.verticalVelocity=0,t.isClimbing=!1,this.dismountSuppressedUntilRelease=!0;const G=g>.001?m/g:d?c:Math.cos(t.facingAngle),U=g>.001?x/g:d?u:Math.sin(t.facingAngle);d?(t.velocity.x=c*3.5,t.velocity.y=u*3.5):(t.velocity.x=G*1.5,t.velocity.y=U*1.5)}}return!0}if(!M&&t.position.z>.05&&t.position.z<b.wallHeight)return n?(t.isClimbing=!0,t.verticalVelocity=0,t.velocity.x=0,t.velocity.y=0,!0):(t.isClimbing=!1,!1);if(s&&d&&v>.01&&t.position.z<b.wallHeight){t.isClimbing=!0,t.verticalVelocity=0,t.velocity.x=0,t.velocity.y=0;const k=t.baseMass,S=Math.max(.2,Math.min(this.maxClimbSpeed,this.maxClimbSpeed*k*t.strength/Math.max(.1,p)));return t.position.z+=S*e,!0}return t.isClimbing=!1,!1}}class St{constructor(t={}){r(this,"id","strength");r(this,"name","Strength Module");r(this,"enabled",!0);r(this,"strength",1);this.strength=t.strength??1,this.enabled=t.enabled??!0}}class Mt extends tt{constructor(i={}){super({name:"Player Character",position:{x:i.x??5,y:i.y??7,z:0},mass:i.mass??1.2,colliderRadius:i.colliderRadius??.44,color:i.color??"#f59e0b",bounceMod:.1});r(this,"strengthModule");r(this,"facingAngle");r(this,"heldObject");r(this,"isCharacter",!0);r(this,"isActivelyWalking",!1);r(this,"isClimbInputHeld",!1);r(this,"baseMass",1.2);r(this,"walkingModule");r(this,"pickupModule");r(this,"throwModule");r(this,"climbingModule");r(this,"isAiming");r(this,"aimTarget");r(this,"activeTrajectory");this.baseMass=i.mass??1.2,this.strength=i.strength??1,this.facingAngle=0,this.heldObject=null,this.isAiming=!1,this.aimTarget=null,this.activeTrajectory=null,this.strengthModule=new St({strength:i.strength??1}),this.walkingModule=new Ct,this.pickupModule=new Rt,this.throwModule=new Pt,this.climbingModule=new Wt}get hasStrength(){return!!(this.strengthModule&&this.strengthModule.enabled&&this.strengthModule.strength>0)}get strength(){return this.hasStrength?this.strengthModule.strength:0}set strength(i){this.strengthModule?this.strengthModule.strength=Math.max(.1,i):this.strengthModule=new St({strength:i})}get mass(){const i=this.hasMass?this.baseMass:0,s=this.heldObject&&this.heldObject.hasMass?this.heldObject.mass:0;return i+s}set mass(i){this.baseMass=Math.max(.1,i),this.massModule&&(this.massModule.mass=this.baseMass)}get carriedMass(){return this.heldObject&&this.heldObject.hasMass?this.heldObject.mass:0}get hangDistance(){return this.climbingModule?this.climbingModule.hangDistance:.5}set hangDistance(i){this.climbingModule&&(this.climbingModule.hangDistance=Math.max(0,i))}updateFacingDirection(i,s,e){if((this.heldObject!==null||i)&&s&&(this.throwModule!==null||this.pickupModule!==null)){const l=s.x-this.position.x,n=s.y-this.position.y;if(Math.hypot(l,n)>.1){this.facingAngle=Math.atan2(n,l);return}}e&&Math.hypot(e.x,e.y)>.05&&(this.facingAngle=Math.atan2(e.y,e.x))}updateCharacter(i,s,e,l,n,o=!1){if(this.isClimbInputHeld=o,this.climbingModule&&this.climbingModule.update(this,s,o,i,n),this.walkingModule&&this.walkingModule.update(this,s,i,n),this.updatePosition(i,n),this.updateFacingDirection(e,l,s),this.heldObject){const a=this.colliderRadius+this.heldObject.colliderRadius*.5+.08;this.heldObject.position.x=this.position.x+Math.cos(this.facingAngle)*a,this.heldObject.position.y=this.position.y+Math.sin(this.facingAngle)*a,this.heldObject.position.z=this.heldObject.hasVerticalPosition?this.position.z+.45:0,this.heldObject.velocity.x=this.velocity.x,this.heldObject.velocity.y=this.velocity.y,this.heldObject.verticalVelocity=0}this.isAiming=this.heldObject!==null||e,this.aimTarget=l,this.heldObject&&this.throwModule&&l?this.activeTrajectory=this.throwModule.calculateTrajectory(this,l.x,l.y,n):this.activeTrajectory=null}}class mt{constructor(t={}){r(this,"enabled",!0);r(this,"angularVelocity",{x:0,y:0,z:0});r(this,"rollResistance",.4);r(this,"visualPhase",0);var i,s,e;this.enabled=t.enabled??!0,this.angularVelocity={x:((i=t.angularVelocity)==null?void 0:i.x)??0,y:((s=t.angularVelocity)==null?void 0:s.y)??0,z:((e=t.angularVelocity)==null?void 0:e.z)??0},this.rollResistance=t.rollResistance??.4}get angularSpeed(){return Math.hypot(this.angularVelocity.x,this.angularVelocity.y,this.angularVelocity.z)}updateVisualPhase(t){const i=this.angularSpeed;i>.001&&(this.visualPhase=(this.visualPhase+i*t)%(Math.PI*2))}}class Dt{constructor(t){r(this,"ctx");this.ctx=t}render(t,i,s,e,l=!1,n,o,a=!1,d){const c=this.ctx,u=c.canvas.width/t.width;c.clearRect(0,0,c.canvas.width,c.canvas.height),this.drawFloorGrid(t,u),this.drawWalls(t,u),a&&d&&this.drawWallEditorHover(t,d,u);const b=[i,...s];b.sort((g,v)=>Math.abs(g.position.z-v.position.z)>.001?g.position.z-v.position.z:Math.abs(g.verticalVelocity-v.verticalVelocity)>.001?g.verticalVelocity-v.verticalVelocity:g.position.y-v.position.y);for(const g of b)g instanceof Mt?this.drawCharacter(g,s,u):this.drawFreebodyObject(g,b,i,u,g===o,t.wallHeight);for(const g of b)this.drawObjectShadow(g,t,u);i.activeTrajectory&&this.drawTrajectory(i.activeTrajectory,u),l&&(n&&n!==e&&this.drawHoverGizmo(n,u),e&&this.drawSelectionGizmo(e,l,u))}drawFloorGrid(t,i){const s=this.ctx;s.fillStyle="#0f172a",s.fillRect(0,0,t.width*i,t.height*i),s.strokeStyle="rgba(148, 163, 184, 0.08)",s.lineWidth=1;for(let e=1;e<t.width;e++)s.beginPath(),s.moveTo(e*i,0),s.lineTo(e*i,t.height*i),s.stroke();for(let e=1;e<t.height;e++)s.beginPath(),s.moveTo(0,e*i),s.lineTo(t.width*i,e*i),s.stroke();s.strokeStyle="rgba(148, 163, 184, 0.35)",s.lineWidth=3,s.strokeRect(1.5,1.5,t.width*i-3,t.height*i-3)}drawWalls(t,i){const s=this.ctx;for(const e of t.walls)s.fillStyle="#1e293b",s.fillRect(e.x*i,e.y*i,e.width*i,e.height*i),s.strokeStyle="#475569",s.lineWidth=2,s.strokeRect(e.x*i,e.y*i,e.width*i,e.height*i)}drawWallEditorHover(t,i,s){if(i.col<0||i.col>=t.cols||i.row<0||i.row>=t.rows)return;const e=this.ctx,l=i.col*t.tileSize*s,n=i.row*t.tileSize*s,o=t.tileSize*s,a=t.hasWall(i.col,i.row);e.save(),a?(e.fillStyle="rgba(239, 68, 68, 0.35)",e.strokeStyle="#ef4444",e.lineWidth=2.5,e.fillRect(l,n,o,o),e.strokeRect(l,n,o,o),e.font="bold 12px system-ui, sans-serif",e.fillStyle="#fca5a5",e.textAlign="center",e.textBaseline="middle",e.fillText("✕ Erase",l+o/2,n+o/2)):(e.fillStyle="rgba(56, 189, 248, 0.3)",e.strokeStyle="#38bdf8",e.lineWidth=2.5,e.fillRect(l,n,o,o),e.strokeRect(l,n,o,o),e.font="bold 12px system-ui, sans-serif",e.fillStyle="#7dd3fc",e.textAlign="center",e.textBaseline="middle",e.fillText("+ Draw",l+o/2,n+o/2)),e.restore()}drawObjectShadow(t,i,s){const e=this.ctx,l=t.position.x*s,n=t.position.y*s,o=t.position.z,a=1+o/i.wallHeight*1.5,d=t.colliderRadius*s*a,c=Math.max(.3,.85-o/(i.wallHeight*7)*.25),u=o>=i.wallHeight-.001;if(e.save(),e.beginPath(),t.visualShape==="box"){const b=d*2,g=Math.max(3,4*a);e.roundRect?e.roundRect(l-d,n-d,b,b,g):e.rect(l-d,n-d,b,b)}else e.arc(l,n,d,0,Math.PI*2);u?(e.strokeStyle=`rgba(56, 189, 248, ${c})`,e.lineWidth=2.5):(e.strokeStyle=`rgba(255, 255, 255, ${c})`,e.lineWidth=1.8),o>.01&&e.setLineDash([4,3]),e.stroke(),e.restore()}drawFreebodyObject(t,i,s,e,l=!1,n=1){var m,x;const o=this.ctx,a=t.position.x*e,d=t.position.y*e,u=(t.hasCollider?t.colliderRadius:((m=t.colliderModule)==null?void 0:m.radius)??.32)*e,g=!s.heldObject&&s.pickupModule!==null&&s.pickupModule.enabled&&!t.isHeld&&(((x=s.pickupModule)==null?void 0:x.isObjectInReach(s,t,n))??!1);if(g){if(o.save(),o.beginPath(),t.visualShape==="box"){const p=(u+5)*2;o.roundRect?o.roundRect(a-u-5,d-u-5,p,p,6):o.rect(a-u-5,d-u-5,p,p)}else o.arc(a,d,u+5,0,Math.PI*2);l?(o.strokeStyle="#38bdf8",o.lineWidth=3,o.setLineDash([]),o.stroke(),o.fillStyle="#38bdf8",o.font="bold 11px sans-serif",o.textAlign="center",o.fillText("GRAB",a,d-u-8)):(o.strokeStyle="rgba(56, 189, 248, 0.45)",o.lineWidth=1.8,o.setLineDash([4,4]),o.stroke()),o.restore()}let v=!1;if(t.isAboveGround)for(const p of i){if(p===t)continue;if(Math.hypot(t.position.x-p.position.x,t.position.y-p.position.y)<t.colliderRadius+p.colliderRadius&&(t.position.z>p.position.z||Math.abs(t.position.z-p.position.z)<=.01&&t.verticalVelocity>p.verticalVelocity)){v=!0;break}}if(o.save(),o.globalAlpha=v?.55:1,t.visualShape==="box"){const p=u*2,f=Math.max(3,u*.16),M=a-u,k=d-u;o.beginPath(),o.roundRect?o.roundRect(M,k,p,p,f):o.rect(M,k,p,p),o.fillStyle=t.color,o.fill(),o.strokeStyle=g?"#ffffff":"rgba(255, 255, 255, 0.45)",o.lineWidth=g?2.5:2,o.stroke();const S=Math.max(3,u*.22);o.beginPath(),o.roundRect?o.roundRect(M+S,k+S,p-S*2,p-S*2,f*.7):o.rect(M+S,k+S,p-S*2,p-S*2),o.strokeStyle="rgba(0, 0, 0, 0.25)",o.lineWidth=1.6,o.stroke(),o.beginPath(),o.moveTo(M+S,k+S),o.lineTo(M+p-S,k+p-S),o.moveTo(M+p-S,k+S),o.lineTo(M+S,k+p-S),o.strokeStyle="rgba(0, 0, 0, 0.16)",o.lineWidth=1.4,o.stroke()}else o.beginPath(),o.arc(a,d,u,0,Math.PI*2),o.fillStyle=t.color,o.fill(),o.strokeStyle=g?"#ffffff":"rgba(255, 255, 255, 0.45)",o.lineWidth=g?2.5:2,o.stroke();this.drawRollIndicator(t,a,d,u),o.restore()}drawCharacter(t,i,s){const e=this.ctx,l=t.position.x*s,n=t.position.y*s,o=t.colliderRadius*s;let a=!1;if(t.isAboveGround)for(const f of i){if(f===t)continue;if(Math.hypot(t.position.x-f.position.x,t.position.y-f.position.y)<t.colliderRadius+f.colliderRadius&&(t.position.z>f.position.z||Math.abs(t.position.z-f.position.z)<=.01&&t.verticalVelocity>f.verticalVelocity)){a=!0;break}}e.save(),e.globalAlpha=a?.55:1,e.beginPath(),e.arc(l,n,o,0,Math.PI*2),e.fillStyle=t.color,e.fill(),e.strokeStyle="#ffffff",e.lineWidth=2.5,e.stroke(),this.drawRollIndicator(t,l,n,o);const d=.52,c=o*.72,u=Math.max(3.5,o*.18),b=t.facingAngle-d,g=t.facingAngle+d,v=l+Math.cos(b)*c,m=n+Math.sin(b)*c,x=l+Math.cos(g)*c,p=n+Math.sin(g)*c;e.fillStyle="#000000",e.beginPath(),e.arc(v,m,u,0,Math.PI*2),e.arc(x,p,u,0,Math.PI*2),e.fill(),t.heldObject&&(e.strokeStyle="rgba(255, 255, 255, 0.6)",e.setLineDash([3,3]),e.lineWidth=1.5,e.beginPath(),e.moveTo(l,n),e.lineTo(t.heldObject.position.x*s,t.heldObject.position.y*s),e.stroke(),e.setLineDash([])),e.restore()}drawRollIndicator(t,i,s,e){if(!t.rollModule||!t.rollModule.enabled)return;const l=t.rollModule,n=l.angularVelocity.x,o=l.angularVelocity.y,a=l.angularVelocity.z,d=Math.hypot(n,o,a);if(d<.02)return;const c=this.ctx,b=Math.hypot(n,o)<.05*d;if(c.save(),b){const g=e*.45,v=e*.78;c.beginPath(),c.arc(i,s,g,0,Math.PI*2),c.strokeStyle="rgba(255, 255, 255, 0.45)",c.lineWidth=1.5,c.setLineDash([]),c.stroke(),c.beginPath(),c.arc(i,s,v,0,Math.PI*2),c.strokeStyle="rgba(255, 255, 255, 0.95)",c.lineWidth=2,c.setLineDash([4,4]),c.lineDashOffset=-l.visualPhase*v*Math.sign(a||1),c.stroke()}else{const g=Math.atan2(-n,o),v=e*.82,m=Math.abs(a)/d,x=v*Math.pow(m,.85);c.translate(i,s),c.rotate(g);const p=a!==0?Math.sign(a):1;x<.5?(c.beginPath(),c.moveTo(-v,0),c.lineTo(v,0),c.strokeStyle="rgba(255, 255, 255, 0.95)",c.lineWidth=2.2,c.setLineDash([4,4]),c.lineDashOffset=-l.visualPhase*v,c.stroke()):(c.beginPath(),c.ellipse(0,0,v,x,0,0,Math.PI),c.strokeStyle="rgba(255, 255, 255, 0.95)",c.lineWidth=2.2,c.setLineDash([4,4]),c.lineDashOffset=-l.visualPhase*v*p,c.stroke(),c.beginPath(),c.ellipse(0,0,v,x,0,Math.PI,Math.PI*2),c.strokeStyle="rgba(255, 255, 255, 0.25)",c.lineWidth=1.8,c.setLineDash([4,4]),c.lineDashOffset=-l.visualPhase*v*p,c.stroke())}c.restore()}drawTrajectory(t,i){const s=this.ctx,e=t.points;if(e.length<2)return;s.save();for(let n=0;n<e.length-1;n++){const o=e[n],a=e[n+1];s.beginPath(),s.moveTo(o.x*i,o.y*i),s.lineTo(a.x*i,a.y*i),o.couldClearWall||a.couldClearWall?(s.strokeStyle="#38bdf8",s.lineWidth=4,s.setLineDash([6,3])):(s.strokeStyle="#f59e0b",s.lineWidth=2.5,s.setLineDash([4,4])),s.stroke()}const l=e[e.length-1];if(t.isBlockedByWall){s.strokeStyle="#ef4444",s.lineWidth=3,s.setLineDash([]);const n=8;s.beginPath(),s.moveTo(l.x*i-n,l.y*i-n),s.lineTo(l.x*i+n,l.y*i+n),s.moveTo(l.x*i+n,l.y*i-n),s.lineTo(l.x*i-n,l.y*i+n),s.stroke()}else t.isLandingOnWallTop?(s.strokeStyle="#38bdf8",s.fillStyle="rgba(56, 189, 248, 0.35)",s.lineWidth=2.5,s.setLineDash([]),s.beginPath(),s.arc(t.landPoint.x*i,t.landPoint.y*i,14,0,Math.PI*2),s.fill(),s.stroke(),s.beginPath(),s.arc(t.landPoint.x*i,t.landPoint.y*i,4,0,Math.PI*2),s.fillStyle="#38bdf8",s.fill()):(s.strokeStyle="#22c55e",s.fillStyle="rgba(34, 197, 94, 0.25)",s.lineWidth=2,s.setLineDash([]),s.beginPath(),s.arc(t.landPoint.x*i,t.landPoint.y*i,14,0,Math.PI*2),s.fill(),s.stroke(),s.beginPath(),s.arc(t.landPoint.x*i,t.landPoint.y*i,4,0,Math.PI*2),s.fillStyle="#22c55e",s.fill());s.restore()}drawHoverGizmo(t,i){var a;const s=this.ctx,e=t.position.x*i,l=t.position.y*i,o=((t.hasCollider?t.colliderRadius:((a=t.colliderModule)==null?void 0:a.radius)??.32)+.08)*i;s.save(),s.strokeStyle="rgba(251, 191, 36, 0.6)",s.lineWidth=1.5,s.setLineDash([4,4]),s.beginPath(),s.arc(e,l,o,0,Math.PI*2),s.stroke(),s.restore()}drawSelectionGizmo(t,i,s){var b;const e=this.ctx,l=t.position.x*s,n=t.position.y*s,d=(t.hasCollider?t.colliderRadius:((b=t.colliderModule)==null?void 0:b.radius)??.32)*s+6,c=Math.max(6,d*.4),u=i?"#fbbf24":"#38bdf8";if(e.save(),e.strokeStyle=u,e.lineWidth=2,e.setLineDash([]),e.beginPath(),e.moveTo(l-d,n-d+c),e.lineTo(l-d,n-d),e.lineTo(l-d+c,n-d),e.stroke(),e.beginPath(),e.moveTo(l+d-c,n-d),e.lineTo(l+d,n-d),e.lineTo(l+d,n-d+c),e.stroke(),e.beginPath(),e.moveTo(l+d,n+d-c),e.lineTo(l+d,n+d),e.lineTo(l+d-c,n+d),e.stroke(),e.beginPath(),e.moveTo(l-d+c,n+d),e.lineTo(l-d,n+d),e.lineTo(l-d,n+d-c),e.stroke(),i){const g=`${t.name} (${t.mass.toFixed(1)}kg)`;e.font="bold 10px 'Segoe UI', system-ui, sans-serif";const m=e.measureText(g).width+12,x=16,p=l-m/2,f=n-d-x-4;e.fillStyle="rgba(15, 23, 42, 0.85)",e.strokeStyle=u,e.lineWidth=1,e.beginPath(),e.roundRect(p,f,m,x,4),e.fill(),e.stroke(),e.fillStyle=u,e.textAlign="center",e.textBaseline="middle",e.fillText(g,l,f+x/2)}e.restore()}}class zt{constructor(t,i){r(this,"canvas");r(this,"arena");r(this,"keysPressed",new Set);r(this,"mousePos",{x:0,y:0});r(this,"isMouseDown",!1);r(this,"isRightMouseDown",!1);r(this,"hoverWallTile",null);r(this,"movementVector",{x:0,y:0});r(this,"justPickedUp",!1);r(this,"isThrowingPress",!1);r(this,"hoverEntity",null);r(this,"selectedCanvasEntity",null);r(this,"draggedEntity",null);r(this,"dragOffset",{x:0,y:0});r(this,"handleClick");r(this,"onMouseDown");r(this,"onRightMouseDown");r(this,"onMouseUp");r(this,"onRightClick");r(this,"onDropAttempt");r(this,"onMouseMove");this.canvas=t,this.arena=i,this.setupListeners()}get isGrabHeld(){return!this.isThrowingPress&&this.isMouseDown}get isClimbHeld(){return this.keysPressed.has("Space")}setupListeners(){window.addEventListener("keydown",t=>{this.keysPressed.add(t.code),this.updateMovementVector(),t.code==="KeyE"&&this.onDropAttempt&&this.onDropAttempt()}),window.addEventListener("keyup",t=>{this.keysPressed.delete(t.code),this.updateMovementVector()}),this.canvas.addEventListener("mousemove",t=>{this.updateMousePos(t),this.onMouseMove&&this.onMouseMove(this.mousePos.x,this.mousePos.y)}),this.canvas.addEventListener("mousedown",t=>{if(this.updateMousePos(t),t.button===2){this.isRightMouseDown=!0,this.onRightMouseDown&&this.onRightMouseDown(this.mousePos.x,this.mousePos.y);return}t.button===0&&(this.isMouseDown=!0,this.onMouseDown&&this.onMouseDown(this.mousePos.x,this.mousePos.y),this.handleClick&&this.handleClick(this.mousePos.x,this.mousePos.y))}),this.canvas.addEventListener("contextmenu",t=>{t.preventDefault(),this.updateMousePos(t),this.onRightClick&&this.onRightClick(this.mousePos.x,this.mousePos.y)}),window.addEventListener("mouseup",t=>{if(t.button===2){this.isRightMouseDown=!1;return}t.button===0&&(this.isMouseDown=!1,this.justPickedUp=!1,this.isThrowingPress=!1,this.onMouseUp&&this.onMouseUp(this.mousePos.x,this.mousePos.y))}),this.canvas.addEventListener("touchstart",t=>{t.touches.length>0&&(this.isMouseDown=!0,this.updateTouchPos(t.touches[0]),this.onMouseDown&&this.onMouseDown(this.mousePos.x,this.mousePos.y),this.handleClick&&this.handleClick(this.mousePos.x,this.mousePos.y))},{passive:!1}),this.canvas.addEventListener("touchmove",t=>{t.touches.length>0&&(this.updateTouchPos(t.touches[0]),this.onMouseMove&&this.onMouseMove(this.mousePos.x,this.mousePos.y))},{passive:!1}),window.addEventListener("touchend",()=>{this.isMouseDown=!1,this.justPickedUp=!1,this.isThrowingPress=!1,this.onMouseUp&&this.onMouseUp(this.mousePos.x,this.mousePos.y)})}updateMousePos(t){const i=this.canvas.getBoundingClientRect(),s=this.arena.width/i.width,e=this.arena.height/i.height;this.mousePos.x=(t.clientX-i.left)*s,this.mousePos.y=(t.clientY-i.top)*e}updateTouchPos(t){const i=this.canvas.getBoundingClientRect(),s=this.arena.width/i.width,e=this.arena.height/i.height;this.mousePos.x=(t.clientX-i.left)*s,this.mousePos.y=(t.clientY-i.top)*e}updateMovementVector(){let t=0,i=0;(this.keysPressed.has("KeyW")||this.keysPressed.has("ArrowUp"))&&(i-=1),(this.keysPressed.has("KeyS")||this.keysPressed.has("ArrowDown"))&&(i+=1),(this.keysPressed.has("KeyA")||this.keysPressed.has("ArrowLeft"))&&(t-=1),(this.keysPressed.has("KeyD")||this.keysPressed.has("ArrowRight"))&&(t+=1);const s=Math.hypot(t,i);s>0?(this.movementVector.x=t/s,this.movementVector.y=i/s):(this.movementVector.x=0,this.movementVector.y=0)}handleInteractions(t,i,s,e){e&&(this.selectedCanvasEntity=e.selectedEntity);const l=(a,d,c=.35)=>{var g;for(let v=s.length-1;v>=0;v--){const m=s[v],x=m.hasCollider?m.colliderRadius:((g=m.colliderModule)==null?void 0:g.radius)??.32;if(Math.hypot(m.position.x-a,m.position.y-d)<=x+c)return m}const u=t.hasCollider?t.colliderRadius:.44;return Math.hypot(t.position.x-a,t.position.y-d)<=u+c?t:null},n=(a,d)=>{var u;if(a<0||a>=i.cols||d<0||d>=i.rows)return;if(i.setWallTile(a,d,!0)){const b={id:`wall-${a}-${d}`,x:a*i.tileSize,y:d*i.tileSize,width:i.tileSize,height:i.tileSize,wallHeight:i.wallHeight},g=[t,...s];for(const v of g){const m=v.hasCollider?v.colliderRadius:((u=v.colliderModule)==null?void 0:u.radius)??.32;i.testWallOverlap(v.position.x,v.position.y,m,b)&&v.position.z<i.wallHeight&&(v.hasVerticalPosition||(v.verticalPositionModule?v.verticalPositionModule.enabled=!0:v.verticalPositionModule=new rt({z:i.wallHeight,hasVerticalVelocity:!0})),v.position.z=i.wallHeight,v.supportingSurfaceHeight=i.wallHeight,v.verticalVelocity=0)}i.currentPresetId="custom",e==null||e.updateWallPresetUI()}},o=(a,d)=>{a<0||a>=i.cols||d<0||d>=i.rows||i.tileGrid[d][a]===1&&(i.setWallTile(a,d,!1),i.currentPresetId="custom",e==null||e.updateWallPresetUI())};this.onMouseDown=(a,d)=>{if(e!=null&&e.isEditMode){if(e.editTool==="walls"){const u=Math.floor(a/i.tileSize),b=Math.floor(d/i.tileSize);n(u,b);return}const c=l(a,d,.35);c?(this.selectedCanvasEntity=c,e.setSelectedEntity(c),this.draggedEntity=c,this.dragOffset.x=c.position.x-a,this.dragOffset.y=c.position.y-d,this.canvas.style.cursor="grabbing"):(this.selectedCanvasEntity=null,this.draggedEntity=null)}},this.onRightMouseDown=(a,d)=>{if(e!=null&&e.isEditMode&&e.editTool==="walls"){const c=Math.floor(a/i.tileSize),u=Math.floor(d/i.tileSize);o(c,u)}},this.onMouseMove=(a,d)=>{var b;const c=Math.floor(a/i.tileSize),u=Math.floor(d/i.tileSize);if(c>=0&&c<i.cols&&u>=0&&u<i.rows?this.hoverWallTile={col:c,row:u}:this.hoverWallTile=null,e!=null&&e.isEditMode){if(e.editTool==="walls"){this.hoverEntity=null,this.draggedEntity=null,this.canvas.style.cursor="cell",this.isMouseDown&&this.hoverWallTile?n(this.hoverWallTile.col,this.hoverWallTile.row):this.isRightMouseDown&&this.hoverWallTile&&o(this.hoverWallTile.col,this.hoverWallTile.row);return}if(this.isMouseDown&&this.draggedEntity){const g=a+this.dragOffset.x,v=d+this.dragOffset.y,m=this.draggedEntity.hasCollider?this.draggedEntity.colliderRadius:((b=this.draggedEntity.colliderModule)==null?void 0:b.radius)??.32;this.draggedEntity.position.x=Math.max(m,Math.min(i.width-m,g)),this.draggedEntity.position.y=Math.max(m,Math.min(i.height-m,v)),this.draggedEntity.velocity.x=0,this.draggedEntity.velocity.y=0,this.draggedEntity.verticalVelocity=0,this.draggedEntity.rollModule&&(this.draggedEntity.rollModule.angularVelocity.x=0,this.draggedEntity.rollModule.angularVelocity.y=0,this.draggedEntity.rollModule.angularVelocity.z=0),this.canvas.style.cursor="grabbing"}else{const g=l(a,d,.3);this.hoverEntity=g,this.canvas.style.cursor=g?"grab":"crosshair"}}else this.hoverEntity=null,this.draggedEntity=null,this.canvas.style.cursor="default"},this.onMouseUp=(a,d)=>{if(this.draggedEntity&&(i.syncEntitiesWithWalls([this.draggedEntity]),this.draggedEntity=null),e!=null&&e.isEditMode)if(e.editTool==="walls")this.canvas.style.cursor="cell";else{const c=l(this.mousePos.x,this.mousePos.y,.3);this.hoverEntity=c,this.canvas.style.cursor=c?"grab":"crosshair"}},this.handleClick=(a,d)=>{if(!(e!=null&&e.isEditMode)){if(t.heldObject&&t.throwModule&&!this.justPickedUp){t.throwModule.throwHeldObject(t,a,d,i),this.isThrowingPress=!0;return}if(!t.heldObject&&t.pickupModule){const c=t.pickupModule.findTargetObject(t,a,d,s,i.wallHeight);c&&(t.pickupModule.pickup(t,c),this.justPickedUp=!0)}}},this.onRightClick=(a,d)=>{if(e!=null&&e.isEditMode&&e.editTool==="walls"||!e)return;const c=l(a,d,.4);c&&(this.selectedCanvasEntity=c,e.setSelectedEntity(c))},this.onDropAttempt=()=>{if(t.heldObject&&t.pickupModule)t.pickupModule.drop(t)&&(this.isThrowingPress=!0);else if(!t.heldObject&&t.pickupModule){const a=t.pickupModule.findTargetObject(t,this.mousePos.x,this.mousePos.y,s,i.wallHeight);a&&t.pickupModule.pickup(t,a)}}}}class Bt{constructor(t){r(this,"container");r(this,"character");r(this,"arena");r(this,"objects");r(this,"onSpawnObject");r(this,"onDeleteObject");r(this,"onClearObjects");r(this,"selectedEntity");r(this,"isEditMode",!1);r(this,"editTool","entities");r(this,"onSelectionChange");r(this,"creatorState",{name:"Custom Box",visualShape:"box",color:"#38bdf8",hasCollider:!0,colliderRadius:.3,hasMass:!0,mass:1,hasFriction:!0,staticFrictionMod:1,dynamicFrictionMod:1,hasBounce:!0,bounceMod:.2,verticalBounce:!0,hasVerticalPosition:!0,elevation:.1,hasVerticalVelocity:!0,hasGravity:!0,hasRollModule:!1,rollResistance:.4});r(this,"presets",{"Light Blue Box":{name:"Light Blue Box",visualShape:"box",color:"#38bdf8",hasCollider:!0,colliderRadius:.26,hasMass:!0,mass:.7,hasFriction:!0,staticFrictionMod:1,dynamicFrictionMod:1,hasBounce:!0,bounceMod:.25,verticalBounce:!0,hasVerticalPosition:!0,elevation:.1,hasVerticalVelocity:!0,hasGravity:!0,hasRollModule:!1,rollResistance:.4},"Heavy Red Box":{name:"Heavy Red Box",visualShape:"box",color:"#f87171",hasCollider:!0,colliderRadius:.4,hasMass:!0,mass:2.6,hasFriction:!0,staticFrictionMod:1.2,dynamicFrictionMod:1.2,hasBounce:!1,bounceMod:.05,verticalBounce:!1,hasVerticalPosition:!0,elevation:.1,hasVerticalVelocity:!0,hasGravity:!0,hasRollModule:!1,rollResistance:.4},"Bouncy Ball":{name:"Super Bouncy Ball",visualShape:"circle",color:"#4ade80",hasCollider:!0,colliderRadius:.24,hasMass:!0,mass:.5,hasFriction:!0,staticFrictionMod:.8,dynamicFrictionMod:.8,hasBounce:!0,bounceMod:.88,verticalBounce:!0,hasVerticalPosition:!0,elevation:.6,hasVerticalVelocity:!0,hasGravity:!0,hasRollModule:!1,rollResistance:.4},"Rolling Ball":{name:"Rolling Ball",visualShape:"circle",color:"#a855f7",hasCollider:!0,colliderRadius:.28,hasMass:!0,mass:.6,hasFriction:!0,staticFrictionMod:.5,dynamicFrictionMod:.5,hasBounce:!0,bounceMod:.95,verticalBounce:!0,hasVerticalPosition:!0,elevation:.1,hasVerticalVelocity:!0,hasGravity:!0,hasRollModule:!0,rollResistance:0},"Ghost Box":{name:"Ghost Box (No Collider)",visualShape:"box",color:"#94a3b8",hasCollider:!1,colliderRadius:.3,hasMass:!1,mass:0,hasFriction:!1,staticFrictionMod:0,dynamicFrictionMod:0,hasBounce:!1,bounceMod:0,verticalBounce:!1,hasVerticalPosition:!1,elevation:0,hasVerticalVelocity:!1,hasGravity:!1,hasRollModule:!1,rollResistance:0}});r(this,"inspectorEl");r(this,"entitySelectorEl");r(this,"characterSpecificControlsEl");r(this,"objectSpecificControlsEl");r(this,"modePlayBtn");r(this,"modeEditBtn");this.container=t.container,this.character=t.character,this.arena=t.arena,this.objects=t.objects,this.onSpawnObject=t.onSpawnObject,this.onDeleteObject=t.onDeleteObject,this.onClearObjects=t.onClearObjects,this.selectedEntity=this.character,this.renderPanel()}setSelectedEntity(t){var i;this.selectedEntity=t,this.updateSelectorOptions(),this.syncEntitySliders(),(i=this.onSelectionChange)==null||i.call(this,t)}setMode(t){this.isEditMode=t,this.modePlayBtn&&this.modeEditBtn&&(this.isEditMode?(this.modePlayBtn.classList.remove("active-play"),this.modeEditBtn.classList.add("active-edit")):(this.modePlayBtn.classList.add("active-play"),this.modeEditBtn.classList.remove("active-edit")));const i=this.container.querySelector("#edit-submode-container");i&&(i.style.display=this.isEditMode?"flex":"none"),this.updateToolVisibility()}setEditTool(t){this.editTool=t;const i=this.container.querySelector("#submode-entities"),s=this.container.querySelector("#submode-walls");i&&s&&(i.classList.toggle("active",t==="entities"),s.classList.toggle("active",t==="walls")),this.updateToolVisibility()}updateToolVisibility(){const t=this.container.querySelector("#wall-editor-section");t&&(t.style.display=this.isEditMode&&this.editTool==="walls"?"block":"none");const i=this.container.querySelector("#edit-hint-label");i&&(this.isEditMode?this.editTool==="walls"?i.textContent="Left-drag: Draw | Right-drag: Erase":i.textContent="Click & drag object in arena":i.textContent="Right-click in arena to select")}updateSelectorOptions(){if(!this.entitySelectorEl)return;const t=this.selectedEntity.id;let i=`<option value="${this.character.id}" ${t===this.character.id?"selected":""}>⭐ Player Character (${this.character.mass.toFixed(1)}kg)</option>`;for(const e of this.objects){const l=e.id===t?"selected":"",n=e.visualShape==="box"?"📦":"⚪",o=e.hasMass?`${e.mass.toFixed(1)}kg`:"Massless";i+=`<option value="${e.id}" ${l}>${n} ${e.name} (${o})</option>`}this.entitySelectorEl.innerHTML=i;const s=this.selectedEntity===this.character;this.characterSpecificControlsEl&&(this.characterSpecificControlsEl.style.display=s?"flex":"none"),this.objectSpecificControlsEl&&(this.objectSpecificControlsEl.style.display=s?"none":"flex")}renderPanel(){var t,i,s,e,l,n,o,a,d,c,u,b,g,v,m,x,p,f,M,k,S,L,W,O,$,D,T,G,U,I,j,C,y,E,w,V,F,z,P,B,A,R,h,q,X,Y,N,et,gt,it,st,pt,lt,ot,vt,at,nt,bt,ct,Q,Z,K,_,wt,kt,Vt,Et;this.container.innerHTML=`
              ...
              <div id="group-mod-climb" style="display: ${(nt=this.character.climbingModule)!=null&&nt.enabled?"block":"none"};">
                ...
                <div class="slider-group">
                  <div class="slider-label">
                    ...
                    <span id="val-climb-hang">${(((Vt=this.character.climbingModule)==null?void 0:Vt.hangDistance)??.5).toFixed(2)}</span>
                  </div>
                  <input type="range" id="slide-climb-hang" min="0.1" max="1.5" step="0.05" value="${((Et=this.character.climbingModule)==null?void 0:Et.hangDistance)??.5}">
                </div>
              </div>
            </div>
          </div>
    ...
    `,this.inspectorEl=this.container.querySelector("#dev-inspector"),this.entitySelectorEl=this.container.querySelector("#entity-selector"),this.characterSpecificControlsEl=this.container.querySelector("#character-specific-controls"),this.objectSpecificControlsEl=this.container.querySelector("#object-actions-row"),this.modePlayBtn=this.container.querySelector("#mode-play"),this.modeEditBtn=this.container.querySelector("#mode-edit"),this.updateSelectorOptions(),this.bindEvents()}syncEntitySliders(){var V,F,z,P,B,A,R;const t=this.selectedEntity,i=t===this.character,s=this.container.querySelector("#row-visual-shape");s&&(s.style.display=i?"none":"flex");const e=this.container.querySelector("#toggle-entity-shape");e&&(t.visualShape==="box"?(e.textContent="Box 📦",e.classList.add("active")):(e.textContent="Circle ⚪",e.classList.remove("active")));const l=this.container.querySelector("#toggle-mod-collider"),n=this.container.querySelector("#group-mod-collider"),o=this.container.querySelector("#note-mod-collider");l&&(l.textContent=t.hasCollider?"Attached":"Detached",l.classList.toggle("active",t.hasCollider)),n&&(n.style.display=t.hasCollider?"block":"none"),o&&(o.style.display=t.hasCollider?"none":"block"),this.setSliderVal("slide-entity-radius","val-entity-radius",((V=t.colliderModule)==null?void 0:V.radius)??.32,2);const a=this.container.querySelector("#toggle-mod-mass"),d=this.container.querySelector("#group-mod-mass"),c=this.container.querySelector("#note-mod-mass");a&&(a.textContent=t.hasMass?"Attached":"Detached",a.classList.toggle("active",t.hasMass)),d&&(d.style.display=t.hasMass?"block":"none"),c&&(c.style.display=t.hasMass?"none":"block"),this.setSliderVal("slide-entity-mass","val-entity-mass",((F=t.massModule)==null?void 0:F.mass)??1,1);const u=this.container.querySelector("#toggle-mod-friction"),b=this.container.querySelector("#group-mod-friction"),g=this.container.querySelector("#note-mod-friction"),v=this.container.querySelector("#warn-friction-mass"),m=!!(t.frictionModule&&t.frictionModule.enabled);u&&(u.textContent=m?"Attached":"Detached",u.classList.toggle("active",m)),b&&(b.style.display=m?"flex":"none"),g&&(g.style.display=m?"none":"block"),v&&(v.style.display=!t.hasMass&&m?"block":"none"),this.setSliderVal("slide-entity-static-fric","val-entity-static-fric",((z=t.frictionModule)==null?void 0:z.staticFrictionMod)??1,2),this.setSliderVal("slide-entity-dynamic-fric","val-entity-dynamic-fric",((P=t.frictionModule)==null?void 0:P.dynamicFrictionMod)??1,2);const x=this.container.querySelector("#toggle-mod-bounce"),p=this.container.querySelector("#group-mod-bounce"),f=this.container.querySelector("#note-mod-bounce"),M=this.container.querySelector("#warn-bounce-mass"),k=!!(t.bounceModule&&t.bounceModule.enabled);x&&(x.textContent=k?"Attached":"Detached",x.classList.toggle("active",k)),p&&(p.style.display=k?"block":"none"),f&&(f.style.display=k?"none":"block"),M&&(M.style.display=!t.hasMass&&k?"block":"none"),this.setSliderVal("slide-entity-bounce","val-entity-bounce",((B=t.bounceModule)==null?void 0:B.bounceMod)??.4,2);const S=this.container.querySelector("#check-mod-vert-bounce"),L=this.container.querySelector("#warn-bounce-vert-vel");if(S&&(S.checked=!!((A=t.bounceModule)!=null&&A.verticalBounce)),L){const h=!!(k&&((R=t.bounceModule)!=null&&R.verticalBounce)&&!t.hasVerticalVelocity);L.style.display=h?"block":"none"}const W=this.container.querySelector("#toggle-mod-vert-pos"),O=this.container.querySelector("#group-mod-vert-pos"),$=this.container.querySelector("#note-mod-vert-pos"),D=t.hasVerticalPosition;W&&(W.textContent=D?"Attached":"Detached",W.classList.toggle("active",D)),O&&(O.style.display=D?"block":"none"),$&&($.style.display=D?"none":"block"),this.setSliderVal("slide-entity-elevation","val-entity-elevation",t.position.z,2);const T=this.container.querySelector("#toggle-mod-vert-vel"),G=this.container.querySelector("#group-mod-vert-vel"),U=t.hasVerticalVelocity;T&&(T.textContent=U?"Enabled":"Disabled",T.classList.toggle("active",U)),G&&(G.style.display=U?"block":"none"),this.setSliderVal("slide-entity-vert-vel","val-entity-vert-vel",t.verticalVelocity,2);const I=this.container.querySelector("#toggle-mod-gravity"),j=this.container.querySelector("#note-mod-gravity");I&&(I.textContent=t.hasGravity?"Attached":"Detached",I.classList.toggle("active",t.hasGravity)),j&&(j.textContent=t.hasGravity?"Subject to static world gravity acceleration":"Zero-G: never falls, flies horizontally in a straight line");const C=this.container.querySelector("#toggle-mod-roll"),y=this.container.querySelector("#group-mod-roll"),E=this.container.querySelector("#note-roll-friction"),w=!!(t.rollModule&&t.rollModule.enabled);if(C&&(C.textContent=w?"Attached":"Detached",C.classList.toggle("active",w)),y&&(y.style.display=w?"block":"none"),E&&(E.style.display=w&&!t.hasFriction?"block":"none"),t.rollModule&&this.setSliderVal("slide-entity-roll-resist","val-entity-roll-resist",t.rollModule.rollResistance,2),i){const h=this.container.querySelector("#toggle-walk"),q=this.container.querySelector("#group-mod-walking"),X=this.container.querySelector("#warn-walk-friction"),Y=this.container.querySelector("#warn-walk-strength"),N=!!(this.character.walkingModule&&this.character.walkingModule.enabled);h&&(h.textContent=N?"Attached":"Detached",h.classList.toggle("active",N)),q&&(q.style.display=N?"flex":"none"),X&&(X.style.display=N&&!this.character.hasFriction?"block":"none"),Y&&(Y.style.display=N&&!this.character.hasStrength?"block":"none"),this.character.walkingModule&&(this.setSliderVal("slide-walk-force","val-walk-force",this.character.walkingModule.maxWalkForce,0),this.setSliderVal("slide-walk-speed","val-walk-speed",this.character.walkingModule.maxWalkSpeed,1));const et=this.container.querySelector("#toggle-strength"),gt=this.container.querySelector("#group-mod-strength"),it=!!(this.character.strengthModule&&this.character.strengthModule.enabled);et&&(et.textContent=it?"Attached":"Detached",et.classList.toggle("active",it)),gt&&(gt.style.display=it?"block":"none"),this.character.strengthModule&&this.setSliderVal("slide-strength","val-strength",this.character.strength,1);const st=this.container.querySelector("#toggle-pickup"),pt=this.container.querySelector("#group-mod-pickup"),lt=!!(this.character.pickupModule&&this.character.pickupModule.enabled);st&&(st.textContent=lt?"Attached":"Detached",st.classList.toggle("active",lt)),pt&&(pt.style.display=lt?"block":"none"),this.character.pickupModule&&(this.setSliderVal("slide-pickup-reach","val-pickup-reach",this.character.pickupModule.pickupReach,1),this.setSliderVal("slide-pickup-cross-layer","val-pickup-cross-layer",this.character.pickupModule.crossLayerReachRatio,2));const ot=this.container.querySelector("#toggle-throw"),vt=this.container.querySelector("#group-mod-throw"),at=!!(this.character.throwModule&&this.character.throwModule.enabled);ot&&(ot.textContent=at?"Attached":"Detached",ot.classList.toggle("active",at)),vt&&(vt.style.display=at?"block":"none"),this.character.throwModule&&this.setSliderVal("slide-throw-force","val-throw-force",this.character.throwModule.baseThrowForce,1);const nt=this.container.querySelector("#toggle-climb"),bt=this.container.querySelector("#group-mod-climb"),ct=this.container.querySelector("#warn-climb-deps"),Q=!!(this.character.climbingModule&&this.character.climbingModule.enabled);if(nt&&(nt.textContent=Q?"Attached":"Detached",nt.classList.toggle("active",Q)),bt&&(bt.style.display=Q?"block":"none"),ct){const Z=!this.character.hasVerticalPosition,K=!this.character.hasStrength;ct.style.display=Q&&(Z||K)?"block":"none",ct.textContent=Z?"⚠️ Requires Vertical Position (3D Z-axis)":K?"⚠️ Requires Strength Ability to climb":""}if(this.character.climbingModule){const Z=this.container.querySelector("#toggle-climb-walkoff");if(Z){const _=!!this.character.climbingModule.preventWalkOff;Z.textContent=_?"Active":"Inactive",Z.classList.toggle("active",_)}const K=this.container.querySelector("#toggle-climb-sideways");if(K){const _=!!this.character.climbingModule.horizontalClimb;K.textContent=_?"Active":"Inactive",K.classList.toggle("active",_)}this.setSliderVal("slide-climb-adhesion","val-climb-adhesion",this.character.climbingModule.maxAdhesion,0),this.setSliderVal("slide-climb-speed","val-climb-speed",this.character.climbingModule.maxClimbSpeed,1),this.setSliderVal("slide-climb-hang","val-climb-hang",this.character.climbingModule.hangDistance,2)}}}setSliderVal(t,i,s,e){const l=this.container.querySelector(`#${t}`),n=this.container.querySelector(`#${i}`);l&&(l.value=s.toString()),n&&(n.textContent=e>0?s.toFixed(e):Math.round(s).toString())}syncCreatorInputs(){const t=this.creatorState,i=this.container.querySelector("#creator-name");i&&(i.value=t.name);const s=this.container.querySelector("#creator-toggle-shape");s&&(s.textContent=t.visualShape==="box"?"Box 📦":"Circle ⚪",s.classList.toggle("active",t.visualShape==="box"));const e=this.container.querySelector("#creator-color"),l=this.container.querySelector("#val-creator-color");e&&(e.value=t.color),l&&(l.textContent=t.color);const n=this.container.querySelector("#creator-toggle-collider"),o=this.container.querySelector("#grp-creator-radius");n&&(n.textContent=t.hasCollider?"Attached":"Detached",n.classList.toggle("active",t.hasCollider)),o&&(o.style.display=t.hasCollider?"block":"none"),this.setSliderVal("slide-creator-radius","val-creator-radius",t.colliderRadius,2);const a=this.container.querySelector("#creator-toggle-mass"),d=this.container.querySelector("#grp-creator-mass");a&&(a.textContent=t.hasMass?"Attached":"Detached",a.classList.toggle("active",t.hasMass)),d&&(d.style.display=t.hasMass?"block":"none"),this.setSliderVal("slide-creator-mass","val-creator-mass",t.mass,1);const c=this.container.querySelector("#creator-toggle-friction"),u=this.container.querySelector("#grp-creator-fric");c&&(c.textContent=t.hasFriction?"Attached":"Detached",c.classList.toggle("active",t.hasFriction)),u&&(u.style.display=t.hasFriction?"block":"none"),this.setSliderVal("slide-creator-fric","val-creator-fric",t.dynamicFrictionMod,2);const b=this.container.querySelector("#creator-toggle-bounce"),g=this.container.querySelector("#grp-creator-bounce"),v=this.container.querySelector("#creator-check-vert-bounce"),m=this.container.querySelector("#creator-warn-bounce-vert");b&&(b.textContent=t.hasBounce?"Attached":"Detached",b.classList.toggle("active",t.hasBounce)),g&&(g.style.display=t.hasBounce?"block":"none"),v&&(v.checked=t.verticalBounce),m&&(m.style.display=t.hasBounce&&t.verticalBounce&&(!t.hasVerticalPosition||!t.hasVerticalVelocity)?"block":"none"),this.setSliderVal("slide-creator-bounce","val-creator-bounce",t.bounceMod,2);const x=this.container.querySelector("#creator-toggle-vert-pos"),p=this.container.querySelector("#grp-creator-vert-pos");x&&(x.textContent=t.hasVerticalPosition?"Attached":"Detached",x.classList.toggle("active",t.hasVerticalPosition)),p&&(p.style.display=t.hasVerticalPosition?"block":"none"),this.setSliderVal("slide-creator-elevation","val-creator-elevation",t.elevation,2);const f=this.container.querySelector("#creator-toggle-vert-vel");f&&(f.textContent=t.hasVerticalVelocity?"Enabled":"Disabled",f.classList.toggle("active",t.hasVerticalVelocity));const M=this.container.querySelector("#creator-toggle-gravity");M&&(M.textContent=t.hasGravity?"Attached":"Detached",M.classList.toggle("active",t.hasGravity));const k=this.container.querySelector("#creator-toggle-roll"),S=this.container.querySelector("#group-creator-roll-resist");k&&(k.textContent=t.hasRollModule?"Enabled":"Disabled",k.classList.toggle("active",t.hasRollModule)),S&&(S.style.display=t.hasRollModule?"block":"none"),this.setSliderVal("slide-creator-roll-resist","val-creator-roll-resist",t.rollResistance,2)}bindEvents(){var y,E,w,V,F,z,P,B,A,R;this.modePlayBtn.addEventListener("click",()=>{this.setMode(!1)}),this.modeEditBtn.addEventListener("click",()=>{this.setMode(!0)}),(y=this.container.querySelector("#submode-entities"))==null||y.addEventListener("click",()=>{this.setEditTool("entities")}),(E=this.container.querySelector("#submode-walls"))==null||E.addEventListener("click",()=>{this.setEditTool("walls")}),this.entitySelectorEl.addEventListener("change",()=>{var q;const h=this.entitySelectorEl.value;if(h===this.character.id)this.selectedEntity=this.character;else{const X=this.objects.find(Y=>Y.id===h);X&&(this.selectedEntity=X)}this.updateSelectorOptions(),this.syncEntitySliders(),(q=this.onSelectionChange)==null||q.call(this,this.selectedEntity)}),(w=this.container.querySelector("#btn-duplicate-entity"))==null||w.addEventListener("click",()=>{this.duplicateSelectedEntity()}),(V=this.container.querySelector("#btn-delete-entity"))==null||V.addEventListener("click",()=>{this.deleteSelectedEntity()});const t=this.container.querySelector("#toggle-entity-shape");t==null||t.addEventListener("click",()=>{this.selectedEntity.visualShape=this.selectedEntity.visualShape==="box"?"circle":"box",t.textContent=this.selectedEntity.visualShape==="box"?"Box 📦":"Circle ⚪",t.classList.toggle("active",this.selectedEntity.visualShape==="box"),this.updateSelectorOptions()});const i=this.container.querySelector("#toggle-mod-collider");i==null||i.addEventListener("click",()=>{this.selectedEntity.colliderModule?this.selectedEntity.colliderModule.enabled=!this.selectedEntity.colliderModule.enabled:this.selectedEntity.colliderModule=new dt({radius:.32}),this.syncEntitySliders()}),this.setupSlider("slide-entity-radius","val-entity-radius",h=>{this.selectedEntity.colliderRadius=h},2);const s=this.container.querySelector("#toggle-mod-mass");s==null||s.addEventListener("click",()=>{this.selectedEntity.massModule?this.selectedEntity.massModule.enabled=!this.selectedEntity.massModule.enabled:this.selectedEntity.massModule=new ht({mass:1}),this.syncEntitySliders(),this.updateSelectorOptions()}),this.setupSlider("slide-entity-mass","val-entity-mass",h=>{this.selectedEntity.mass=h,this.updateSelectorOptions()},1);const e=this.container.querySelector("#toggle-mod-friction");e==null||e.addEventListener("click",()=>{this.selectedEntity.frictionModule?this.selectedEntity.frictionModule.enabled=!this.selectedEntity.frictionModule.enabled:this.selectedEntity.frictionModule=new ut,this.syncEntitySliders()}),this.setupSlider("slide-entity-static-fric","val-entity-static-fric",h=>{this.selectedEntity.staticGroundFrictionMod=h},2),this.setupSlider("slide-entity-dynamic-fric","val-entity-dynamic-fric",h=>{this.selectedEntity.dynamicGroundFrictionMod=h},2);const l=this.container.querySelector("#toggle-mod-bounce");l==null||l.addEventListener("click",()=>{this.selectedEntity.bounceModule?this.selectedEntity.bounceModule.enabled=!this.selectedEntity.bounceModule.enabled:this.selectedEntity.bounceModule=new yt({bounceMod:.4}),this.syncEntitySliders()}),this.setupSlider("slide-entity-bounce","val-entity-bounce",h=>{this.selectedEntity.bounceMod=h},2);const n=this.container.querySelector("#check-mod-vert-bounce");n==null||n.addEventListener("change",()=>{this.selectedEntity.bounceModule&&(this.selectedEntity.bounceModule.verticalBounce=n.checked),this.syncEntitySliders(),this.updateInspector()});const o=this.container.querySelector("#toggle-mod-vert-pos");o==null||o.addEventListener("click",()=>{this.selectedEntity.verticalPositionModule?(this.selectedEntity.verticalPositionModule.enabled=!this.selectedEntity.verticalPositionModule.enabled,this.selectedEntity.verticalPositionModule.enabled||(this.selectedEntity.position.z=0,this.selectedEntity.verticalVelocity=0)):this.selectedEntity.verticalPositionModule=new rt({z:this.selectedEntity.position.z,hasVerticalVelocity:!0,verticalVelocity:0,enabled:!0}),this.syncEntitySliders(),this.updateInspector()}),this.setupSlider("slide-entity-elevation","val-entity-elevation",h=>{this.selectedEntity.verticalPositionModule&&(this.selectedEntity.verticalPositionModule.z=h),this.selectedEntity.position.z=h,this.syncEntitySliders(),this.updateInspector()},2);const a=this.container.querySelector("#toggle-mod-vert-vel");a==null||a.addEventListener("click",()=>{this.selectedEntity.verticalPositionModule&&(this.selectedEntity.verticalPositionModule.hasVerticalVelocity=!this.selectedEntity.verticalPositionModule.hasVerticalVelocity,this.selectedEntity.verticalPositionModule.hasVerticalVelocity||(this.selectedEntity.verticalVelocity=0)),this.syncEntitySliders(),this.updateInspector()}),this.setupSlider("slide-entity-vert-vel","val-entity-vert-vel",h=>{this.selectedEntity.verticalVelocity=h},2);const d=this.container.querySelector("#toggle-mod-gravity");d==null||d.addEventListener("click",()=>{this.selectedEntity.gravityModule?this.selectedEntity.gravityModule.enabled=!this.selectedEntity.gravityModule.enabled:this.selectedEntity.gravityModule=new ft,this.syncEntitySliders()});const c=this.container.querySelector("#toggle-mod-roll");c==null||c.addEventListener("click",()=>{this.selectedEntity.rollModule?this.selectedEntity.rollModule.enabled=!this.selectedEntity.rollModule.enabled:this.selectedEntity.rollModule=new mt({rollResistance:.4}),this.syncEntitySliders()}),this.setupSlider("slide-entity-roll-resist","val-entity-roll-resist",h=>{this.selectedEntity.rollModule&&(this.selectedEntity.rollModule.rollResistance=h)},2);const u=this.container.querySelector("#toggle-walk");u==null||u.addEventListener("click",()=>{this.character.walkingModule?this.character.walkingModule.enabled=!this.character.walkingModule.enabled:this.character.walkingModule=new Ct,this.syncEntitySliders()}),this.setupSlider("slide-walk-force","val-walk-force",h=>{this.character.walkingModule&&(this.character.walkingModule.maxWalkForce=h)},0),this.setupSlider("slide-walk-speed","val-walk-speed",h=>{this.character.walkingModule&&(this.character.walkingModule.maxWalkSpeed=h)},1);const b=this.container.querySelector("#toggle-strength");b==null||b.addEventListener("click",()=>{this.character.strengthModule?this.character.strengthModule.enabled=!this.character.strengthModule.enabled:this.character.strengthModule=new St({strength:1}),this.syncEntitySliders()}),this.setupSlider("slide-strength","val-strength",h=>{this.character.strength=h},1);const g=this.container.querySelector("#toggle-pickup");g==null||g.addEventListener("click",()=>{this.character.pickupModule?this.character.pickupModule.enabled=!this.character.pickupModule.enabled:this.character.pickupModule=new Rt,this.syncEntitySliders()}),this.setupSlider("slide-pickup-reach","val-pickup-reach",h=>{this.character.pickupModule&&(this.character.pickupModule.pickupReach=h)},1),this.setupSlider("slide-pickup-cross-layer","val-pickup-cross-layer",h=>{this.character.pickupModule&&(this.character.pickupModule.crossLayerReachRatio=h)},2);const v=this.container.querySelector("#toggle-throw");v==null||v.addEventListener("click",()=>{this.character.throwModule?this.character.throwModule.enabled=!this.character.throwModule.enabled:this.character.throwModule=new Pt,this.syncEntitySliders()}),this.setupSlider("slide-throw-force","val-throw-force",h=>{this.character.throwModule&&(this.character.throwModule.baseThrowForce=h)},1);const m=this.container.querySelector("#toggle-climb");m==null||m.addEventListener("click",()=>{this.character.climbingModule?this.character.climbingModule.enabled=!this.character.climbingModule.enabled:this.character.climbingModule=new Wt,this.syncEntitySliders()});const x=this.container.querySelector("#toggle-climb-walkoff");x==null||x.addEventListener("click",()=>{this.character.climbingModule&&(this.character.climbingModule.preventWalkOff=!this.character.climbingModule.preventWalkOff),this.syncEntitySliders()});const p=this.container.querySelector("#toggle-climb-sideways");p==null||p.addEventListener("click",()=>{this.character.climbingModule&&(this.character.climbingModule.horizontalClimb=!this.character.climbingModule.horizontalClimb),this.syncEntitySliders()}),this.setupSlider("slide-climb-adhesion","val-climb-adhesion",h=>{this.character.climbingModule&&(this.character.climbingModule.maxAdhesion=h)},0),this.setupSlider("slide-climb-speed","val-climb-speed",h=>{this.character.climbingModule&&(this.character.climbingModule.maxClimbSpeed=h)},1),this.setupSlider("slide-climb-hang","val-climb-hang",h=>{this.character.climbingModule&&(this.character.climbingModule.hangDistance=h)},2),this.setupSlider("slide-gravity","val-gravity",h=>{this.arena.gravity=h},1),this.setupSlider("slide-wall-height","val-wall-height",h=>{this.arena.setStandardWallHeight(h),this.setSliderVal("slide-editor-wall-height","val-editor-wall-height",h,1)},1),this.setupSlider("slide-editor-wall-height","val-editor-wall-height",h=>{this.arena.setStandardWallHeight(h),this.setSliderVal("slide-wall-height","val-wall-height",h,1)},1);const f=this.container.querySelector("#select-wall-preset");f==null||f.addEventListener("change",()=>{this.arena.loadWallPreset(f.value,[this.character,...this.objects]),this.updateWallPresetUI()}),(F=this.container.querySelector("#btn-prev-wall-map"))==null||F.addEventListener("click",()=>{const h=J.WALL_PRESETS,X=(h.findIndex(Y=>Y.id===this.arena.currentPresetId)-1+h.length)%h.length;this.arena.loadWallPreset(h[X].id,[this.character,...this.objects]),this.updateWallPresetUI()}),(z=this.container.querySelector("#btn-next-wall-map"))==null||z.addEventListener("click",()=>{const h=J.WALL_PRESETS,X=(h.findIndex(Y=>Y.id===this.arena.currentPresetId)+1)%h.length;this.arena.loadWallPreset(h[X].id,[this.character,...this.objects]),this.updateWallPresetUI()}),(P=this.container.querySelector("#btn-reset-walls"))==null||P.addEventListener("click",()=>{this.arena.resetDefaultWalls([this.character,...this.objects]),this.updateWallPresetUI()}),(B=this.container.querySelector("#btn-clear-walls"))==null||B.addEventListener("click",()=>{this.arena.clearAllWalls([this.character,...this.objects]),this.updateWallPresetUI()}),this.setupSlider("slide-friction","val-friction",h=>{this.arena.frictionCoeff=h},1),this.setupSlider("slide-static-thresh","val-static-thresh",h=>{this.arena.staticFrictionThreshold=h},2),this.container.querySelectorAll(".preset-chip").forEach(h=>{h.addEventListener("click",()=>{const q=h.getAttribute("data-preset");q&&this.presets[q]&&(this.creatorState={...this.presets[q]},this.syncCreatorInputs())})});const k=this.container.querySelector("#creator-name");k==null||k.addEventListener("input",()=>{this.creatorState.name=k.value});const S=this.container.querySelector("#creator-toggle-shape");S==null||S.addEventListener("click",()=>{this.creatorState.visualShape=this.creatorState.visualShape==="box"?"circle":"box",S.textContent=this.creatorState.visualShape==="box"?"Box 📦":"Circle ⚪",S.classList.toggle("active",this.creatorState.visualShape==="box")});const L=this.container.querySelector("#creator-color"),W=this.container.querySelector("#val-creator-color");L==null||L.addEventListener("input",()=>{this.creatorState.color=L.value,W&&(W.textContent=L.value)});const O=this.container.querySelector("#creator-toggle-collider");O==null||O.addEventListener("click",()=>{this.creatorState.hasCollider=!this.creatorState.hasCollider,O.textContent=this.creatorState.hasCollider?"Attached":"Detached",O.classList.toggle("active",this.creatorState.hasCollider);const h=this.container.querySelector("#grp-creator-radius");h&&(h.style.display=this.creatorState.hasCollider?"block":"none")}),this.setupSlider("slide-creator-radius","val-creator-radius",h=>{this.creatorState.colliderRadius=h},2);const $=this.container.querySelector("#creator-toggle-mass");$==null||$.addEventListener("click",()=>{this.creatorState.hasMass=!this.creatorState.hasMass,$.textContent=this.creatorState.hasMass?"Attached":"Detached",$.classList.toggle("active",this.creatorState.hasMass);const h=this.container.querySelector("#grp-creator-mass");h&&(h.style.display=this.creatorState.hasMass?"block":"none")}),this.setupSlider("slide-creator-mass","val-creator-mass",h=>{this.creatorState.mass=h},1);const D=this.container.querySelector("#creator-toggle-friction");D==null||D.addEventListener("click",()=>{this.creatorState.hasFriction=!this.creatorState.hasFriction,D.textContent=this.creatorState.hasFriction?"Attached":"Detached",D.classList.toggle("active",this.creatorState.hasFriction);const h=this.container.querySelector("#grp-creator-fric");h&&(h.style.display=this.creatorState.hasFriction?"block":"none")}),this.setupSlider("slide-creator-fric","val-creator-fric",h=>{this.creatorState.dynamicFrictionMod=h},2);const T=this.container.querySelector("#creator-toggle-bounce");T==null||T.addEventListener("click",()=>{this.creatorState.hasBounce=!this.creatorState.hasBounce,T.textContent=this.creatorState.hasBounce?"Attached":"Detached",T.classList.toggle("active",this.creatorState.hasBounce);const h=this.container.querySelector("#grp-creator-bounce");h&&(h.style.display=this.creatorState.hasBounce?"block":"none")}),this.setupSlider("slide-creator-bounce","val-creator-bounce",h=>{this.creatorState.bounceMod=h},2);const G=this.container.querySelector("#creator-check-vert-bounce");G==null||G.addEventListener("change",()=>{this.creatorState.verticalBounce=G.checked,this.syncCreatorInputs()});const U=this.container.querySelector("#creator-toggle-vert-pos");U==null||U.addEventListener("click",()=>{this.creatorState.hasVerticalPosition=!this.creatorState.hasVerticalPosition,this.syncCreatorInputs()}),this.setupSlider("slide-creator-elevation","val-creator-elevation",h=>{this.creatorState.elevation=h},2);const I=this.container.querySelector("#creator-toggle-vert-vel");I==null||I.addEventListener("click",()=>{this.creatorState.hasVerticalVelocity=!this.creatorState.hasVerticalVelocity,this.syncCreatorInputs()});const j=this.container.querySelector("#creator-toggle-gravity");j==null||j.addEventListener("click",()=>{this.creatorState.hasGravity=!this.creatorState.hasGravity,j.textContent=this.creatorState.hasGravity?"Attached":"Detached",j.classList.toggle("active",this.creatorState.hasGravity)});const C=this.container.querySelector("#creator-toggle-roll");C==null||C.addEventListener("click",()=>{this.creatorState.hasRollModule=!this.creatorState.hasRollModule,C.textContent=this.creatorState.hasRollModule?"Enabled":"Disabled",C.classList.toggle("active",this.creatorState.hasRollModule);const h=this.container.querySelector("#group-creator-roll-resist");h&&(h.style.display=this.creatorState.hasRollModule?"block":"none")}),this.setupSlider("slide-creator-roll-resist","val-creator-roll-resist",h=>{this.creatorState.rollResistance=h},2),(A=this.container.querySelector("#btn-spawn-configured"))==null||A.addEventListener("click",()=>{this.spawnFromCreator()}),(R=this.container.querySelector("#btn-clear-entities"))==null||R.addEventListener("click",()=>{this.onClearObjects(),this.setSelectedEntity(this.character)})}spawnFromCreator(){const t=this.creatorState,i=Math.min(Math.max(this.character.position.x+(Math.random()*2-1),1),this.arena.width-1),s=Math.min(Math.max(this.character.position.y+(Math.random()*2-1),1),this.arena.height-1),e=new tt({name:t.name||"Custom Object",position:{x:i,y:s,z:t.hasVerticalPosition?t.elevation:0},visualShape:t.visualShape,color:t.color,colliderModule:t.hasCollider?new dt({radius:t.colliderRadius}):null,massModule:t.hasMass?new ht({mass:t.mass}):null,frictionModule:t.hasFriction?new ut({staticFrictionMod:t.staticFrictionMod,dynamicFrictionMod:t.dynamicFrictionMod}):null,bounceModule:t.hasBounce?new yt({bounceMod:t.bounceMod,verticalBounce:t.verticalBounce}):null,verticalPositionModule:t.hasVerticalPosition?new rt({z:t.elevation,hasVerticalVelocity:t.hasVerticalVelocity,verticalVelocity:0}):null,gravityModule:t.hasGravity?new ft:null,rollModule:t.hasRollModule?new mt({rollResistance:t.rollResistance}):null});this.onSpawnObject(e),this.setSelectedEntity(e)}duplicateSelectedEntity(){if(this.selectedEntity===this.character)return;const t=this.selectedEntity,i=Math.min(Math.max(t.position.x+.6,1),this.arena.width-1),s=Math.min(Math.max(t.position.y+.6,1),this.arena.height-1),e=new tt({name:`${t.name} (Copy)`,position:{x:i,y:s,z:t.position.z},visualShape:t.visualShape,color:t.color,colliderModule:t.colliderModule?new dt({radius:t.colliderModule.radius,enabled:t.colliderModule.enabled}):null,massModule:t.massModule?new ht({mass:t.massModule.mass,enabled:t.massModule.enabled}):null,frictionModule:t.frictionModule?new ut({staticFrictionMod:t.frictionModule.staticFrictionMod,dynamicFrictionMod:t.frictionModule.dynamicFrictionMod,enabled:t.frictionModule.enabled}):null,bounceModule:t.bounceModule?new yt({bounceMod:t.bounceModule.bounceMod,verticalBounce:t.bounceModule.verticalBounce,enabled:t.bounceModule.enabled}):null,verticalPositionModule:t.verticalPositionModule?new rt({z:t.verticalPositionModule.z,hasVerticalVelocity:t.verticalPositionModule.hasVerticalVelocity,verticalVelocity:t.verticalPositionModule.verticalVelocity,enabled:t.verticalPositionModule.enabled}):null,gravityModule:t.gravityModule?new ft({enabled:t.gravityModule.enabled}):null,rollModule:t.rollModule?new mt({rollResistance:t.rollModule.rollResistance,enabled:t.rollModule.enabled}):null});this.onSpawnObject(e),this.setSelectedEntity(e)}deleteSelectedEntity(){if(this.selectedEntity===this.character)return;const t=this.selectedEntity;this.character.heldObject===t&&(t.isHeld=!1,t.heldBy=null,this.character.heldObject=null),this.onDeleteObject&&this.onDeleteObject(t),this.setSelectedEntity(this.character)}setupSlider(t,i,s,e=0){const l=this.container.querySelector(`#${t}`),n=this.container.querySelector(`#${i}`);!l||!n||l.addEventListener("input",()=>{const o=parseFloat(l.value);n.textContent=e>0?o.toFixed(e):Math.round(o).toString(),s(o)})}updateInspector(){var e;const t=this.selectedEntity,i=Math.hypot(t.velocity.x,t.velocity.y).toFixed(2),s=t===this.character;this.inspectorEl.innerHTML=`
      ...
      <div class="inspect-item">
        ...
        <span class="inspect-v">${(((e=this.character.climbingModule)==null?void 0:e.hangDistance)??.5).toFixed(2)} u</span>
      </div>
      `:""}
